...
static_assert(sizeof(UHeroSquadSlotsView_C) == 0x000318, "Wrong size on UHeroSquadSlotsView_C");
...
static_assert(offsetof(UHeroSquadSlotsView_C, BonusSquadSlotGroup) == 0x000300, "Member 'UHeroSquadSlotsView_C::BonusSquadSlotGroup' has a wrong offset!");
static_assert(offsetof(UHeroSquadSlotsView_C, DefendersSquadSlotGroup) == 0x000308, "Member 'UHeroSquadSlotsView_C::DefendersSquadSlotGroup' has a wrong offset!");
static_assert(offsetof(UHeroSquadSlotsView_C, PrimarySquadSlotGroup) == 0x000310, "Member 'UHeroSquadSlotsView_C::PrimarySquadSlotGroup' has a wrong offset!");
