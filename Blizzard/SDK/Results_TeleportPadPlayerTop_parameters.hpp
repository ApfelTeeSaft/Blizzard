...
static_assert(sizeof(Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop) == 0x000068, "Wrong size on Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop");
...
static_assert(offsetof(Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop, CallFunc_MakeLiteralString_ReturnValue) == 0x000008, "Member 'Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop::CallFunc_MakeLiteralString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop, CallFunc_RandomInteger_ReturnValue) == 0x000018, "Member 'Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop::CallFunc_RandomInteger_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop, CallFunc_Conv_IntToString_ReturnValue) == 0x000020, "Member 'Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop::CallFunc_Conv_IntToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop, CallFunc_Concat_StrStr_ReturnValue) == 0x000030, "Member 'Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop, CallFunc_Concat_StrStr_ReturnValue1) == 0x000040, "Member 'Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop::CallFunc_Concat_StrStr_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop, CallFunc_Conv_StringToText_ReturnValue) == 0x000050, "Member 'Results_TeleportPadPlayerTop_C_ExecuteUbergraph_Results_TeleportPadPlayerTop::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
...
public:
	...
	class FText                                   CallFunc_GetPlayerName_ReturnValue;                // 0x0038(0x0018)()
};
...
static_assert(sizeof(Results_TeleportPadPlayerTop_C_Initialize) == 0x000050, "Wrong size on Results_TeleportPadPlayerTop_C_Initialize");
...
static_assert(offsetof(Results_TeleportPadPlayerTop_C_Initialize, CallFunc_GetPlayerName_ReturnValue) == 0x000038, "Member 'Results_TeleportPadPlayerTop_C_Initialize::CallFunc_GetPlayerName_ReturnValue' has a wrong offset!");
