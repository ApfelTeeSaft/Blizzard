...
static_assert(sizeof(UMediaSoundComponent) == 0x000710, "Wrong size on UMediaSoundComponent");
static_assert(offsetof(UMediaSoundComponent, Channels) == 0x000690, "Member 'UMediaSoundComponent::Channels' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, MediaPlayer) == 0x000698, "Member 'UMediaSoundComponent::MediaPlayer' has a wrong offset!");
