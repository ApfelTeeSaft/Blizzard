...
static_assert(sizeof(UQuestScreen_C) == 0x0004D8, "Wrong size on UQuestScreen_C");
...
static_assert(offsetof(UQuestScreen_C, ShouldExpandAllOnStart) == 0x0004D0, "Member 'UQuestScreen_C::ShouldExpandAllOnStart' has a wrong offset!");
