...
static_assert(sizeof(UHordeTierResultsWidget_C) == 0x0002A0, "Wrong size on UHordeTierResultsWidget_C");
static_assert(offsetof(UHordeTierResultsWidget_C, Movie) == 0x000240, "Member 'UHordeTierResultsWidget_C::Movie' has a wrong offset!");
static_assert(offsetof(UHordeTierResultsWidget_C, ResultsNameplate) == 0x000248, "Member 'UHordeTierResultsWidget_C::ResultsNameplate' has a wrong offset!");
static_assert(offsetof(UHordeTierResultsWidget_C, OnTierResultsWidgetComplete) == 0x000250, "Member 'UHordeTierResultsWidget_C::OnTierResultsWidgetComplete' has a wrong offset!");
static_assert(offsetof(UHordeTierResultsWidget_C, CompletionResult) == 0x000260, "Member 'UHordeTierResultsWidget_C::CompletionResult' has a wrong offset!");
static_assert(offsetof(UHordeTierResultsWidget_C, DefaultDefeatMedia) == 0x000268, "Member 'UHordeTierResultsWidget_C::DefaultDefeatMedia' has a wrong offset!");
static_assert(offsetof(UHordeTierResultsWidget_C, DefaultVictoryMedia) == 0x000270, "Member 'UHordeTierResultsWidget_C::DefaultVictoryMedia' has a wrong offset!");
static_assert(offsetof(UHordeTierResultsWidget_C, VictorySound) == 0x000278, "Member 'UHordeTierResultsWidget_C::VictorySound' has a wrong offset!");
static_assert(offsetof(UHordeTierResultsWidget_C, DefeatSound) == 0x000280, "Member 'UHordeTierResultsWidget_C::DefeatSound' has a wrong offset!");
static_assert(offsetof(UHordeTierResultsWidget_C, MovieTextDelay) == 0x000288, "Member 'UHordeTierResultsWidget_C::MovieTextDelay' has a wrong offset!");
static_assert(offsetof(UHordeTierResultsWidget_C, NameplateIntroFunctionName) == 0x000290, "Member 'UHordeTierResultsWidget_C::NameplateIntroFunctionName' has a wrong offset!");
