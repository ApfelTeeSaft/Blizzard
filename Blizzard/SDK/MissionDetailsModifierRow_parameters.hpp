...
public:
	...
	ESlateVisibility                              K2Node_Select12_Default;                           // 0x0074(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(MissionDetailsModifierRow_C_Init, Temp_bool_Variable1) == 0x000055, "Member 'MissionDetailsModifierRow_C_Init::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(MissionDetailsModifierRow_C_Init, Temp_byte_Variable1) == 0x000057, "Member 'MissionDetailsModifierRow_C_Init::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierRow_C_Init, Temp_bool_Variable12) == 0x000058, "Member 'MissionDetailsModifierRow_C_Init::Temp_bool_Variable12' has a wrong offset!");
...
static_assert(offsetof(MissionDetailsModifierRow_C_Init, CallFunc_BreakVector2D_X1) == 0x000064, "Member 'MissionDetailsModifierRow_C_Init::CallFunc_BreakVector2D_X1' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierRow_C_Init, CallFunc_BreakVector2D_Y1) == 0x000068, "Member 'MissionDetailsModifierRow_C_Init::CallFunc_BreakVector2D_Y1' has a wrong offset!");
...
static_assert(offsetof(MissionDetailsModifierRow_C_Init, K2Node_Select1_Default) == 0x000070, "Member 'MissionDetailsModifierRow_C_Init::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierRow_C_Init, K2Node_Select12_Default) == 0x000074, "Member 'MissionDetailsModifierRow_C_Init::K2Node_Select12_Default' has a wrong offset!");
