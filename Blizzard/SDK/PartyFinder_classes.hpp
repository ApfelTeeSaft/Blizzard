...
static_assert(sizeof(UPartyFinder_C) == 0x0004F8, "Wrong size on UPartyFinder_C");
static_assert(offsetof(UPartyFinder_C, UberGraphFrame) == 0x0003F0, "Member 'UPartyFinder_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, CloseButton) == 0x0003F8, "Member 'UPartyFinder_C::CloseButton' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, IgnoreButton) == 0x000400, "Member 'UPartyFinder_C::IgnoreButton' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, Image_1) == 0x000408, "Member 'UPartyFinder_C::Image_1' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, InviteButton) == 0x000410, "Member 'UPartyFinder_C::InviteButton' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, InviteIgnoreSwitcher) == 0x000418, "Member 'UPartyFinder_C::InviteIgnoreSwitcher' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, JoinButton) == 0x000420, "Member 'UPartyFinder_C::JoinButton' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, Lightbox) == 0x000428, "Member 'UPartyFinder_C::Lightbox' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, PartyInfo) == 0x000430, "Member 'UPartyFinder_C::PartyInfo' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, SocialTreeView) == 0x000438, "Member 'UPartyFinder_C::SocialTreeView' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, ViewProfileButton) == 0x000440, "Member 'UPartyFinder_C::ViewProfileButton' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, ViewProfileVisibility) == 0x000448, "Member 'UPartyFinder_C::ViewProfileVisibility' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, LeaveConfirmationIcon) == 0x000450, "Member 'UPartyFinder_C::LeaveConfirmationIcon' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, LeaveConfirmationTitle) == 0x0004C8, "Member 'UPartyFinder_C::LeaveConfirmationTitle' has a wrong offset!");
static_assert(offsetof(UPartyFinder_C, LeaveConfirmationDescription) == 0x0004E0, "Member 'UPartyFinder_C::LeaveConfirmationDescription' has a wrong offset!");
