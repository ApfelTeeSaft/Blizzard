...
static_assert(sizeof(XpBoostInfoText_C_ExecuteUbergraph_XpBoostInfoText) == 0x000068, "Wrong size on XpBoostInfoText_C_ExecuteUbergraph_XpBoostInfoText");
...
static_assert(offsetof(XpBoostInfoText_C_ExecuteUbergraph_XpBoostInfoText, K2Node_CreateDelegate_OutputDelegate1) == 0x000018, "Member 'XpBoostInfoText_C_ExecuteUbergraph_XpBoostInfoText::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(XpBoostInfoText_C_ExecuteUbergraph_XpBoostInfoText, K2Node_CustomEvent_BoostAmount) == 0x000064, "Member 'XpBoostInfoText_C_ExecuteUbergraph_XpBoostInfoText::K2Node_CustomEvent_BoostAmount' has a wrong offset!");
...
static_assert(sizeof(XpBoostInfoText_C_HandleAccountUpdate) == 0x000034, "Wrong size on XpBoostInfoText_C_HandleAccountUpdate");
