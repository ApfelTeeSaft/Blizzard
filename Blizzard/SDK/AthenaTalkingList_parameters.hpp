...
static_assert(offsetof(AthenaTalkingList_C_TalkingPlayersChanged, CallFunc_Conv_StringToText_ReturnValue1) == 0x000030, "Member 'AthenaTalkingList_C_TalkingPlayersChanged::CallFunc_Conv_StringToText_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AthenaTalkingList_C_TalkingPlayersChanged, CallFunc_Conv_StringToText_ReturnValue12) == 0x000048, "Member 'AthenaTalkingList_C_TalkingPlayersChanged::CallFunc_Conv_StringToText_ReturnValue12' has a wrong offset!");
static_assert(offsetof(AthenaTalkingList_C_TalkingPlayersChanged, CallFunc_Conv_StringToText_ReturnValue123) == 0x000060, "Member 'AthenaTalkingList_C_TalkingPlayersChanged::CallFunc_Conv_StringToText_ReturnValue123' has a wrong offset!");
...
static_assert(offsetof(AthenaTalkingList_C_TalkingPlayersChanged, CallFunc_Array_IsValidIndex_ReturnValue1) == 0x000079, "Member 'AthenaTalkingList_C_TalkingPlayersChanged::CallFunc_Array_IsValidIndex_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AthenaTalkingList_C_TalkingPlayersChanged, CallFunc_Array_IsValidIndex_ReturnValue12) == 0x00007A, "Member 'AthenaTalkingList_C_TalkingPlayersChanged::CallFunc_Array_IsValidIndex_ReturnValue12' has a wrong offset!");
static_assert(offsetof(AthenaTalkingList_C_TalkingPlayersChanged, CallFunc_Conv_StringToText_ReturnValue1234) == 0x000080, "Member 'AthenaTalkingList_C_TalkingPlayersChanged::CallFunc_Conv_StringToText_ReturnValue1234' has a wrong offset!");
static_assert(offsetof(AthenaTalkingList_C_TalkingPlayersChanged, CallFunc_Array_IsValidIndex_ReturnValue123) == 0x000098, "Member 'AthenaTalkingList_C_TalkingPlayersChanged::CallFunc_Array_IsValidIndex_ReturnValue123' has a wrong offset!");
static_assert(offsetof(AthenaTalkingList_C_TalkingPlayersChanged, CallFunc_Array_IsValidIndex_ReturnValue1234) == 0x000099, "Member 'AthenaTalkingList_C_TalkingPlayersChanged::CallFunc_Array_IsValidIndex_ReturnValue1234' has a wrong offset!");
