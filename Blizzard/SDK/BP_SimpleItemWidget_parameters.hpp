...
static_assert(offsetof(BP_SimpleItemWidget_C_ExecuteUbergraph_BP_SimpleItemWidget, Temp_byte_Variable1) == 0x000006, "Member 'BP_SimpleItemWidget_C_ExecuteUbergraph_BP_SimpleItemWidget::Temp_byte_Variable1' has a wrong offset!");
