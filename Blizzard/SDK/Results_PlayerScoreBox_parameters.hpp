...
static_assert(offsetof(Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x000014, "Member 'Results_PlayerScoreBox_C_ExecuteUbergraph_Results_PlayerScoreBox::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(Results_PlayerScoreBox_C_Initialize, CallFunc_Divide_FloatFloat_ReturnValue1) == 0x00000C, "Member 'Results_PlayerScoreBox_C_Initialize::CallFunc_Divide_FloatFloat_ReturnValue1' has a wrong offset!");
