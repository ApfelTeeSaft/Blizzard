...
static_assert(sizeof(AGCN_BluGloPylon_Shield_Activate_C) == 0x000450, "Wrong size on AGCN_BluGloPylon_Shield_Activate_C");
static_assert(offsetof(AGCN_BluGloPylon_Shield_Activate_C, IconTexture) == 0x000440, "Member 'AGCN_BluGloPylon_Shield_Activate_C::IconTexture' has a wrong offset!");
