...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FSupplyDropUnlocks&        InUnlocks                                              (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
...
// Parameters:
// const struct FVector&                   InLocation                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const struct FRotator&                  InRotation                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor)
