...
static_assert(sizeof(UViewInfoButton_NoText_C) == 0x000788, "Wrong size on UViewInfoButton_NoText_C");
static_assert(offsetof(UViewInfoButton_NoText_C, Content) == 0x000780, "Member 'UViewInfoButton_NoText_C::Content' has a wrong offset!");
