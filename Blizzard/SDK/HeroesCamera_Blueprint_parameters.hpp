...
public:
	...
	struct FKey                                   K2Node_InputKeyEvent_Key123;                       // 0x0088(0x0018)(HasGetValueTypeHash)
	...
	class APlayerController*                      CallFunc_GetPlayerController_ReturnValue12;        // 0x00F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(HeroesCamera_Blueprint_C_ExecuteUbergraph_HeroesCamera_Blueprint, K2Node_InputKeyEvent_Key12) == 0x000008, "Member 'HeroesCamera_Blueprint_C_ExecuteUbergraph_HeroesCamera_Blueprint::K2Node_InputKeyEvent_Key12' has a wrong offset!");
...
static_assert(offsetof(HeroesCamera_Blueprint_C_ExecuteUbergraph_HeroesCamera_Blueprint, K2Node_InputKeyEvent_Key123) == 0x000088, "Member 'HeroesCamera_Blueprint_C_ExecuteUbergraph_HeroesCamera_Blueprint::K2Node_InputKeyEvent_Key123' has a wrong offset!");
...
static_assert(offsetof(HeroesCamera_Blueprint_C_ExecuteUbergraph_HeroesCamera_Blueprint, CallFunc_GetPlayerController_ReturnValue12) == 0x0000F8, "Member 'HeroesCamera_Blueprint_C_ExecuteUbergraph_HeroesCamera_Blueprint::CallFunc_GetPlayerController_ReturnValue12' has a wrong offset!");
