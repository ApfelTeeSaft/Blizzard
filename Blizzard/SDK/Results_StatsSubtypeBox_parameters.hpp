...
public:
	...
	struct FFortScoreStylingInfo                  CallFunc_GetScoreStylingData_ScoreStylingInfo;     // 0x0040(0x02F8)()
	bool                                          CallFunc_GetScoreStylingData_ReturnValue;          // 0x0338(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(Results_StatsSubtypeBox_C_InitializeScoreType) == 0x000370, "Wrong size on Results_StatsSubtypeBox_C_InitializeScoreType");
...
static_assert(offsetof(Results_StatsSubtypeBox_C_InitializeScoreType, CallFunc_GetScoreStylingData_ReturnValue) == 0x000338, "Member 'Results_StatsSubtypeBox_C_InitializeScoreType::CallFunc_GetScoreStylingData_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_StatsSubtypeBox_C_InitializeScoreType, K2Node_MakeStruct_SlateColor) == 0x000340, "Member 'Results_StatsSubtypeBox_C_InitializeScoreType::K2Node_MakeStruct_SlateColor' has a wrong offset!");
static_assert(offsetof(Results_StatsSubtypeBox_C_InitializeScoreType, K2Node_SwitchEnum_CmpSuccess) == 0x000368, "Member 'Results_StatsSubtypeBox_C_InitializeScoreType::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
