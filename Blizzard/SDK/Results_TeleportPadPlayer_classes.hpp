...
static_assert(offsetof(UResults_TeleportPadPlayer_C, InvitePopupMenuAnchor) == 0x000258, "Member 'UResults_TeleportPadPlayer_C::InvitePopupMenuAnchor' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, OverlayThumbs) == 0x000260, "Member 'UResults_TeleportPadPlayer_C::OverlayThumbs' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, Top) == 0x000268, "Member 'UResults_TeleportPadPlayer_C::Top' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, bIsValid) == 0x000270, "Member 'UResults_TeleportPadPlayer_C::bIsValid' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, bIsLocalPlayer) == 0x000271, "Member 'UResults_TeleportPadPlayer_C::bIsLocalPlayer' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, ThumbsUp) == 0x000278, "Member 'UResults_TeleportPadPlayer_C::ThumbsUp' has a wrong offset!");
