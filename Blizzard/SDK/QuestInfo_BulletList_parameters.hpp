...
public:
	class FText                                   EntryText;                                         // 0x0000(0x0018)(BlueprintVisible, BlueprintReadOnly, Parm)
	struct FSlateBrush                            EntryIconBrush;                                    // 0x0018(0x0078)(BlueprintVisible, BlueprintReadOnly, Parm)
	class UQuestInfo_BulletListEntry_C*           NewEntry;                                          // 0x0090(0x0008)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UQuestInfo_BulletListEntry_C*           CallFunc_Create_ReturnValue;                       // 0x0098(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(QuestInfo_BulletList_C_AddEntryWithBrush) == 0x0000B0, "Wrong size on QuestInfo_BulletList_C_AddEntryWithBrush");
...
static_assert(offsetof(QuestInfo_BulletList_C_AddEntryWithBrush, NewEntry) == 0x000090, "Member 'QuestInfo_BulletList_C_AddEntryWithBrush::NewEntry' has a wrong offset!");
static_assert(offsetof(QuestInfo_BulletList_C_AddEntryWithBrush, CallFunc_Create_ReturnValue) == 0x000098, "Member 'QuestInfo_BulletList_C_AddEntryWithBrush::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestInfo_BulletList_C_AddEntryWithBrush, CallFunc_GetChildrenCount_ReturnValue) == 0x0000A0, "Member 'QuestInfo_BulletList_C_AddEntryWithBrush::CallFunc_GetChildrenCount_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestInfo_BulletList_C_AddEntryWithBrush, CallFunc_Greater_IntInt_ReturnValue) == 0x0000A4, "Member 'QuestInfo_BulletList_C_AddEntryWithBrush::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestInfo_BulletList_C_AddEntryWithBrush, CallFunc_AddChild_ReturnValue) == 0x0000A8, "Member 'QuestInfo_BulletList_C_AddEntryWithBrush::CallFunc_AddChild_ReturnValue' has a wrong offset!");
