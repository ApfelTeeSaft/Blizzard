...
public:
	...
	ECommonInputType                              Temp_byte_Variable1;                               // 0x0061(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ECommonInputType                              K2Node_Select1_Default;                            // 0x0062(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_63[0x1];                                       // 0x0063(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         K2Node_CustomEvent_Selected_Index12;               // 0x0064(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(int32 Selected_Index)>         K2Node_CreateDelegate_OutputDelegate1;             // 0x0088(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(int32 Selected_Index)>         K2Node_CreateDelegate_OutputDelegate12;            // 0x00A0(0x0010)(ZeroConstructor, NoDestructor)
};
...
static_assert(offsetof(TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig, Temp_string_Variable1) == 0x000030, "Member 'TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig::Temp_string_Variable1' has a wrong offset!");
...
static_assert(offsetof(TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig, Temp_bool_Variable1) == 0x000048, "Member 'TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig, Temp_byte_Variable1) == 0x000061, "Member 'TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig, K2Node_Select1_Default) == 0x000062, "Member 'TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig, K2Node_CustomEvent_Selected_Index12) == 0x000064, "Member 'TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig::K2Node_CustomEvent_Selected_Index12' has a wrong offset!");
...
static_assert(offsetof(TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig, CallFunc_GetContext_ReturnValue1) == 0x000070, "Member 'TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig, K2Node_CreateDelegate_OutputDelegate1) == 0x000088, "Member 'TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig, K2Node_CreateDelegate_OutputDelegate12) == 0x0000A0, "Member 'TabGamePadConfig_C_ExecuteUbergraph_TabGamePadConfig::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
...
static_assert(offsetof(TabGamePadConfig_C_Initialize_Data, Temp_text_Variable1) == 0x000028, "Member 'TabGamePadConfig_C_Initialize_Data::Temp_text_Variable1' has a wrong offset!");
