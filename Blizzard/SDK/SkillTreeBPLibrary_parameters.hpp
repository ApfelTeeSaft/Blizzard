...
static_assert(offsetof(SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData, Temp_class_Variable1) == 0x000458, "Member 'SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData::Temp_class_Variable1' has a wrong offset!");
static_assert(offsetof(SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData, Temp_class_Variable12) == 0x000460, "Member 'SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData::Temp_class_Variable12' has a wrong offset!");
static_assert(offsetof(SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData, Temp_class_Variable123) == 0x000468, "Member 'SkillTreeBPLibrary_C_UpdateSkillTreeNodeMaterial_StaticData::Temp_class_Variable123' has a wrong offset!");
...
static_assert(offsetof(SkillTreeBPLibrary_C_GetSkillTreeNodeCostTint, CallFunc_GetContext_ReturnValue1) == 0x0000E0, "Member 'SkillTreeBPLibrary_C_GetSkillTreeNodeCostTint::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
