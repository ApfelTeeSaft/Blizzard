...
static_assert(alignof(UGE_DefaultPlayer_BuildTime_C) == 0x000010, "Wrong alignment on UGE_DefaultPlayer_BuildTime_C");
static_assert(sizeof(UGE_DefaultPlayer_BuildTime_C) == 0x000670, "Wrong size on UGE_DefaultPlayer_BuildTime_C");
