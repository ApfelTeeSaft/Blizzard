...
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, CallFunc_GetOwningPlayer_ReturnValue1) == 0x000070, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::CallFunc_GetOwningPlayer_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, K2Node_DynamicCast_AsFort_Player_Controller_Athena1) == 0x000080, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::K2Node_DynamicCast_AsFort_Player_Controller_Athena1' has a wrong offset!");
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, K2Node_DynamicCast_bSuccess1) == 0x000088, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
