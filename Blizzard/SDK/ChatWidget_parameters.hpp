...
static_assert(offsetof(ChatWidget_C_ExecuteUbergraph_ChatWidget, Temp_byte_Variable1) == 0x000006, "Member 'ChatWidget_C_ExecuteUbergraph_ChatWidget::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_UpdateChatUserListIcon, CallFunc_GetContext_ReturnValue1) == 0x000018, "Member 'ChatWidget_C_UpdateChatUserListIcon::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
public:
	...
	class UCommonUIContext*                       CallFunc_GetContext_ReturnValue1;                  // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonUIContext*                       CallFunc_GetContext_ReturnValue12;                 // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsUsingGamepad_ReturnValue1;              // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UCommonUIContext*                       CallFunc_GetContext_ReturnValue123;                // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	ESlateVisibility                              Temp_byte_Variable123;                             // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, Temp_byte_Variable1) == 0x000012, "Member 'ChatWidget_C_HandeChatEnteredEvent::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, Temp_byte_Variable12) == 0x000013, "Member 'ChatWidget_C_HandeChatEnteredEvent::Temp_byte_Variable12' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, CallFunc_GetContext_ReturnValue1) == 0x000018, "Member 'ChatWidget_C_HandeChatEnteredEvent::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, CallFunc_GetContext_ReturnValue12) == 0x000020, "Member 'ChatWidget_C_HandeChatEnteredEvent::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, CallFunc_IsUsingGamepad_ReturnValue1) == 0x000028, "Member 'ChatWidget_C_HandeChatEnteredEvent::CallFunc_IsUsingGamepad_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, CallFunc_GetContext_ReturnValue123) == 0x000038, "Member 'ChatWidget_C_HandeChatEnteredEvent::CallFunc_GetContext_ReturnValue123' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, CallFunc_GetInputManager_ReturnValue1) == 0x000048, "Member 'ChatWidget_C_HandeChatEnteredEvent::CallFunc_GetInputManager_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, Temp_byte_Variable123) == 0x000050, "Member 'ChatWidget_C_HandeChatEnteredEvent::Temp_byte_Variable123' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, Temp_bool_Variable1) == 0x000051, "Member 'ChatWidget_C_HandeChatEnteredEvent::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandeChatEnteredEvent, K2Node_Select1_Default) == 0x000052, "Member 'ChatWidget_C_HandeChatEnteredEvent::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_HandleShowChatWindow, Temp_byte_Variable12) == 0x000006, "Member 'ChatWidget_C_HandleShowChatWindow::Temp_byte_Variable12' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandleShowChatWindow, Temp_byte_Variable123) == 0x000007, "Member 'ChatWidget_C_HandleShowChatWindow::Temp_byte_Variable123' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_HandleShowChatWindow, Temp_byte_Variable1234) == 0x000008, "Member 'ChatWidget_C_HandleShowChatWindow::Temp_byte_Variable1234' has a wrong offset!");
...
public:
	...
	class UFortHUDContext*                        CallFunc_GetContext_ReturnValue12;                 // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(ChatWidget_C_BindDelegates, CallFunc_GetContext_ReturnValue1) == 0x000028, "Member 'ChatWidget_C_BindDelegates::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_BindDelegates, K2Node_CreateDelegate_OutputDelegate12) == 0x000030, "Member 'ChatWidget_C_BindDelegates::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_BindDelegates, CallFunc_GetContext_ReturnValue12) == 0x000040, "Member 'ChatWidget_C_BindDelegates::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
...
public:
	...
	class UCommonUIContext*                       CallFunc_GetContext_ReturnValue1;                  // 0x0008(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWidget*                                K2Node_Select1_Default;                            // 0x0028(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(ChatWidget_C_InitializeChat, CallFunc_GetContext_ReturnValue1) == 0x000008, "Member 'ChatWidget_C_InitializeChat::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_InitializeChat, Temp_byte_Variable1) == 0x000015, "Member 'ChatWidget_C_InitializeChat::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(ChatWidget_C_InitializeChat, Temp_bool_Variable1) == 0x000016, "Member 'ChatWidget_C_InitializeChat::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_InitializeChat, CallFunc_GetContext_ReturnValue12) == 0x000018, "Member 'ChatWidget_C_InitializeChat::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(ChatWidget_C_InitializeChat, K2Node_Select1_Default) == 0x000028, "Member 'ChatWidget_C_InitializeChat::K2Node_Select1_Default' has a wrong offset!");
