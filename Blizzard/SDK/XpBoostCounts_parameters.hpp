...
static_assert(offsetof(XpBoostCounts_C_ExecuteUbergraph_XpBoostCounts, K2Node_CreateDelegate_OutputDelegate1) == 0x000018, "Member 'XpBoostCounts_C_ExecuteUbergraph_XpBoostCounts::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(XpBoostCounts_C_Update_Available_Boosts, CallFunc_MakeLiteralText_ReturnValue1) == 0x000018, "Member 'XpBoostCounts_C_Update_Available_Boosts::CallFunc_MakeLiteralText_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(XpBoostCounts_C_Update_Available_Boosts, CallFunc_GetAccountItemWithDefinition_ReturnValue1) == 0x000040, "Member 'XpBoostCounts_C_Update_Available_Boosts::CallFunc_GetAccountItemWithDefinition_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(XpBoostCounts_C_Update_Available_Boosts, CallFunc_IsValid_ReturnValue1) == 0x000049, "Member 'XpBoostCounts_C_Update_Available_Boosts::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(XpBoostCounts_C_Update_Available_Boosts, CallFunc_GetDisplayName_ReturnValue1) == 0x000080, "Member 'XpBoostCounts_C_Update_Available_Boosts::CallFunc_GetDisplayName_ReturnValue1' has a wrong offset!");
static_assert(offsetof(XpBoostCounts_C_Update_Available_Boosts, CallFunc_Conv_IntToText_ReturnValue1) == 0x000098, "Member 'XpBoostCounts_C_Update_Available_Boosts::CallFunc_Conv_IntToText_ReturnValue1' has a wrong offset!");
