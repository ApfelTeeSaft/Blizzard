...
public:
	...
	struct FFortTheaterMapData                    CallFunc_GetTheaterData_OutTheaterData;            // 0x0058(0x04D0)()
	bool                                          CallFunc_GetTheaterData_ReturnValue;               // 0x0528(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AWorldMapPin*                           CallFunc_FinishSpawningActor_ReturnValue;          // 0x0538(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WM_PinManager_C_CreateWorldMapPin) == 0x000010, "Wrong alignment on WM_PinManager_C_CreateWorldMapPin");
static_assert(sizeof(WM_PinManager_C_CreateWorldMapPin) == 0x000540, "Wrong size on WM_PinManager_C_CreateWorldMapPin");
...
static_assert(offsetof(WM_PinManager_C_CreateWorldMapPin, CallFunc_GetTheaterData_ReturnValue) == 0x000528, "Member 'WM_PinManager_C_CreateWorldMapPin::CallFunc_GetTheaterData_ReturnValue' has a wrong offset!");
static_assert(offsetof(WM_PinManager_C_CreateWorldMapPin, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x000530, "Member 'WM_PinManager_C_CreateWorldMapPin::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(WM_PinManager_C_CreateWorldMapPin, CallFunc_FinishSpawningActor_ReturnValue) == 0x000538, "Member 'WM_PinManager_C_CreateWorldMapPin::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
