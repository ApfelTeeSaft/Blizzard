...
public:
	...
	struct FTimerHandle                           CallFunc_K2_SetTimerDelegate_ReturnValue12;        // 0x0080(0x0008)(NoDestructor)
...
static_assert(offsetof(Announcement_ZoneModifiers_C_ExecuteUbergraph_Announcement_ZoneModifiers, K2Node_CreateDelegate_OutputDelegate1) == 0x000028, "Member 'Announcement_ZoneModifiers_C_ExecuteUbergraph_Announcement_ZoneModifiers::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(Announcement_ZoneModifiers_C_ExecuteUbergraph_Announcement_ZoneModifiers, CallFunc_K2_SetTimerDelegate_ReturnValue1) == 0x000038, "Member 'Announcement_ZoneModifiers_C_ExecuteUbergraph_Announcement_ZoneModifiers::CallFunc_K2_SetTimerDelegate_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(Announcement_ZoneModifiers_C_ExecuteUbergraph_Announcement_ZoneModifiers, K2Node_CreateDelegate_OutputDelegate12) == 0x000068, "Member 'Announcement_ZoneModifiers_C_ExecuteUbergraph_Announcement_ZoneModifiers::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
...
static_assert(offsetof(Announcement_ZoneModifiers_C_ExecuteUbergraph_Announcement_ZoneModifiers, CallFunc_K2_SetTimerDelegate_ReturnValue12) == 0x000080, "Member 'Announcement_ZoneModifiers_C_ExecuteUbergraph_Announcement_ZoneModifiers::CallFunc_K2_SetTimerDelegate_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(Announcement_ZoneModifiers_C_ExecuteUbergraph_Announcement_ZoneModifiers, K2Node_DynamicCast_bSuccess1) == 0x000090, "Member 'Announcement_ZoneModifiers_C_ExecuteUbergraph_Announcement_ZoneModifiers::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
