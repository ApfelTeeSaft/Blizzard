...
public:
	...
	class UObject*                                K2Node_HandleClientEvent_EventSource1;             // 0x0140(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UObject*                                K2Node_HandleClientEvent_EventFocus1;              // 0x0148(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortClientEvent                       K2Node_HandleClientEvent_ClientEvent1;             // 0x0150(0x0020)(ConstParm, NoDestructor)
	...
	struct FFortClientEvent                       K2Node_HandleClientEvent_ClientEvent;              // 0x0180(0x0020)(ConstParm, NoDestructor)
	...
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate1;             // 0x02D0(0x0010)(ZeroConstructor, NoDestructor)
	...
	class UFortFrontEndContext*                   CallFunc_GetContext_ReturnValue1;                  // 0x02E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial, K2Node_HandleClientEvent_EventSource1) == 0x000140, "Member 'Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial::K2Node_HandleClientEvent_EventSource1' has a wrong offset!");
static_assert(offsetof(Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial, K2Node_HandleClientEvent_EventFocus1) == 0x000148, "Member 'Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial::K2Node_HandleClientEvent_EventFocus1' has a wrong offset!");
static_assert(offsetof(Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial, K2Node_HandleClientEvent_ClientEvent1) == 0x000150, "Member 'Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial::K2Node_HandleClientEvent_ClientEvent1' has a wrong offset!");
...
static_assert(offsetof(Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial, K2Node_CreateDelegate_OutputDelegate1) == 0x0002D0, "Member 'Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial, CallFunc_GetContext_ReturnValue1) == 0x0002E8, "Member 'Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
public:
	struct FFortClientAnnouncementData_Tutorial   TutorialData;                                      // 0x0000(0x0128)(BlueprintVisible, BlueprintReadOnly, Parm)
	class UOverlaySlot*                           ContentBoxSlot;                                    // 0x0128(0x0008)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UOverlaySlot*                           CallFunc_SlotAsOverlaySlot_ReturnValue;            // 0x0260(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
{
public:
	struct FFortClientAnnouncementData_Tutorial   FortClientAnnouncementData_Tutorial;               // 0x0000(0x0128)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	...
	ESlateVisibility                              Temp_byte_Variable1;                               // 0x012C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Announcement_Tutorial_C_GetLightboxVisibility, Temp_byte_Variable1) == 0x00012C, "Member 'Announcement_Tutorial_C_GetLightboxVisibility::Temp_byte_Variable1' has a wrong offset!");
