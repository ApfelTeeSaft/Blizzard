...
public:
	...
	bool                                          CallFunc_BooleanOR_ReturnValue12;                  // 0x0007(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(Results_Badge_C_ExecuteUbergraph_Results_Badge, CallFunc_BooleanOR_ReturnValue1) == 0x000005, "Member 'Results_Badge_C_ExecuteUbergraph_Results_Badge::CallFunc_BooleanOR_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(Results_Badge_C_ExecuteUbergraph_Results_Badge, CallFunc_BooleanOR_ReturnValue12) == 0x000007, "Member 'Results_Badge_C_ExecuteUbergraph_Results_Badge::CallFunc_BooleanOR_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(Results_Badge_C_DoDesignTimeRandomization, Temp_text_Variable1) == 0x000020, "Member 'Results_Badge_C_DoDesignTimeRandomization::Temp_text_Variable1' has a wrong offset!");
static_assert(offsetof(Results_Badge_C_DoDesignTimeRandomization, Temp_text_Variable12) == 0x000038, "Member 'Results_Badge_C_DoDesignTimeRandomization::Temp_text_Variable12' has a wrong offset!");
static_assert(offsetof(Results_Badge_C_DoDesignTimeRandomization, Temp_text_Variable123) == 0x000050, "Member 'Results_Badge_C_DoDesignTimeRandomization::Temp_text_Variable123' has a wrong offset!");
