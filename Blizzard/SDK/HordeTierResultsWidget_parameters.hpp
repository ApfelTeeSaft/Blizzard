...
public:
	...
	class UMediaSource*                           K2Node_Select1_Default;                            // 0x0360(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMediaSource*                           K2Node_Select12_Default;                           // 0x0368(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(HordeTierResultsWidget_C_ChooseMediaToUse, K2Node_Select1_Default) == 0x000360, "Member 'HordeTierResultsWidget_C_ChooseMediaToUse::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(HordeTierResultsWidget_C_ChooseMediaToUse, K2Node_Select12_Default) == 0x000368, "Member 'HordeTierResultsWidget_C_ChooseMediaToUse::K2Node_Select12_Default' has a wrong offset!");
