...
static_assert(sizeof(AFrontendCamera_Manage_C) == 0x0008C0, "Wrong size on AFrontendCamera_Manage_C");
static_assert(offsetof(AFrontendCamera_Manage_C, UberGraphFrame) == 0x0008B0, "Member 'AFrontendCamera_Manage_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AFrontendCamera_Manage_C, LoginCamera_0) == 0x0008B8, "Member 'AFrontendCamera_Manage_C::LoginCamera_0' has a wrong offset!");
