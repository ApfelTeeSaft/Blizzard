...
static_assert(sizeof(ZoneDetails_C_Update) == 0x0003F8, "Wrong size on ZoneDetails_C_Update");
...
static_assert(offsetof(ZoneDetails_C_Update, CallFunc_GetCurrentBasicMissionInfo_ReturnValue) == 0x000330, "Member 'ZoneDetails_C_Update::CallFunc_GetCurrentBasicMissionInfo_ReturnValue' has a wrong offset!");
static_assert(offsetof(ZoneDetails_C_Update, K2Node_MakeStruct_FormatArgumentData) == 0x000338, "Member 'ZoneDetails_C_Update::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(ZoneDetails_C_Update, K2Node_MakeStruct_FormatArgumentData1) == 0x000378, "Member 'ZoneDetails_C_Update::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
static_assert(offsetof(ZoneDetails_C_Update, K2Node_MakeArray_Array) == 0x0003B8, "Member 'ZoneDetails_C_Update::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(ZoneDetails_C_Update, CallFunc_TextToUpper_ReturnValue) == 0x0003C8, "Member 'ZoneDetails_C_Update::CallFunc_TextToUpper_ReturnValue' has a wrong offset!");
static_assert(offsetof(ZoneDetails_C_Update, CallFunc_Format_ReturnValue) == 0x0003E0, "Member 'ZoneDetails_C_Update::CallFunc_Format_ReturnValue' has a wrong offset!");
