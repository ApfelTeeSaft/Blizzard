...
static_assert(alignof(AGCN_Generic_Stunned_C) == 0x000010, "Wrong alignment on AGCN_Generic_Stunned_C");
static_assert(sizeof(AGCN_Generic_Stunned_C) == 0x000440, "Wrong size on AGCN_Generic_Stunned_C");
