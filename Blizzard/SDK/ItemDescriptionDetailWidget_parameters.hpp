...
static_assert(offsetof(ItemDescriptionDetailWidget_C_ExecuteUbergraph_ItemDescriptionDetailWidget, K2Node_Select1_Default) == 0x000092, "Member 'ItemDescriptionDetailWidget_C_ExecuteUbergraph_ItemDescriptionDetailWidget::K2Node_Select1_Default' has a wrong offset!");
