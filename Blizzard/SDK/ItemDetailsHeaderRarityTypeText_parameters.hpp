...
static_assert(offsetof(ItemDetailsHeaderRarityTypeText_C_ExecuteUbergraph_ItemDetailsHeaderRarityTypeText, K2Node_MakeStruct_SlateColor1) == 0x000130, "Member 'ItemDetailsHeaderRarityTypeText_C_ExecuteUbergraph_ItemDetailsHeaderRarityTypeText::K2Node_MakeStruct_SlateColor1' has a wrong offset!");
static_assert(offsetof(ItemDetailsHeaderRarityTypeText_C_ExecuteUbergraph_ItemDetailsHeaderRarityTypeText, K2Node_MakeStruct_SlateColor12) == 0x000158, "Member 'ItemDetailsHeaderRarityTypeText_C_ExecuteUbergraph_ItemDetailsHeaderRarityTypeText::K2Node_MakeStruct_SlateColor12' has a wrong offset!");
