...
static_assert(offsetof(UMinibossDetails_C, Kill_Animation) == 0x000260, "Member 'UMinibossDetails_C::Kill_Animation' has a wrong offset!");
static_assert(offsetof(UMinibossDetails_C, Outro_Animation) == 0x000268, "Member 'UMinibossDetails_C::Outro_Animation' has a wrong offset!");
static_assert(offsetof(UMinibossDetails_C, Intro_Animation) == 0x000270, "Member 'UMinibossDetails_C::Intro_Animation' has a wrong offset!");
