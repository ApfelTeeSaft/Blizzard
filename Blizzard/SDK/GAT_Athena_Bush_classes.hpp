...
static_assert(sizeof(UGAT_Athena_Bush_C) == 0x000AD0, "Wrong size on UGAT_Athena_Bush_C");
static_assert(offsetof(UGAT_Athena_Bush_C, UberGraphFrame_GAT_Athena_Bush_C) == 0x000AC0, "Member 'UGAT_Athena_Bush_C::UberGraphFrame_GAT_Athena_Bush_C' has a wrong offset!");
static_assert(offsetof(UGAT_Athena_Bush_C, PlayerPawn) == 0x000AC8, "Member 'UGAT_Athena_Bush_C::PlayerPawn' has a wrong offset!");
