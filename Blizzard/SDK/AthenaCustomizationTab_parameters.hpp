...
public:
	...
	TArray<class UAthenaCustomizationSlotButtonWrapper_C*> K2Node_MakeArray_Array;                   // 0x00C8(0x0010)(ZeroConstructor, ReferenceParm)
	class UFortItem*                              K2Node_ComponentBoundEvent_SelectedItem;           // 0x00D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(AthenaCustomizationTab_C_ExecuteUbergraph_AthenaCustomizationTab) == 0x0000E0, "Wrong size on AthenaCustomizationTab_C_ExecuteUbergraph_AthenaCustomizationTab");
...
static_assert(offsetof(AthenaCustomizationTab_C_ExecuteUbergraph_AthenaCustomizationTab, K2Node_ComponentBoundEvent_Button1) == 0x000070, "Member 'AthenaCustomizationTab_C_ExecuteUbergraph_AthenaCustomizationTab::K2Node_ComponentBoundEvent_Button1' has a wrong offset!");
...
static_assert(offsetof(AthenaCustomizationTab_C_ExecuteUbergraph_AthenaCustomizationTab, K2Node_ComponentBoundEvent_Button) == 0x0000A0, "Member 'AthenaCustomizationTab_C_ExecuteUbergraph_AthenaCustomizationTab::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
...
static_assert(offsetof(AthenaCustomizationTab_C_ExecuteUbergraph_AthenaCustomizationTab, K2Node_MakeArray_Array) == 0x0000C8, "Member 'AthenaCustomizationTab_C_ExecuteUbergraph_AthenaCustomizationTab::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(AthenaCustomizationTab_C_ExecuteUbergraph_AthenaCustomizationTab, K2Node_ComponentBoundEvent_SelectedItem) == 0x0000D8, "Member 'AthenaCustomizationTab_C_ExecuteUbergraph_AthenaCustomizationTab::K2Node_ComponentBoundEvent_SelectedItem' has a wrong offset!");
...
public:
	...
	class UProgressModalWidget_C*                 CallFunc_Create_ReturnValue;                       // 0x00C0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AthenaCustomizationTab_C_ShowSavingModal) == 0x0000D0, "Wrong size on AthenaCustomizationTab_C_ShowSavingModal");
...
static_assert(offsetof(AthenaCustomizationTab_C_ShowSavingModal, CallFunc_IsValid_ReturnValue) == 0x0000B0, "Member 'AthenaCustomizationTab_C_ShowSavingModal::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaCustomizationTab_C_ShowSavingModal, CallFunc_GetOwningPlayer_ReturnValue) == 0x0000B8, "Member 'AthenaCustomizationTab_C_ShowSavingModal::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaCustomizationTab_C_ShowSavingModal, CallFunc_Create_ReturnValue) == 0x0000C0, "Member 'AthenaCustomizationTab_C_ShowSavingModal::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaCustomizationTab_C_ShowSavingModal, CallFunc_GetUIManagerWidget_ReturnValue) == 0x0000C8, "Member 'AthenaCustomizationTab_C_ShowSavingModal::CallFunc_GetUIManagerWidget_ReturnValue' has a wrong offset!");
...
public:
	...
	class UFortItem*                              CallFunc_GetFavoriteItemForCategory_ReturnValue;   // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(AthenaCustomizationTab_C_ShowVaultItemByCategory, CallFunc_GetFavoriteItemForCategory_ReturnValue) == 0x000018, "Member 'AthenaCustomizationTab_C_ShowVaultItemByCategory::CallFunc_GetFavoriteItemForCategory_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaCustomizationTab_C_ShowVaultItemByCategory, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000020, "Member 'AthenaCustomizationTab_C_ShowVaultItemByCategory::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaCustomizationTab_C_ShowVaultItemByCategory, CallFunc_IsValid_ReturnValue) == 0x000021, "Member 'AthenaCustomizationTab_C_ShowVaultItemByCategory::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaCustomizationTab_C_ShowVaultItemByCategory, CallFunc_GetItemDefinitionBP_ReturnValue) == 0x000028, "Member 'AthenaCustomizationTab_C_ShowVaultItemByCategory::CallFunc_GetItemDefinitionBP_ReturnValue' has a wrong offset!");
