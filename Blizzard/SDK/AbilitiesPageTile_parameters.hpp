...
static_assert(sizeof(AbilitiesPageTile_C_SetAbilityItemInfo) == 0x0000B8, "Wrong size on AbilitiesPageTile_C_SetAbilityItemInfo");
...
static_assert(offsetof(AbilitiesPageTile_C_UpdateKeyBinding, CallFunc_IsValid_ReturnValue1) == 0x000011, "Member 'AbilitiesPageTile_C_UpdateKeyBinding::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AbilitiesPageTile_C_UpdateKeyBinding, CallFunc_IsValid_ReturnValue12) == 0x000012, "Member 'AbilitiesPageTile_C_UpdateKeyBinding::CallFunc_IsValid_ReturnValue12' has a wrong offset!");
...
static_assert(sizeof(AbilitiesPageTile_C_SetAbilityPerkInfo) == 0x000158, "Wrong size on AbilitiesPageTile_C_SetAbilityPerkInfo");
...
static_assert(offsetof(AbilitiesPageTile_C_SetAbilityPerkInfo, CallFunc_BP_GetGadgets_GadgetItemDefinitions) == 0x000098, "Member 'AbilitiesPageTile_C_SetAbilityPerkInfo::CallFunc_BP_GetGadgets_GadgetItemDefinitions' has a wrong offset!");
static_assert(offsetof(AbilitiesPageTile_C_SetAbilityPerkInfo, CallFunc_Array_Get_Item) == 0x0000A8, "Member 'AbilitiesPageTile_C_SetAbilityPerkInfo::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(AbilitiesPageTile_C_SetAbilityPerkInfo, K2Node_MakeStruct_SlateColor) == 0x0000B0, "Member 'AbilitiesPageTile_C_SetAbilityPerkInfo::K2Node_MakeStruct_SlateColor' has a wrong offset!");
static_assert(offsetof(AbilitiesPageTile_C_SetAbilityPerkInfo, CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue) == 0x0000D8, "Member 'AbilitiesPageTile_C_SetAbilityPerkInfo::CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilitiesPageTile_C_SetAbilityPerkInfo, CallFunc_GetGrantedAbilityKit_ReturnValue) == 0x000150, "Member 'AbilitiesPageTile_C_SetAbilityPerkInfo::CallFunc_GetGrantedAbilityKit_ReturnValue' has a wrong offset!");
