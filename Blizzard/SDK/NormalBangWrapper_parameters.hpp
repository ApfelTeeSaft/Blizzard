...
static_assert(offsetof(NormalBangWrapper_C_ExecuteUbergraph_NormalBangWrapper, Temp_byte_Variable1) == 0x000006, "Member 'NormalBangWrapper_C_ExecuteUbergraph_NormalBangWrapper::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(NormalBangWrapper_C_Update_Bang_Icon_Version, Temp_int_Variable12) == 0x000010, "Member 'NormalBangWrapper_C_Update_Bang_Icon_Version::Temp_int_Variable12' has a wrong offset!");
static_assert(offsetof(NormalBangWrapper_C_Update_Bang_Icon_Version, Temp_int_Variable123) == 0x000014, "Member 'NormalBangWrapper_C_Update_Bang_Icon_Version::Temp_int_Variable123' has a wrong offset!");
