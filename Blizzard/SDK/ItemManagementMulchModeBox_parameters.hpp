...
static_assert(offsetof(ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox, K2Node_CreateDelegate_OutputDelegate1) == 0x000040, "Member 'ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox, K2Node_DynamicCast_AsItem_Management_Mulch_Details_Panel1) == 0x000050, "Member 'ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox::K2Node_DynamicCast_AsItem_Management_Mulch_Details_Panel1' has a wrong offset!");
static_assert(offsetof(ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox, K2Node_DynamicCast_bSuccess1) == 0x000058, "Member 'ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
static_assert(offsetof(ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox, K2Node_CreateDelegate_OutputDelegate12) == 0x000060, "Member 'ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
...
static_assert(offsetof(ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox, K2Node_MakeStruct_DataTableRowHandle1) == 0x000078, "Member 'ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox::K2Node_MakeStruct_DataTableRowHandle1' has a wrong offset!");
static_assert(offsetof(ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox, K2Node_CreateDelegate_OutputDelegate123) == 0x000088, "Member 'ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox::K2Node_CreateDelegate_OutputDelegate123' has a wrong offset!");
...
static_assert(offsetof(ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox, CallFunc_GetContext_ReturnValue1) == 0x0000A0, "Member 'ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox, K2Node_CreateDelegate_OutputDelegate1234) == 0x0000A8, "Member 'ItemManagementMulchModeBox_C_ExecuteUbergraph_ItemManagementMulchModeBox::K2Node_CreateDelegate_OutputDelegate1234' has a wrong offset!");
...
static_assert(offsetof(ItemManagementMulchModeBox_C_HandleMulchListChanged, Temp_byte_Variable1) == 0x000002, "Member 'ItemManagementMulchModeBox_C_HandleMulchListChanged::Temp_byte_Variable1' has a wrong offset!");
