...
static_assert(offsetof(PopupCenterMessageModalPanel_C_LeaveZone, CallFunc_GetContext_ReturnValue1) == 0x000008, "Member 'PopupCenterMessageModalPanel_C_LeaveZone::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
