...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GAT_GenericTriggeredAbility_C;      // 0x0AC0(0x0008)(Transient, DuplicateTransient)
...
static_assert(sizeof(UGAT_GenericTriggeredAbility_C) == 0x000B80, "Wrong size on UGAT_GenericTriggeredAbility_C");
static_assert(offsetof(UGAT_GenericTriggeredAbility_C, UberGraphFrame_GAT_GenericTriggeredAbility_C) == 0x000AC0, "Member 'UGAT_GenericTriggeredAbility_C::UberGraphFrame_GAT_GenericTriggeredAbility_C' has a wrong offset!");
static_assert(offsetof(UGAT_GenericTriggeredAbility_C, EventData) == 0x000AC8, "Member 'UGAT_GenericTriggeredAbility_C::EventData' has a wrong offset!");
static_assert(offsetof(UGAT_GenericTriggeredAbility_C, FortPlayerPawn) == 0x000B70, "Member 'UGAT_GenericTriggeredAbility_C::FortPlayerPawn' has a wrong offset!");
static_assert(offsetof(UGAT_GenericTriggeredAbility_C, isAutoCommitted) == 0x000B78, "Member 'UGAT_GenericTriggeredAbility_C::isAutoCommitted' has a wrong offset!");
static_assert(offsetof(UGAT_GenericTriggeredAbility_C, isStaminaLockedOut) == 0x000B79, "Member 'UGAT_GenericTriggeredAbility_C::isStaminaLockedOut' has a wrong offset!");
