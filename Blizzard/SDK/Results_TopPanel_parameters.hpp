...
static_assert(offsetof(Results_TopPanel_C_Initialize, K2Node_MakeStruct_FormatArgumentData1) == 0x0003E0, "Member 'Results_TopPanel_C_Initialize::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
