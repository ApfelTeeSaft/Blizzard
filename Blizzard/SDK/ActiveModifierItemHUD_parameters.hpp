...
{
public:
	struct FSlateBrush                            inIconSlateBrush;                                  // 0x0000(0x0078)(BlueprintVisible, BlueprintReadOnly, Parm)
};
static_assert(alignof(ActiveModifierItemHUD_C_AssignIcon) == 0x000008, "Wrong alignment on ActiveModifierItemHUD_C_AssignIcon");
static_assert(sizeof(ActiveModifierItemHUD_C_AssignIcon) == 0x000078, "Wrong size on ActiveModifierItemHUD_C_AssignIcon");
