...
static_assert(offsetof(GCN_TakerMarkedForDeath_C_ExecuteUbergraph_GCN_TakerMarkedForDeath, CallFunc_GetOwner_ReturnValue1) == 0x000020, "Member 'GCN_TakerMarkedForDeath_C_ExecuteUbergraph_GCN_TakerMarkedForDeath::CallFunc_GetOwner_ReturnValue1' has a wrong offset!");
static_assert(offsetof(GCN_TakerMarkedForDeath_C_ExecuteUbergraph_GCN_TakerMarkedForDeath, K2Node_DynamicCast_AsFort_Pawn1) == 0x000028, "Member 'GCN_TakerMarkedForDeath_C_ExecuteUbergraph_GCN_TakerMarkedForDeath::K2Node_DynamicCast_AsFort_Pawn1' has a wrong offset!");
static_assert(offsetof(GCN_TakerMarkedForDeath_C_ExecuteUbergraph_GCN_TakerMarkedForDeath, K2Node_DynamicCast_bSuccess1) == 0x000030, "Member 'GCN_TakerMarkedForDeath_C_ExecuteUbergraph_GCN_TakerMarkedForDeath::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
