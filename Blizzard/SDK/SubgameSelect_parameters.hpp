...
static_assert(offsetof(SubgameSelect_C_ExecuteUbergraph_SubgameSelect, CallFunc_GetContext_ReturnValue1) == 0x000020, "Member 'SubgameSelect_C_ExecuteUbergraph_SubgameSelect::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(SubgameSelect_C_ExecuteUbergraph_SubgameSelect, K2Node_Event_NextUIState) == 0x000033, "Member 'SubgameSelect_C_ExecuteUbergraph_SubgameSelect::K2Node_Event_NextUIState' has a wrong offset!");

// Function SubgameSelect.SubgameSelect_C.OnExitState
// 0x0001 (0x0001 - 0x0000)
struct SubgameSelect_C_OnExitState final
{
public:
...
static_assert(alignof(SubgameSelect_C_OnExitState) == 0x000001, "Wrong alignment on SubgameSelect_C_OnExitState");
static_assert(sizeof(SubgameSelect_C_OnExitState) == 0x000001, "Wrong size on SubgameSelect_C_OnExitState");
static_assert(offsetof(SubgameSelect_C_OnExitState, NextUIState) == 0x000000, "Member 'SubgameSelect_C_OnExitState::NextUIState' has a wrong offset!");
...
static_assert(offsetof(SubgameSelect_C_UpdateHeaderAndFooter, Temp_byte_Variable1) == 0x000004, "Member 'SubgameSelect_C_UpdateHeaderAndFooter::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(SubgameSelect_C_UpdateHeaderAndFooter, Temp_bool_Variable1) == 0x000005, "Member 'SubgameSelect_C_UpdateHeaderAndFooter::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(SubgameSelect_C_UpdateHeaderAndFooter, Temp_byte_Variable12) == 0x000007, "Member 'SubgameSelect_C_UpdateHeaderAndFooter::Temp_byte_Variable12' has a wrong offset!");
static_assert(offsetof(SubgameSelect_C_UpdateHeaderAndFooter, Temp_byte_Variable123) == 0x000008, "Member 'SubgameSelect_C_UpdateHeaderAndFooter::Temp_byte_Variable123' has a wrong offset!");
static_assert(offsetof(SubgameSelect_C_UpdateHeaderAndFooter, K2Node_Select1_Default) == 0x000009, "Member 'SubgameSelect_C_UpdateHeaderAndFooter::K2Node_Select1_Default' has a wrong offset!");
