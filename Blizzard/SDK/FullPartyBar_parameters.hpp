...
static_assert(offsetof(FullPartyBar_C_BindDelegates, CallFunc_GetContext_ReturnValue1) == 0x000018, "Member 'FullPartyBar_C_BindDelegates::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(sizeof(FullPartyBar_C_HandlePartybarUIFeatureChanged) == 0x00000A, "Wrong size on FullPartyBar_C_HandlePartybarUIFeatureChanged");
...
static_assert(offsetof(FullPartyBar_C_HandlePartybarUIFeatureChanged, Reason) == 0x000002, "Member 'FullPartyBar_C_HandlePartybarUIFeatureChanged::Reason' has a wrong offset!");
...
static_assert(sizeof(FullPartyBar_C_isTeammateSlotPopulated) == 0x000050, "Wrong size on FullPartyBar_C_isTeammateSlotPopulated");
...
static_assert(offsetof(FullPartyBar_C_isTeammateSlotPopulated, CallFunc_Array_IsValidIndex_ReturnValue) == 0x000018, "Member 'FullPartyBar_C_isTeammateSlotPopulated::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(FullPartyBar_C_isTeammateSlotPopulated, CallFunc_Array_Get_Item) == 0x000020, "Member 'FullPartyBar_C_isTeammateSlotPopulated::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(FullPartyBar_C_isTeammateSlotPopulated, CallFunc_IsValidNetID_ReturnValue) == 0x000048, "Member 'FullPartyBar_C_isTeammateSlotPopulated::CallFunc_IsValidNetID_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(FullPartyBar_C_GetTooltipStat) == 0x000150, "Wrong size on FullPartyBar_C_GetTooltipStat");
...
static_assert(offsetof(FullPartyBar_C_GetTooltipStat, CallFunc_GetPlayerInfoFromUniqueID_ReturnValue) == 0x0000D0, "Member 'FullPartyBar_C_GetTooltipStat::CallFunc_GetPlayerInfoFromUniqueID_ReturnValue' has a wrong offset!");
static_assert(offsetof(FullPartyBar_C_GetTooltipStat, CallFunc_GetTooltipStat_OutDisplayAttribute) == 0x0000D8, "Member 'FullPartyBar_C_GetTooltipStat::CallFunc_GetTooltipStat_OutDisplayAttribute' has a wrong offset!");
static_assert(offsetof(FullPartyBar_C_GetTooltipStat, CallFunc_GetTooltipStat_ReturnValue) == 0x000148, "Member 'FullPartyBar_C_GetTooltipStat::CallFunc_GetTooltipStat_ReturnValue' has a wrong offset!");
