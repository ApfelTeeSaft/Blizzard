...
public:
	...
	class FText                                   CallFunc_Format_ReturnValue1;                      // 0x0110(0x0018)()
...
static_assert(offsetof(XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression, K2Node_MakeStruct_FormatArgumentData1) == 0x000098, "Member 'XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
...
static_assert(offsetof(XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression, K2Node_MakeArray_Array1) == 0x0000E8, "Member 'XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression::K2Node_MakeArray_Array1' has a wrong offset!");
...
static_assert(offsetof(XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression, CallFunc_Format_ReturnValue1) == 0x000110, "Member 'XpMatchProgression_C_ExecuteUbergraph_XpMatchProgression::CallFunc_Format_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(XpMatchProgression_C_IsReadyForNextXpEvent, CallFunc_IsReadyForNextXpReward_Ready1) == 0x000002, "Member 'XpMatchProgression_C_IsReadyForNextXpEvent::CallFunc_IsReadyForNextXpReward_Ready1' has a wrong offset!");
