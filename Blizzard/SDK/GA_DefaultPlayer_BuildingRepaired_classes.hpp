...
static_assert(sizeof(UGA_DefaultPlayer_BuildingRepaired_C) == 0x000AB8, "Wrong size on UGA_DefaultPlayer_BuildingRepaired_C");
static_assert(offsetof(UGA_DefaultPlayer_BuildingRepaired_C, UberGraphFrame) == 0x000AB0, "Member 'UGA_DefaultPlayer_BuildingRepaired_C::UberGraphFrame' has a wrong offset!");
