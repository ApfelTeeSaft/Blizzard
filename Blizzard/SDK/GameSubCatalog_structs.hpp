...
public:
	...
	class FString                                 AppStoreId[0x8];                                   // 0x00F8(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FCatalogMetaAssetInfo                  MetaAssetInfo;                                     // 0x0178(0x0030)(NativeAccessSpecifierPublic)
	class FString                                 DisplayAssetPath;                                  // 0x01A8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FItemQuantity>                  ItemGrants;                                        // 0x01B8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FCatalogOfferRequirement>       Requirements;                                      // 0x01C8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FCatalogGiftInfo                       GiftInfo;                                          // 0x01D8(0x0028)(NativeAccessSpecifierPublic)
	TArray<class FString>                         DenyItemTemplateIds;                               // 0x0200(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FCatalogOffer) == 0x000008, "Wrong alignment on FCatalogOffer");
static_assert(sizeof(FCatalogOffer) == 0x000210, "Wrong size on FCatalogOffer");
...
static_assert(offsetof(FCatalogOffer, MetaAssetInfo) == 0x000178, "Member 'FCatalogOffer::MetaAssetInfo' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, DisplayAssetPath) == 0x0001A8, "Member 'FCatalogOffer::DisplayAssetPath' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, ItemGrants) == 0x0001B8, "Member 'FCatalogOffer::ItemGrants' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, Requirements) == 0x0001C8, "Member 'FCatalogOffer::Requirements' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, GiftInfo) == 0x0001D8, "Member 'FCatalogOffer::GiftInfo' has a wrong offset!");
static_assert(offsetof(FCatalogOffer, DenyItemTemplateIds) == 0x000200, "Member 'FCatalogOffer::DenyItemTemplateIds' has a wrong offset!");
