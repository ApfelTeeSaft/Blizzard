...
public:
	...
	ESlateVisibility                              K2Node_Select12_Default;                           // 0x0021(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(AthenaTeamMemberDBNOState_C_RefreshVisuals, Temp_bool_Variable1) == 0x000002, "Member 'AthenaTeamMemberDBNOState_C_RefreshVisuals::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(AthenaTeamMemberDBNOState_C_RefreshVisuals, Temp_byte_Variable1) == 0x000003, "Member 'AthenaTeamMemberDBNOState_C_RefreshVisuals::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(AthenaTeamMemberDBNOState_C_RefreshVisuals, Temp_byte_Variable12) == 0x000004, "Member 'AthenaTeamMemberDBNOState_C_RefreshVisuals::Temp_byte_Variable12' has a wrong offset!");
static_assert(offsetof(AthenaTeamMemberDBNOState_C_RefreshVisuals, Temp_bool_Variable12) == 0x000005, "Member 'AthenaTeamMemberDBNOState_C_RefreshVisuals::Temp_bool_Variable12' has a wrong offset!");
...
static_assert(offsetof(AthenaTeamMemberDBNOState_C_RefreshVisuals, Temp_object_Variable1) == 0x000010, "Member 'AthenaTeamMemberDBNOState_C_RefreshVisuals::Temp_object_Variable1' has a wrong offset!");
...
static_assert(offsetof(AthenaTeamMemberDBNOState_C_RefreshVisuals, K2Node_Select1_Default) == 0x000020, "Member 'AthenaTeamMemberDBNOState_C_RefreshVisuals::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(AthenaTeamMemberDBNOState_C_RefreshVisuals, K2Node_Select12_Default) == 0x000021, "Member 'AthenaTeamMemberDBNOState_C_RefreshVisuals::K2Node_Select12_Default' has a wrong offset!");
