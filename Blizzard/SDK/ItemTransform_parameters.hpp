...
public:
	...
	TDelegate<void(const TArray<struct FFortItemInstanceQuantityPair>& TransmoggedItems, const TArray<struct FFortItemInstanceQuantityPair>& RecycledItems)> K2Node_CreateDelegate_OutputDelegate; // 0x0010(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(const class FText& ErrorMessage)> K2Node_CreateDelegate_OutputDelegate1;          // 0x0020(0x0010)(ZeroConstructor, NoDestructor)
	class UWidget*                                K2Node_ComponentBoundEvent_ActiveWidget;           // 0x0030(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_HandleSelect_PassThrough;                 // 0x003D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_ComponentBoundEvent_TransformActive;        // 0x003E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UFortItem*                              K2Node_ComponentBoundEvent_Key;                    // 0x0090(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	const class UFortItem*                        Temp_object_Variable;                              // 0x0098(0x0008)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, CallFunc_GetContext_ReturnValue) == 0x000008, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, K2Node_CreateDelegate_OutputDelegate) == 0x000010, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, K2Node_CreateDelegate_OutputDelegate1) == 0x000020, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, K2Node_ComponentBoundEvent_ActiveWidget) == 0x000030, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::K2Node_ComponentBoundEvent_ActiveWidget' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, K2Node_ComponentBoundEvent_ActiveWidgetIndex) == 0x000038, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::K2Node_ComponentBoundEvent_ActiveWidgetIndex' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, K2Node_SwitchInteger_CmpSuccess) == 0x00003C, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::K2Node_SwitchInteger_CmpSuccess' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, CallFunc_HandleSelect_PassThrough) == 0x00003D, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::CallFunc_HandleSelect_PassThrough' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, K2Node_ComponentBoundEvent_TransformActive) == 0x00003E, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::K2Node_ComponentBoundEvent_TransformActive' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, CallFunc_GetActiveWidgetIndex_ReturnValue) == 0x000040, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::CallFunc_GetActiveWidgetIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000044, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, K2Node_CreateDelegate_OutputDelegate123) == 0x000058, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::K2Node_CreateDelegate_OutputDelegate123' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, Temp_int_Variable) == 0x000068, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, CallFunc_GetContext_ReturnValue1) == 0x000070, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000078, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, CallFunc_Add_IntInt_ReturnValue) == 0x00007C, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, K2Node_ComponentBoundEvent_Key) == 0x000090, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::K2Node_ComponentBoundEvent_Key' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, Temp_object_Variable) == 0x000098, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_ExecuteUbergraph_ItemTransform, CallFunc_Array_Add_ReturnValue) == 0x0000A0, "Member 'ItemTransform_C_ExecuteUbergraph_ItemTransform::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemTransform_C_OpenConfirmation, K2Node_CreateDelegate_OutputDelegate1) == 0x000018, "Member 'ItemTransform_C_OpenConfirmation::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct ItemTransform_C_HandleTransformCancel final
{
public:
...
static_assert(alignof(ItemTransform_C_HandleTransformCancel) == 0x000004, "Wrong alignment on ItemTransform_C_HandleTransformCancel");
static_assert(sizeof(ItemTransform_C_HandleTransformCancel) == 0x000008, "Wrong size on ItemTransform_C_HandleTransformCancel");
static_assert(offsetof(ItemTransform_C_HandleTransformCancel, CallFunc_GetActiveWidgetIndex_ReturnValue) == 0x000000, "Member 'ItemTransform_C_HandleTransformCancel::CallFunc_GetActiveWidgetIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_HandleTransformCancel, K2Node_SwitchInteger_CmpSuccess) == 0x000004, "Member 'ItemTransform_C_HandleTransformCancel::K2Node_SwitchInteger_CmpSuccess' has a wrong offset!");
...
static_assert(sizeof(ItemTransform_C_OpenResult) == 0x000050, "Wrong size on ItemTransform_C_OpenResult");
...
static_assert(offsetof(ItemTransform_C_OpenResult, CallFunc_GetContext_ReturnValue) == 0x000028, "Member 'ItemTransform_C_OpenResult::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_OpenResult, CallFunc_GetUIManagerWidget_ReturnValue) == 0x000030, "Member 'ItemTransform_C_OpenResult::CallFunc_GetUIManagerWidget_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_OpenResult, CallFunc_GetCachedWidget_ReturnValue) == 0x000038, "Member 'ItemTransform_C_OpenResult::CallFunc_GetCachedWidget_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_OpenResult, K2Node_DynamicCast_AsItem_Transform_Result_Modal) == 0x000040, "Member 'ItemTransform_C_OpenResult::K2Node_DynamicCast_AsItem_Transform_Result_Modal' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_OpenResult, K2Node_DynamicCast_bSuccess) == 0x000048, "Member 'ItemTransform_C_OpenResult::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(ItemTransform_C_OpenResult, CallFunc_IsValid_ReturnValue) == 0x000049, "Member 'ItemTransform_C_OpenResult::CallFunc_IsValid_ReturnValue' has a wrong offset!");
