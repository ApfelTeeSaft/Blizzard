...
static_assert(offsetof(PanelButton_C_ExecuteUbergraph_PanelButton, Temp_byte_Variable1) == 0x000005, "Member 'PanelButton_C_ExecuteUbergraph_PanelButton::Temp_byte_Variable1' has a wrong offset!");
