...
static_assert(offsetof(QuickbarPrimary_C_ExecuteUbergraph_QuickbarPrimary, K2Node_CreateDelegate_OutputDelegate1) == 0x000048, "Member 'QuickbarPrimary_C_ExecuteUbergraph_QuickbarPrimary::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(QuickbarPrimary_C_ExecuteUbergraph_QuickbarPrimary, CallFunc_GetContext_ReturnValue12) == 0x000058, "Member 'QuickbarPrimary_C_ExecuteUbergraph_QuickbarPrimary::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(QuickbarPrimary_C_ExecuteUbergraph_QuickbarPrimary, CallFunc_GetContext_ReturnValue123) == 0x000068, "Member 'QuickbarPrimary_C_ExecuteUbergraph_QuickbarPrimary::CallFunc_GetContext_ReturnValue123' has a wrong offset!");
