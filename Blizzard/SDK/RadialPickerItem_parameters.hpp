...
static_assert(offsetof(RadialPickerItem_C_SetSelected, Temp_byte_Variable1) == 0x000002, "Member 'RadialPickerItem_C_SetSelected::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(RadialPickerItem_C_SetSelected, K2Node_MakeStruct_SlateColor1) == 0x000050, "Member 'RadialPickerItem_C_SetSelected::K2Node_MakeStruct_SlateColor1' has a wrong offset!");
