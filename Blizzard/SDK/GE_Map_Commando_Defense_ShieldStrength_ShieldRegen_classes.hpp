...
static_assert(sizeof(UGE_Map_Commando_Defense_ShieldStrength_ShieldRegen_C) == 0x000670, "Wrong size on UGE_Map_Commando_Defense_ShieldStrength_ShieldRegen_C");
