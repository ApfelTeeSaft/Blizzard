...
static_assert(sizeof(AUIMapManager_C) == 0x000488, "Wrong size on AUIMapManager_C");
static_assert(offsetof(AUIMapManager_C, DefaultSceneRoot) == 0x000480, "Member 'AUIMapManager_C::DefaultSceneRoot' has a wrong offset!");
