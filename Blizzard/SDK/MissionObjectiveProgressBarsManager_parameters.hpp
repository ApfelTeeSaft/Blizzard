...
public:
	...
	int32                                         CallFunc_Subtract_IntInt_ReturnValue12;            // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Greater_IntInt_ReturnValue;               // 0x0024(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_25[0x3];                                       // 0x0025(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_Subtract_IntInt_ReturnValue123;           // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UMissionObjectiveProgress_C*            K2Node_DynamicCast_AsMission_Objective_Progress;   // 0x0048(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_Subtract_IntInt_ReturnValue1234;          // 0x005C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_LessEqual_IntInt_ReturnValue1;            // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Greater_IntInt_ReturnValue12;             // 0x0061(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars, CallFunc_Subtract_IntInt_ReturnValue1) == 0x000018, "Member 'MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars::CallFunc_Subtract_IntInt_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars, CallFunc_Subtract_IntInt_ReturnValue12) == 0x000020, "Member 'MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars::CallFunc_Subtract_IntInt_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars, CallFunc_Subtract_IntInt_ReturnValue123) == 0x000028, "Member 'MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars::CallFunc_Subtract_IntInt_ReturnValue123' has a wrong offset!");
static_assert(offsetof(MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars, Temp_int_Variable1) == 0x00002C, "Member 'MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars::Temp_int_Variable1' has a wrong offset!");
static_assert(offsetof(MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars, CallFunc_Greater_IntInt_ReturnValue1) == 0x000030, "Member 'MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars::CallFunc_Greater_IntInt_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars, CallFunc_Add_IntInt_ReturnValue1) == 0x000034, "Member 'MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars, CallFunc_Subtract_IntInt_ReturnValue1234) == 0x00005C, "Member 'MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars::CallFunc_Subtract_IntInt_ReturnValue1234' has a wrong offset!");
static_assert(offsetof(MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars, CallFunc_LessEqual_IntInt_ReturnValue1) == 0x000060, "Member 'MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars::CallFunc_LessEqual_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars, CallFunc_Greater_IntInt_ReturnValue12) == 0x000061, "Member 'MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars::CallFunc_Greater_IntInt_ReturnValue12' has a wrong offset!");
...
public:
	...
	TDelegate<void(const class AFortObjectiveBase* Objective, EFortObjectiveStatus NewStatus)> K2Node_CreateDelegate_OutputDelegate12; // 0x0030(0x0010)(ZeroConstructor, NoDestructor)
};
...
static_assert(offsetof(MissionObjectiveProgressBarsManager_C_Setup, K2Node_CreateDelegate_OutputDelegate1) == 0x000020, "Member 'MissionObjectiveProgressBarsManager_C_Setup::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(MissionObjectiveProgressBarsManager_C_Setup, K2Node_CreateDelegate_OutputDelegate12) == 0x000030, "Member 'MissionObjectiveProgressBarsManager_C_Setup::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
