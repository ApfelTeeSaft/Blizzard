...
public:
	...
	struct FInputEvent                            CallFunc_GetInputEventFromPointerEvent_ReturnValue; // 0x00B0(0x0018)()
	bool                                          CallFunc_InputEvent_IsShiftDown_ReturnValue;       // 0x00C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	EFortItemCardSize                             CallFunc_GetCardSize_ReturnValue;                  // 0x00C9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UAthenaInventoryDragVisual_C*           CallFunc_Create_ReturnValue;                       // 0x00D8(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(AthenaInventoryFortItemTileButton_C_OnDragDetected) == 0x0000E0, "Wrong size on AthenaInventoryFortItemTileButton_C_OnDragDetected");
...
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_OnDragDetected, Operation) == 0x0000A0, "Member 'AthenaInventoryFortItemTileButton_C_OnDragDetected::Operation' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_OnDragDetected, CallFunc_CreateDragDropOperation_ReturnValue) == 0x0000A8, "Member 'AthenaInventoryFortItemTileButton_C_OnDragDetected::CallFunc_CreateDragDropOperation_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_OnDragDetected, CallFunc_GetInputEventFromPointerEvent_ReturnValue) == 0x0000B0, "Member 'AthenaInventoryFortItemTileButton_C_OnDragDetected::CallFunc_GetInputEventFromPointerEvent_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_OnDragDetected, CallFunc_InputEvent_IsShiftDown_ReturnValue) == 0x0000C8, "Member 'AthenaInventoryFortItemTileButton_C_OnDragDetected::CallFunc_InputEvent_IsShiftDown_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_OnDragDetected, CallFunc_GetCardSize_ReturnValue) == 0x0000C9, "Member 'AthenaInventoryFortItemTileButton_C_OnDragDetected::CallFunc_GetCardSize_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_OnDragDetected, CallFunc_GetOwningPlayer_ReturnValue) == 0x0000D0, "Member 'AthenaInventoryFortItemTileButton_C_OnDragDetected::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_OnDragDetected, CallFunc_Create_ReturnValue) == 0x0000D8, "Member 'AthenaInventoryFortItemTileButton_C_OnDragDetected::CallFunc_Create_ReturnValue' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_IsUsingGamepad_ReturnValue;               // 0x02D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FEventReply                            CallFunc_Unhandled_ReturnValue1;                   // 0x02D8(0x00B8)()
};
...
static_assert(sizeof(AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown) == 0x000390, "Wrong size on AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown");
...
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown, ReturnValue) == 0x0000A0, "Member 'AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown::ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown, CallFunc_Unhandled_ReturnValue) == 0x000158, "Member 'AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown::CallFunc_Unhandled_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown, CallFunc_GetContext_ReturnValue) == 0x000210, "Member 'AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown, CallFunc_DetectDrag_ReturnValue) == 0x000218, "Member 'AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown::CallFunc_DetectDrag_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown, CallFunc_IsUsingGamepad_ReturnValue) == 0x0002D0, "Member 'AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown::CallFunc_IsUsingGamepad_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown, CallFunc_Not_PreBool_ReturnValue) == 0x0002D1, "Member 'AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown, CallFunc_Unhandled_ReturnValue1) == 0x0002D8, "Member 'AthenaInventoryFortItemTileButton_C_On_ItemWidgetHolder_MouseButtonDown::CallFunc_Unhandled_ReturnValue1' has a wrong offset!");
...
public:
	...
	bool                                          ValidDrop;                                         // 0x00A9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(AthenaInventoryFortItemTileButton_C_OnDrop) == 0x0000C0, "Wrong size on AthenaInventoryFortItemTileButton_C_OnDrop");
...
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_OnDrop, Operation) == 0x0000A0, "Member 'AthenaInventoryFortItemTileButton_C_OnDrop::Operation' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_OnDrop, ReturnValue) == 0x0000A8, "Member 'AthenaInventoryFortItemTileButton_C_OnDrop::ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_OnDrop, ValidDrop) == 0x0000A9, "Member 'AthenaInventoryFortItemTileButton_C_OnDrop::ValidDrop' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_OnDrop, K2Node_DynamicCast_AsFort_Item) == 0x0000B0, "Member 'AthenaInventoryFortItemTileButton_C_OnDrop::K2Node_DynamicCast_AsFort_Item' has a wrong offset!");
static_assert(offsetof(AthenaInventoryFortItemTileButton_C_OnDrop, K2Node_DynamicCast_bSuccess) == 0x0000B8, "Member 'AthenaInventoryFortItemTileButton_C_OnDrop::K2Node_DynamicCast_bSuccess' has a wrong offset!");
