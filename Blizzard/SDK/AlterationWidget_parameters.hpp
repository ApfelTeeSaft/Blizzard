...
static_assert(offsetof(AlterationWidget_C_ShouldFadeAlteration, CallFunc_Not_PreBool_ReturnValue1) == 0x000004, "Member 'AlterationWidget_C_ShouldFadeAlteration::CallFunc_Not_PreBool_ReturnValue1' has a wrong offset!");
...
{
public:
	struct FSlateBrush                            CallFunc_ResizeBrush_NewParam;                     // 0x0000(0x0078)()
	class UFortAlterationItemDefinition*          CallFunc_GetAlterationDefintion_ReturnValue;       // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0080(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_81[0x7];                                       // 0x0081(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateBrush                            CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue; // 0x0088(0x0078)()
};
static_assert(alignof(AlterationWidget_C_InitIcon) == 0x000008, "Wrong alignment on AlterationWidget_C_InitIcon");
static_assert(sizeof(AlterationWidget_C_InitIcon) == 0x000100, "Wrong size on AlterationWidget_C_InitIcon");
...
static_assert(offsetof(AlterationWidget_C_InitIcon, CallFunc_GetAlterationDefintion_ReturnValue) == 0x000078, "Member 'AlterationWidget_C_InitIcon::CallFunc_GetAlterationDefintion_ReturnValue' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitIcon, CallFunc_IsValid_ReturnValue) == 0x000080, "Member 'AlterationWidget_C_InitIcon::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_InitIcon, CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue) == 0x000088, "Member 'AlterationWidget_C_InitIcon::CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_InitText, CallFunc_GetAlterationDefintion_ReturnValue1) == 0x000028, "Member 'AlterationWidget_C_InitText::CallFunc_GetAlterationDefintion_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_InitText, CallFunc_GetAlterationDefintion_ReturnValue12) == 0x000048, "Member 'AlterationWidget_C_InitText::CallFunc_GetAlterationDefintion_ReturnValue12' has a wrong offset!");
...
static_assert(sizeof(AlterationWidget_C_SetLevelText) == 0x000130, "Wrong size on AlterationWidget_C_SetLevelText");
...
static_assert(offsetof(AlterationWidget_C_SetLevelText, Temp_byte_Variable) == 0x000001, "Member 'AlterationWidget_C_SetLevelText::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_SetLevelText, Temp_byte_Variable1) == 0x000002, "Member 'AlterationWidget_C_SetLevelText::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_SetLevelText, Temp_bool_Variable1) == 0x000003, "Member 'AlterationWidget_C_SetLevelText::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_SetLevelText, K2Node_MakeStruct_SlateColor1) == 0x000048, "Member 'AlterationWidget_C_SetLevelText::K2Node_MakeStruct_SlateColor1' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_SetLevelText, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x0000F0, "Member 'AlterationWidget_C_SetLevelText::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_SetLevelText, CallFunc_Format_ReturnValue) == 0x0000F8, "Member 'AlterationWidget_C_SetLevelText::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_SetLevelText, K2Node_Select1_Default) == 0x000110, "Member 'AlterationWidget_C_SetLevelText::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_SetLevelText, CallFunc_Conv_IntToText_ReturnValue) == 0x000118, "Member 'AlterationWidget_C_SetLevelText::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_UpdateRaritySwitcherVisiblity, Temp_byte_Variable1) == 0x000002, "Member 'AlterationWidget_C_UpdateRaritySwitcherVisiblity::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_UpdateRaritySwitcherVisiblity, Temp_bool_Variable1) == 0x000009, "Member 'AlterationWidget_C_UpdateRaritySwitcherVisiblity::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(AlterationWidget_C_UpdateRaritySwitcherVisiblity, K2Node_Select1_Default) == 0x000010, "Member 'AlterationWidget_C_UpdateRaritySwitcherVisiblity::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(AlterationWidget_C_SetEvolutionDetails, Temp_byte_Variable1) == 0x000002, "Member 'AlterationWidget_C_SetEvolutionDetails::Temp_byte_Variable1' has a wrong offset!");
