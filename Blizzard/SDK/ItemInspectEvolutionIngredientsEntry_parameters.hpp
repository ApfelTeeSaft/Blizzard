...
public:
	...
	struct FSlateBrush                            Brush;                                             // 0x0008(0x0078)(Parm, OutParm)
	struct FSlateBrush                            CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue; // 0x0080(0x0078)()
};
...
static_assert(sizeof(ItemInspectEvolutionIngredientsEntry_C_GetIconBrush) == 0x0000F8, "Wrong size on ItemInspectEvolutionIngredientsEntry_C_GetIconBrush");
...
static_assert(offsetof(ItemInspectEvolutionIngredientsEntry_C_GetIconBrush, CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue) == 0x000080, "Member 'ItemInspectEvolutionIngredientsEntry_C_GetIconBrush::CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue' has a wrong offset!");
...
{
public:
	struct FFortItemQuantityPair                  InPair;                                            // 0x0000(0x0030)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	...
	class UFortInventoryContext*                  CallFunc_GetContext_ReturnValue1;                  // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortItemDefinition*                    CallFunc_GetItemFromItemQuantityPair_ReturnValue;  // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetTotalItemQuantityByDefinition_ReturnValue; // 0x0050(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(ItemInspectEvolutionIngredientsEntry_C_GetHaveQuantity) == 0x000058, "Wrong size on ItemInspectEvolutionIngredientsEntry_C_GetHaveQuantity");
...
static_assert(offsetof(ItemInspectEvolutionIngredientsEntry_C_GetHaveQuantity, ReturnValue) == 0x000030, "Member 'ItemInspectEvolutionIngredientsEntry_C_GetHaveQuantity::ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInspectEvolutionIngredientsEntry_C_GetHaveQuantity, CallFunc_GetContext_ReturnValue) == 0x000038, "Member 'ItemInspectEvolutionIngredientsEntry_C_GetHaveQuantity::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInspectEvolutionIngredientsEntry_C_GetHaveQuantity, CallFunc_GetContext_ReturnValue1) == 0x000040, "Member 'ItemInspectEvolutionIngredientsEntry_C_GetHaveQuantity::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ItemInspectEvolutionIngredientsEntry_C_GetHaveQuantity, CallFunc_GetItemFromItemQuantityPair_ReturnValue) == 0x000048, "Member 'ItemInspectEvolutionIngredientsEntry_C_GetHaveQuantity::CallFunc_GetItemFromItemQuantityPair_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInspectEvolutionIngredientsEntry_C_GetHaveQuantity, CallFunc_GetTotalItemQuantityByDefinition_ReturnValue) == 0x000050, "Member 'ItemInspectEvolutionIngredientsEntry_C_GetHaveQuantity::CallFunc_GetTotalItemQuantityByDefinition_ReturnValue' has a wrong offset!");
