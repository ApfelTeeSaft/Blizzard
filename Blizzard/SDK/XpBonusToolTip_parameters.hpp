...
static_assert(offsetof(XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip, Temp_byte_Variable1) == 0x000006, "Member 'XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip, Temp_bool_Variable1) == 0x000010, "Member 'XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip, Temp_byte_Variable12) == 0x000018, "Member 'XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip::Temp_byte_Variable12' has a wrong offset!");
...
static_assert(offsetof(XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip, Temp_byte_Variable123) == 0x00001A, "Member 'XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip::Temp_byte_Variable123' has a wrong offset!");
...
static_assert(offsetof(XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip, CallFunc_GetContext_ReturnValue1) == 0x000020, "Member 'XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip, CallFunc_Greater_IntInt_ReturnValue1) == 0x00002C, "Member 'XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip::CallFunc_Greater_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip, K2Node_Select1_Default) == 0x00002D, "Member 'XpBonusToolTip_C_ExecuteUbergraph_XpBonusToolTip::K2Node_Select1_Default' has a wrong offset!");
