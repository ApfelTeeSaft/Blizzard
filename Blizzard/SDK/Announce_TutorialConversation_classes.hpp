...
static_assert(sizeof(AAnnounce_TutorialConversation_C) == 0x000540, "Wrong size on AAnnounce_TutorialConversation_C");
static_assert(offsetof(AAnnounce_TutorialConversation_C, UberGraphFrame) == 0x000528, "Member 'AAnnounce_TutorialConversation_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAnnounce_TutorialConversation_C, SentencedIndexedTutorialData) == 0x000530, "Member 'AAnnounce_TutorialConversation_C::SentencedIndexedTutorialData' has a wrong offset!");
