...
static_assert(sizeof(UMcpProfile) == 0x0002C0, "Wrong size on UMcpProfile");
...
static_assert(offsetof(UMcpProfile, ProfileGroup) == 0x000100, "Member 'UMcpProfile::ProfileGroup' has a wrong offset!");
static_assert(offsetof(UMcpProfile, ProfileId) == 0x000108, "Member 'UMcpProfile::ProfileId' has a wrong offset!");
static_assert(offsetof(UMcpProfile, ProfileRevision) == 0x000118, "Member 'UMcpProfile::ProfileRevision' has a wrong offset!");
static_assert(offsetof(UMcpProfile, FullProfileQueryQueued) == 0x000120, "Member 'UMcpProfile::FullProfileQueryQueued' has a wrong offset!");
static_assert(offsetof(UMcpProfile, bShouldCreateInstances) == 0x000124, "Member 'UMcpProfile::bShouldCreateInstances' has a wrong offset!");
static_assert(offsetof(UMcpProfile, bProfileWriteLocked) == 0x000125, "Member 'UMcpProfile::bProfileWriteLocked' has a wrong offset!");
static_assert(offsetof(UMcpProfile, ProfileWriteLockExpireTime) == 0x000128, "Member 'UMcpProfile::ProfileWriteLockExpireTime' has a wrong offset!");
static_assert(offsetof(UMcpProfile, CommandRevision) == 0x000130, "Member 'UMcpProfile::CommandRevision' has a wrong offset!");
