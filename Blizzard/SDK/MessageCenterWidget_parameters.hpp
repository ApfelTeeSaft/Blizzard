...
static_assert(offsetof(MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget, K2Node_CreateDelegate_OutputDelegate1) == 0x000018, "Member 'MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget, K2Node_ComponentBoundEvent_Button12) == 0x000028, "Member 'MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget::K2Node_ComponentBoundEvent_Button12' has a wrong offset!");
...
static_assert(offsetof(MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget, K2Node_ComponentBoundEvent_Button1) == 0x000050, "Member 'MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget::K2Node_ComponentBoundEvent_Button1' has a wrong offset!");
...
static_assert(offsetof(MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget, CallFunc_GetSelectedItem_ReturnValue1) == 0x000068, "Member 'MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget::CallFunc_GetSelectedItem_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget, K2Node_DynamicCast_AsFort_UINotification1) == 0x000080, "Member 'MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget::K2Node_DynamicCast_AsFort_UINotification1' has a wrong offset!");
static_assert(offsetof(MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget, K2Node_DynamicCast_bSuccess1) == 0x000088, "Member 'MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
...
static_assert(offsetof(MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget, CallFunc_GetUIManagerWidget_ReturnValue1) == 0x000098, "Member 'MessageCenterWidget_C_ExecuteUbergraph_MessageCenterWidget::CallFunc_GetUIManagerWidget_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MessageCenterWidget_C_HandleMessageSelected, Temp_byte_Variable1) == 0x00002A, "Member 'MessageCenterWidget_C_HandleMessageSelected::Temp_byte_Variable1' has a wrong offset!");
