...
static_assert(offsetof(TeamMemberBluGloIndicator_C_SetPlayer, K2Node_CreateDelegate_OutputDelegate1) == 0x0000A0, "Member 'TeamMemberBluGloIndicator_C_SetPlayer::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
