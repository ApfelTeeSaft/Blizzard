...
static_assert(sizeof(UBP_FortExpeditionBuildSquadWidget_C) == 0x0006C8, "Wrong size on UBP_FortExpeditionBuildSquadWidget_C");
...
static_assert(offsetof(UBP_FortExpeditionBuildSquadWidget_C, SortPickerAction) == 0x0006B8, "Member 'UBP_FortExpeditionBuildSquadWidget_C::SortPickerAction' has a wrong offset!");
