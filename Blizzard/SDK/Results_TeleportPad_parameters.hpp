...
public:
	...
	int32                                         CallFunc_GetPlayerCount_ReturnValue1;              // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UResults_TeleportPadPlayer_C*           CallFunc_Array_Get_Item;                           // 0x0058(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_Array_Get_Item12;                         // 0x0068(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UResults_TeleportPadPlayer_C*>   K2Node_MakeArray_Array;                            // 0x0078(0x0010)(ZeroConstructor, ReferenceParm)
	class AFortPlayerPawn*                        CallFunc_GetCurrentPlayerPawn_ReturnValue;         // 0x0088(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FUniqueNetIdRepl                       CallFunc_GetPlatformUniqueNetId_ReturnValue;       // 0x00A8(0x0028)(HasGetValueTypeHash)
	struct FUniqueNetIdRepl                       CallFunc_GetUniqueID_ReturnValue;                  // 0x00D0(0x0028)(HasGetValueTypeHash)
	bool                                          CallFunc_IsValidNetID_ReturnValue;                 // 0x00F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(Results_TeleportPad_C_Initialize) == 0x000008, "Wrong alignment on Results_TeleportPad_C_Initialize");
static_assert(sizeof(Results_TeleportPad_C_Initialize) == 0x000100, "Wrong size on Results_TeleportPad_C_Initialize");
...
static_assert(offsetof(Results_TeleportPad_C_Initialize, CallFunc_GetPlayerCount_ReturnValue1) == 0x000048, "Member 'Results_TeleportPad_C_Initialize::CallFunc_GetPlayerCount_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_TeleportPad_C_Initialize, CallFunc_Subtract_IntInt_ReturnValue) == 0x00004C, "Member 'Results_TeleportPad_C_Initialize::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Results_TeleportPad_C_Initialize, CallFunc_Array_Get_Item) == 0x000058, "Member 'Results_TeleportPad_C_Initialize::CallFunc_Array_Get_Item' has a wrong offset!");
...
static_assert(offsetof(Results_TeleportPad_C_Initialize, CallFunc_Array_Get_Item12) == 0x000068, "Member 'Results_TeleportPad_C_Initialize::CallFunc_Array_Get_Item12' has a wrong offset!");
static_assert(offsetof(Results_TeleportPad_C_Initialize, CallFunc_Less_IntInt_ReturnValue) == 0x00006C, "Member 'Results_TeleportPad_C_Initialize::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TeleportPad_C_Initialize, CallFunc_LessEqual_IntInt_ReturnValue) == 0x00006D, "Member 'Results_TeleportPad_C_Initialize::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TeleportPad_C_Initialize, CallFunc_Add_IntInt_ReturnValue) == 0x000070, "Member 'Results_TeleportPad_C_Initialize::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TeleportPad_C_Initialize, K2Node_MakeArray_Array) == 0x000078, "Member 'Results_TeleportPad_C_Initialize::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Results_TeleportPad_C_Initialize, CallFunc_GetCurrentPlayerPawn_ReturnValue) == 0x000088, "Member 'Results_TeleportPad_C_Initialize::CallFunc_GetCurrentPlayerPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TeleportPad_C_Initialize, CallFunc_IsValid_ReturnValue) == 0x000090, "Member 'Results_TeleportPad_C_Initialize::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TeleportPad_C_Initialize, K2Node_DynamicCast_AsFort_Player_State) == 0x000098, "Member 'Results_TeleportPad_C_Initialize::K2Node_DynamicCast_AsFort_Player_State' has a wrong offset!");
static_assert(offsetof(Results_TeleportPad_C_Initialize, K2Node_DynamicCast_bSuccess) == 0x0000A0, "Member 'Results_TeleportPad_C_Initialize::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Results_TeleportPad_C_Initialize, CallFunc_GetPlatformUniqueNetId_ReturnValue) == 0x0000A8, "Member 'Results_TeleportPad_C_Initialize::CallFunc_GetPlatformUniqueNetId_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TeleportPad_C_Initialize, CallFunc_GetUniqueID_ReturnValue) == 0x0000D0, "Member 'Results_TeleportPad_C_Initialize::CallFunc_GetUniqueID_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_TeleportPad_C_Initialize, CallFunc_IsValidNetID_ReturnValue) == 0x0000F8, "Member 'Results_TeleportPad_C_Initialize::CallFunc_IsValidNetID_ReturnValue' has a wrong offset!");
