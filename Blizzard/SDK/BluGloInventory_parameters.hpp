...
public:
	...
	TDelegate<void(const TArray<class UFortWorldItem*>& ItemsAdded, const TArray<class UFortWorldItem*>& ItemsRemoved)> K2Node_CreateDelegate_OutputDelegate12; // 0x0028(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(offsetof(BluGloInventory_C_ExecuteUbergraph_BluGloInventory, CallFunc_IsValid_ReturnValue1) == 0x00004B, "Member 'BluGloInventory_C_ExecuteUbergraph_BluGloInventory::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(BluGloInventory_C_Update, CallFunc_GetContext_ReturnValue1) == 0x000008, "Member 'BluGloInventory_C_Update::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
