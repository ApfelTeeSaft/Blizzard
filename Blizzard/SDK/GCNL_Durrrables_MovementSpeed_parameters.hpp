...
static_assert(offsetof(GCNL_Durrrables_MovementSpeed_C_OnRemove, CallFunc_IsValid_ReturnValue1) == 0x0000C2, "Member 'GCNL_Durrrables_MovementSpeed_C_OnRemove::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
