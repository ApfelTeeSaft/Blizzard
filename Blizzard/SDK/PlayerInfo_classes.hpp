...
static_assert(sizeof(UPlayerInfo_C) == 0x000278, "Wrong size on UPlayerInfo_C");
...
static_assert(offsetof(UPlayerInfo_C, PowerWidget) == 0x000268, "Member 'UPlayerInfo_C::PowerWidget' has a wrong offset!");
static_assert(offsetof(UPlayerInfo_C, TextPlayerName) == 0x000270, "Member 'UPlayerInfo_C::TextPlayerName' has a wrong offset!");
