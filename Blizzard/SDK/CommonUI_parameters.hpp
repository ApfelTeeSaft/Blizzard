...
static_assert(alignof(CommonDynamicEntryBox_RemoveEntry) == 0x000008, "Wrong alignment on CommonDynamicEntryBox_RemoveEntry");
static_assert(sizeof(CommonDynamicEntryBox_RemoveEntry) == 0x000008, "Wrong size on CommonDynamicEntryBox_RemoveEntry");
static_assert(offsetof(CommonDynamicEntryBox_RemoveEntry, EntryWidget) == 0x000000, "Member 'CommonDynamicEntryBox_RemoveEntry::EntryWidget' has a wrong offset!");
...
static_assert(alignof(CommonDynamicEntryBox_Reset) == 0x000001, "Wrong alignment on CommonDynamicEntryBox_Reset");
static_assert(sizeof(CommonDynamicEntryBox_Reset) == 0x000001, "Wrong size on CommonDynamicEntryBox_Reset");
static_assert(offsetof(CommonDynamicEntryBox_Reset, bDeleteWidgets) == 0x000000, "Member 'CommonDynamicEntryBox_Reset::bDeleteWidgets' has a wrong offset!");
...
static_assert(alignof(CommonDynamicEntryBox_SetEntrySpacing) == 0x000004, "Wrong alignment on CommonDynamicEntryBox_SetEntrySpacing");
static_assert(sizeof(CommonDynamicEntryBox_SetEntrySpacing) == 0x000008, "Wrong size on CommonDynamicEntryBox_SetEntrySpacing");
static_assert(offsetof(CommonDynamicEntryBox_SetEntrySpacing, InEntrySpacing) == 0x000000, "Member 'CommonDynamicEntryBox_SetEntrySpacing::InEntrySpacing' has a wrong offset!");
...
static_assert(alignof(CommonDynamicEntryBox_GetAllEntries) == 0x000008, "Wrong alignment on CommonDynamicEntryBox_GetAllEntries");
static_assert(sizeof(CommonDynamicEntryBox_GetAllEntries) == 0x000010, "Wrong size on CommonDynamicEntryBox_GetAllEntries");
static_assert(offsetof(CommonDynamicEntryBox_GetAllEntries, ReturnValue) == 0x000000, "Member 'CommonDynamicEntryBox_GetAllEntries::ReturnValue' has a wrong offset!");
...
static_assert(alignof(CommonDynamicEntryBox_GetNumEntries) == 0x000004, "Wrong alignment on CommonDynamicEntryBox_GetNumEntries");
static_assert(sizeof(CommonDynamicEntryBox_GetNumEntries) == 0x000004, "Wrong size on CommonDynamicEntryBox_GetNumEntries");
static_assert(offsetof(CommonDynamicEntryBox_GetNumEntries, ReturnValue) == 0x000000, "Member 'CommonDynamicEntryBox_GetNumEntries::ReturnValue' has a wrong offset!");
