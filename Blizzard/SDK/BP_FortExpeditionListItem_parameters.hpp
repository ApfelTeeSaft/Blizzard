...
public:
	...
	bool                                          CallFunc_IsValid_ReturnValue12;                    // 0x003E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(BP_FortExpeditionListItem_C_ExecuteUbergraph_BP_FortExpeditionListItem, CallFunc_IsValid_ReturnValue1) == 0x000028, "Member 'BP_FortExpeditionListItem_C_ExecuteUbergraph_BP_FortExpeditionListItem::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(BP_FortExpeditionListItem_C_ExecuteUbergraph_BP_FortExpeditionListItem, Temp_byte_Variable1) == 0x00003C, "Member 'BP_FortExpeditionListItem_C_ExecuteUbergraph_BP_FortExpeditionListItem::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(BP_FortExpeditionListItem_C_ExecuteUbergraph_BP_FortExpeditionListItem, CallFunc_IsValid_ReturnValue12) == 0x00003E, "Member 'BP_FortExpeditionListItem_C_ExecuteUbergraph_BP_FortExpeditionListItem::CallFunc_IsValid_ReturnValue12' has a wrong offset!");
...
public:
	...
	class UBP_SimpleItemWidget_C*                 CallFunc_Create_ReturnValue;                       // 0x00C8(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
