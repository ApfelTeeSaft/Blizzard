...
static_assert(alignof(RewardsListWidget_C_PopulateRewards) == 0x000008, "Wrong alignment on RewardsListWidget_C_PopulateRewards");
static_assert(sizeof(RewardsListWidget_C_PopulateRewards) == 0x000080, "Wrong size on RewardsListWidget_C_PopulateRewards");
...
static_assert(alignof(RewardsListWidget_C_CreateReward) == 0x000008, "Wrong alignment on RewardsListWidget_C_CreateReward");
static_assert(sizeof(RewardsListWidget_C_CreateReward) == 0x000108, "Wrong size on RewardsListWidget_C_CreateReward");
...
static_assert(offsetof(RewardsListWidget_C_CreateReward, K2Node_MakeStruct_FormatArgumentData1) == 0x000078, "Member 'RewardsListWidget_C_CreateReward::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
...
static_assert(offsetof(RewardsListWidget_C_CreateReward, CallFunc_Array_Add_ReturnValue1) == 0x000104, "Member 'RewardsListWidget_C_CreateReward::CallFunc_Array_Add_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(RewardsListWidget_C_PresentAllRewards, Temp_int_Array_Index_Variable1) == 0x000010, "Member 'RewardsListWidget_C_PresentAllRewards::Temp_int_Array_Index_Variable1' has a wrong offset!");
...
static_assert(offsetof(RewardsListWidget_C_PresentAllRewards, K2Node_MakeStruct_Margin1) == 0x000024, "Member 'RewardsListWidget_C_PresentAllRewards::K2Node_MakeStruct_Margin1' has a wrong offset!");
static_assert(offsetof(RewardsListWidget_C_PresentAllRewards, Temp_int_Loop_Counter_Variable1) == 0x000034, "Member 'RewardsListWidget_C_PresentAllRewards::Temp_int_Loop_Counter_Variable1' has a wrong offset!");
...
static_assert(offsetof(RewardsListWidget_C_PresentAllRewards, CallFunc_Add_IntInt_ReturnValue1) == 0x000054, "Member 'RewardsListWidget_C_PresentAllRewards::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(RewardsListWidget_C_PresentAllRewards, CallFunc_Array_Get_Item1) == 0x000068, "Member 'RewardsListWidget_C_PresentAllRewards::CallFunc_Array_Get_Item1' has a wrong offset!");
