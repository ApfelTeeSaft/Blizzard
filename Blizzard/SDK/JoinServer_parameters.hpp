...
public:
	...
	class UFortTutorialContext*                   CallFunc_GetContext_ReturnValue1;                  // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(EFortDialogResult Result, class FName ResultName)> K2Node_CreateDelegate_OutputDelegate1234; // 0x00C8(0x0010)(ZeroConstructor, NoDestructor)
	...
	class AFortPlayerController*                  K2Node_DynamicCast_AsFort_Player_Controller1;      // 0x0100(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsValid_ReturnValue12;                    // 0x0119(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, K2Node_CreateDelegate_OutputDelegate1) == 0x000020, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, K2Node_CreateDelegate_OutputDelegate12) == 0x000030, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, K2Node_CreateDelegate_OutputDelegate123) == 0x000040, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::K2Node_CreateDelegate_OutputDelegate123' has a wrong offset!");
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, CallFunc_GetContext_ReturnValue1) == 0x000050, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, CallFunc_GetContext_ReturnValue12) == 0x000058, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, K2Node_HandleClientEvent_EventSource1) == 0x000078, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::K2Node_HandleClientEvent_EventSource1' has a wrong offset!");
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, K2Node_HandleClientEvent_EventFocus1) == 0x000080, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::K2Node_HandleClientEvent_EventFocus1' has a wrong offset!");
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, K2Node_HandleClientEvent_ClientEvent1) == 0x000088, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::K2Node_HandleClientEvent_ClientEvent1' has a wrong offset!");
...
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, K2Node_CreateDelegate_OutputDelegate1234) == 0x0000C8, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::K2Node_CreateDelegate_OutputDelegate1234' has a wrong offset!");
...
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, CallFunc_GetOwningPlayer_ReturnValue1) == 0x0000F8, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::CallFunc_GetOwningPlayer_ReturnValue1' has a wrong offset!");
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, K2Node_DynamicCast_AsFort_Player_Controller1) == 0x000100, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::K2Node_DynamicCast_AsFort_Player_Controller1' has a wrong offset!");
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, K2Node_DynamicCast_bSuccess1) == 0x000108, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
...
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, CallFunc_IsValid_ReturnValue1) == 0x000118, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
static_assert(offsetof(JoinServer_C_ExecuteUbergraph_JoinServer, CallFunc_IsValid_ReturnValue12) == 0x000119, "Member 'JoinServer_C_ExecuteUbergraph_JoinServer::CallFunc_IsValid_ReturnValue12' has a wrong offset!");
...
public:
	...
	TDelegate<void(int32 CurrentTime)>            K2Node_CreateDelegate_OutputDelegate123;           // 0x0058(0x0010)(ZeroConstructor, NoDestructor)
	class UTutorialWindow_C*                      CallFunc_Create_ReturnValue12;                     // 0x0068(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate1234;          // 0x0070(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(EMatchmakingState OldState, EMatchmakingState NewState)> K2Node_CreateDelegate_OutputDelegate12345; // 0x0080(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(EMatchmakingCompleteResult Result)> K2Node_CreateDelegate_OutputDelegate123456;   // 0x0090(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate1234567;       // 0x00A0(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(offsetof(JoinServer_C_Initialize, K2Node_CreateDelegate_OutputDelegate12) == 0x000040, "Member 'JoinServer_C_Initialize::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
static_assert(offsetof(JoinServer_C_Initialize, CallFunc_GetOwningPlayer_ReturnValue12) == 0x000050, "Member 'JoinServer_C_Initialize::CallFunc_GetOwningPlayer_ReturnValue12' has a wrong offset!");
static_assert(offsetof(JoinServer_C_Initialize, K2Node_CreateDelegate_OutputDelegate123) == 0x000058, "Member 'JoinServer_C_Initialize::K2Node_CreateDelegate_OutputDelegate123' has a wrong offset!");
static_assert(offsetof(JoinServer_C_Initialize, CallFunc_Create_ReturnValue12) == 0x000068, "Member 'JoinServer_C_Initialize::CallFunc_Create_ReturnValue12' has a wrong offset!");
static_assert(offsetof(JoinServer_C_Initialize, K2Node_CreateDelegate_OutputDelegate1234) == 0x000070, "Member 'JoinServer_C_Initialize::K2Node_CreateDelegate_OutputDelegate1234' has a wrong offset!");
static_assert(offsetof(JoinServer_C_Initialize, K2Node_CreateDelegate_OutputDelegate12345) == 0x000080, "Member 'JoinServer_C_Initialize::K2Node_CreateDelegate_OutputDelegate12345' has a wrong offset!");
static_assert(offsetof(JoinServer_C_Initialize, K2Node_CreateDelegate_OutputDelegate123456) == 0x000090, "Member 'JoinServer_C_Initialize::K2Node_CreateDelegate_OutputDelegate123456' has a wrong offset!");
static_assert(offsetof(JoinServer_C_Initialize, K2Node_CreateDelegate_OutputDelegate1234567) == 0x0000A0, "Member 'JoinServer_C_Initialize::K2Node_CreateDelegate_OutputDelegate1234567' has a wrong offset!");
...
public:
	...
	class UWidget*                                CallFunc_PopWigdet_ReturnValue;                    // 0x0020(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	class FText                                   Temp_text_Variable1234;                            // 0x0088(0x0018)()
	class FText                                   Temp_text_Variable12345;                           // 0x00A0(0x0018)()
	class FText                                   Temp_text_Variable123456;                          // 0x00B8(0x0018)()
	class FText                                   Temp_text_Variable1234567;                         // 0x00D0(0x0018)()
...
static_assert(offsetof(JoinServer_C_GetMatchmakingError, Temp_text_Variable12) == 0x000058, "Member 'JoinServer_C_GetMatchmakingError::Temp_text_Variable12' has a wrong offset!");
static_assert(offsetof(JoinServer_C_GetMatchmakingError, Temp_text_Variable123) == 0x000070, "Member 'JoinServer_C_GetMatchmakingError::Temp_text_Variable123' has a wrong offset!");
static_assert(offsetof(JoinServer_C_GetMatchmakingError, Temp_text_Variable1234) == 0x000088, "Member 'JoinServer_C_GetMatchmakingError::Temp_text_Variable1234' has a wrong offset!");
static_assert(offsetof(JoinServer_C_GetMatchmakingError, Temp_text_Variable12345) == 0x0000A0, "Member 'JoinServer_C_GetMatchmakingError::Temp_text_Variable12345' has a wrong offset!");
static_assert(offsetof(JoinServer_C_GetMatchmakingError, Temp_text_Variable123456) == 0x0000B8, "Member 'JoinServer_C_GetMatchmakingError::Temp_text_Variable123456' has a wrong offset!");
static_assert(offsetof(JoinServer_C_GetMatchmakingError, Temp_text_Variable1234567) == 0x0000D0, "Member 'JoinServer_C_GetMatchmakingError::Temp_text_Variable1234567' has a wrong offset!");
