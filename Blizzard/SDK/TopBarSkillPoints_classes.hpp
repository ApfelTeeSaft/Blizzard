...
static_assert(offsetof(UTopBarSkillPoints_C, XPRequiredToLevel) == 0x0002D0, "Member 'UTopBarSkillPoints_C::XPRequiredToLevel' has a wrong offset!");
static_assert(offsetof(UTopBarSkillPoints_C, CachedLevelXP) == 0x0002D4, "Member 'UTopBarSkillPoints_C::CachedLevelXP' has a wrong offset!");
static_assert(offsetof(UTopBarSkillPoints_C, CachedLevel) == 0x0002D8, "Member 'UTopBarSkillPoints_C::CachedLevel' has a wrong offset!");
