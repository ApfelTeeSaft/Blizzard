...
static_assert(sizeof(UBuildWatermark_C) == 0x000268, "Wrong size on UBuildWatermark_C");
...
static_assert(offsetof(UBuildWatermark_C, Text) == 0x000240, "Member 'UBuildWatermark_C::Text' has a wrong offset!");
static_assert(offsetof(UBuildWatermark_C, TextMcp) == 0x000248, "Member 'UBuildWatermark_C::TextMcp' has a wrong offset!");
static_assert(offsetof(UBuildWatermark_C, Watermark) == 0x000250, "Member 'UBuildWatermark_C::Watermark' has a wrong offset!");
