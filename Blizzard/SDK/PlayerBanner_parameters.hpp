...
static_assert(offsetof(PlayerBanner_C_SetBannerImage, CallFunc_Conv_StringToName_ReturnValue1) == 0x000050, "Member 'PlayerBanner_C_SetBannerImage::CallFunc_Conv_StringToName_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(PlayerBanner_C_SetBannerOwner, K2Node_CreateDelegate_OutputDelegate12) == 0x000048, "Member 'PlayerBanner_C_SetBannerOwner::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
...
static_assert(offsetof(PlayerBanner_C_SetBannerOwner, CallFunc_GetContext_ReturnValue1) == 0x000070, "Member 'PlayerBanner_C_SetBannerOwner::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerOwner, K2Node_CreateDelegate_OutputDelegate123) == 0x000078, "Member 'PlayerBanner_C_SetBannerOwner::K2Node_CreateDelegate_OutputDelegate123' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerOwner, CallFunc_GetContext_ReturnValue12) == 0x000088, "Member 'PlayerBanner_C_SetBannerOwner::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
...
static_assert(sizeof(PlayerBanner_C_SetBannerIconAndColorFromProfile) == 0x0000F0, "Wrong size on PlayerBanner_C_SetBannerIconAndColorFromProfile");
...
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_GetSubGame_ReturnValue) == 0x000090, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_GetSubGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000091, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_Conv_StringToName_ReturnValue) == 0x000098, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_Conv_StringToName_ReturnValue1) == 0x0000A0, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_Conv_StringToName_ReturnValue1' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_GetHomeBaseInfoForPlayer_Result) == 0x0000A8, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_GetHomeBaseInfoForPlayer_Result' has a wrong offset!");
static_assert(offsetof(PlayerBanner_C_SetBannerIconAndColorFromProfile, CallFunc_SetBannerImage_Success) == 0x0000E8, "Member 'PlayerBanner_C_SetBannerIconAndColorFromProfile::CallFunc_SetBannerImage_Success' has a wrong offset!");
