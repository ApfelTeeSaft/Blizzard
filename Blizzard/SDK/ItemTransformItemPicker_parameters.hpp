...
static_assert(offsetof(ItemTransformItemPicker_C_SetupItemPicker, K2Node_CreateDelegate_OutputDelegate1) == 0x000010, "Member 'ItemTransformItemPicker_C_SetupItemPicker::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(ItemTransformItemPicker_C_RemoveInvalidItems, CallFunc_BooleanAND_ReturnValue1) == 0x000092, "Member 'ItemTransformItemPicker_C_RemoveInvalidItems::CallFunc_BooleanAND_ReturnValue1' has a wrong offset!");
