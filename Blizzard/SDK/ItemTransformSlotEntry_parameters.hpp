...
public:
	...
	class UCommonUIContext*                       CallFunc_GetContext_ReturnValue1;                  // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ItemTransformSlotEntry_C_ExecuteUbergraph_ItemTransformSlotEntry, K2Node_ComponentBoundEvent_Button12) == 0x000008, "Member 'ItemTransformSlotEntry_C_ExecuteUbergraph_ItemTransformSlotEntry::K2Node_ComponentBoundEvent_Button12' has a wrong offset!");
...
static_assert(offsetof(ItemTransformSlotEntry_C_ExecuteUbergraph_ItemTransformSlotEntry, K2Node_ComponentBoundEvent_Button1) == 0x000018, "Member 'ItemTransformSlotEntry_C_ExecuteUbergraph_ItemTransformSlotEntry::K2Node_ComponentBoundEvent_Button1' has a wrong offset!");
...
static_assert(offsetof(ItemTransformSlotEntry_C_ExecuteUbergraph_ItemTransformSlotEntry, CallFunc_GetContext_ReturnValue1) == 0x000040, "Member 'ItemTransformSlotEntry_C_ExecuteUbergraph_ItemTransformSlotEntry::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ItemTransformSlotEntry_C_ExecuteUbergraph_ItemTransformSlotEntry, CallFunc_IsUsingGamepad_ReturnValue1) == 0x000048, "Member 'ItemTransformSlotEntry_C_ExecuteUbergraph_ItemTransformSlotEntry::CallFunc_IsUsingGamepad_ReturnValue1' has a wrong offset!");
