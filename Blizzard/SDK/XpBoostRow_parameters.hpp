...
public:
	...
	bool                                          CallFunc_IsValid_ReturnValue12;                    // 0x00F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue123;                   // 0x00F9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow) == 0x0002B0, "Wrong size on XpBoostRow_C_ExecuteUbergraph_XpBoostRow");
...
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, K2Node_CustomEvent_Result1) == 0x000004, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::K2Node_CustomEvent_Result1' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, K2Node_CustomEvent_ResultName1) == 0x000008, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::K2Node_CustomEvent_ResultName1' has a wrong offset!");
...
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, K2Node_CreateDelegate_OutputDelegate1) == 0x000038, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, Temp_name_Variable1) == 0x000048, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::Temp_name_Variable1' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, Temp_byte_Variable1) == 0x000050, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, K2Node_SwitchEnum1_CmpSuccess) == 0x000051, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::K2Node_SwitchEnum1_CmpSuccess' has a wrong offset!");
...
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, K2Node_CreateDelegate_OutputDelegate12) == 0x000068, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, K2Node_CreateDelegate_OutputDelegate123) == 0x000078, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::K2Node_CreateDelegate_OutputDelegate123' has a wrong offset!");
...
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, CallFunc_MakeLiteralText_ReturnValue1) == 0x0000A0, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::CallFunc_MakeLiteralText_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue1) == 0x0000C0, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, CallFunc_IsValid_ReturnValue1) == 0x0000C9, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, CallFunc_GetContext_ReturnValue1) == 0x0000D8, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, CallFunc_GetAccountItemWithDefinition_ReturnValue1) == 0x0000E0, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::CallFunc_GetAccountItemWithDefinition_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, CallFunc_ConsumeItem_ReturnValue1) == 0x0000F0, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::CallFunc_ConsumeItem_ReturnValue1' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, CallFunc_IsValid_ReturnValue12) == 0x0000F8, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::CallFunc_IsValid_ReturnValue12' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, CallFunc_IsValid_ReturnValue123) == 0x0000F9, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::CallFunc_IsValid_ReturnValue123' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, K2Node_Event_NewInfo) == 0x000100, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::K2Node_Event_NewInfo' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_ExecuteUbergraph_XpBoostRow, CallFunc_IsValid_ReturnValue1234) == 0x0002A8, "Member 'XpBoostRow_C_ExecuteUbergraph_XpBoostRow::CallFunc_IsValid_ReturnValue1234' has a wrong offset!");
...
static_assert(alignof(XpBoostRow_C_OnPlayerInfoChanged) == 0x000008, "Wrong alignment on XpBoostRow_C_OnPlayerInfoChanged");
static_assert(sizeof(XpBoostRow_C_OnPlayerInfoChanged) == 0x0001A8, "Wrong size on XpBoostRow_C_OnPlayerInfoChanged");
static_assert(offsetof(XpBoostRow_C_OnPlayerInfoChanged, NewInfo) == 0x000000, "Member 'XpBoostRow_C_OnPlayerInfoChanged::NewInfo' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFortTeamMemberInfo                    Party_Members_Info;                                // 0x0008(0x01A8)(BlueprintVisible, BlueprintReadOnly, Parm)
	...
	bool                                          CallFunc_HasBoost_Result;                          // 0x01B9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_HasBoost_Result1;                         // 0x01BA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class FText                                   CallFunc_MakeLiteralText_ReturnValue1;             // 0x0240(0x0018)()
	ESlateVisibility                              Temp_byte_Variable;                                // 0x0258(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsLocalPlayersUniqueID_ReturnValue;       // 0x0259(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ESlateVisibility                              Temp_byte_Variable1;                               // 0x025A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable;                                // 0x025B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(XpBoostRow_C_Update_Party_Member) == 0x000260, "Wrong size on XpBoostRow_C_Update_Party_Member");
...
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_GetContext_ReturnValue) == 0x0001B0, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_NotEqual_BoolBool_ReturnValue) == 0x0001B8, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_NotEqual_BoolBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_HasBoost_Result) == 0x0001B9, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_HasBoost_Result' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_HasBoost_Result1) == 0x0001BA, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_HasBoost_Result1' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, K2Node_MakeStruct_FormatArgumentData) == 0x0001C0, "Member 'XpBoostRow_C_Update_Party_Member::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, K2Node_MakeArray_Array) == 0x000200, "Member 'XpBoostRow_C_Update_Party_Member::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_Format_ReturnValue) == 0x000210, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_MakeLiteralText_ReturnValue) == 0x000228, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_MakeLiteralText_ReturnValue1) == 0x000240, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_MakeLiteralText_ReturnValue1' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, Temp_byte_Variable) == 0x000258, "Member 'XpBoostRow_C_Update_Party_Member::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_IsLocalPlayersUniqueID_ReturnValue) == 0x000259, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_IsLocalPlayersUniqueID_ReturnValue' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, Temp_byte_Variable1) == 0x00025A, "Member 'XpBoostRow_C_Update_Party_Member::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, Temp_bool_Variable) == 0x00025B, "Member 'XpBoostRow_C_Update_Party_Member::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, K2Node_Select_Default) == 0x00025C, "Member 'XpBoostRow_C_Update_Party_Member::K2Node_Select_Default' has a wrong offset!");
...
static_assert(alignof(XpBoostRow_C_Update_Boost_Amount) == 0x000008, "Wrong alignment on XpBoostRow_C_Update_Boost_Amount");
static_assert(sizeof(XpBoostRow_C_Update_Boost_Amount) == 0x000080, "Wrong size on XpBoostRow_C_Update_Boost_Amount");
static_assert(offsetof(XpBoostRow_C_Update_Boost_Amount, K2Node_MakeStruct_FormatArgumentData) == 0x000000, "Member 'XpBoostRow_C_Update_Boost_Amount::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Boost_Amount, CallFunc_GetContext_ReturnValue) == 0x000040, "Member 'XpBoostRow_C_Update_Boost_Amount::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Boost_Amount, K2Node_MakeArray_Array) == 0x000048, "Member 'XpBoostRow_C_Update_Boost_Amount::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Boost_Amount, CallFunc_GetPlayersXPPercentContributionToLocalPlayer_ReturnValue) == 0x000058, "Member 'XpBoostRow_C_Update_Boost_Amount::CallFunc_GetPlayersXPPercentContributionToLocalPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Boost_Amount, CallFunc_Format_ReturnValue) == 0x000060, "Member 'XpBoostRow_C_Update_Boost_Amount::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Boost_Amount, CallFunc_NotEqual_IntInt_ReturnValue) == 0x000078, "Member 'XpBoostRow_C_Update_Boost_Amount::CallFunc_NotEqual_IntInt_ReturnValue' has a wrong offset!");
