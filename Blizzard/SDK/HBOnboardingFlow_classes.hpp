...
static_assert(offsetof(AHBOnboardingFlow_C, PeriodicEventMovieAnnouncmentClass) == 0x0003B0, "Member 'AHBOnboardingFlow_C::PeriodicEventMovieAnnouncmentClass' has a wrong offset!");
