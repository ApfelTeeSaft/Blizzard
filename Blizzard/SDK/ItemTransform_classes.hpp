...
static_assert(sizeof(UItemTransform_C) == 0x000470, "Wrong size on UItemTransform_C");
...
static_assert(offsetof(UItemTransform_C, bOnKeySelect) == 0x000468, "Member 'UItemTransform_C::bOnKeySelect' has a wrong offset!");
