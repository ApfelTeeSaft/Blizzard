...
static_assert(sizeof(EquippedItem_Bandolier_C_UpdateCurrent) == 0x0000A0, "Wrong size on EquippedItem_Bandolier_C_UpdateCurrent");
...
static_assert(sizeof(EquippedItem_Bandolier_C_UpdateCapacity) == 0x0000A0, "Wrong size on EquippedItem_Bandolier_C_UpdateCapacity");
