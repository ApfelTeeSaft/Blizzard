...
static_assert(sizeof(UAnimCustomInstance) == 0x000380, "Wrong size on UAnimCustomInstance");
...
static_assert(sizeof(UPlayMontageCallbackProxy) == 0x000110, "Wrong size on UPlayMontageCallbackProxy");
