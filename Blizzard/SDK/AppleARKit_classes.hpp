...
static_assert(sizeof(UMaterialExpressionARKitPassthroughCamera) == 0x000078, "Wrong size on UMaterialExpressionARKitPassthroughCamera");
static_assert(offsetof(UMaterialExpressionARKitPassthroughCamera, Coordinates) == 0x000040, "Member 'UMaterialExpressionARKitPassthroughCamera::Coordinates' has a wrong offset!");
static_assert(offsetof(UMaterialExpressionARKitPassthroughCamera, ConstCoordinate) == 0x000070, "Member 'UMaterialExpressionARKitPassthroughCamera::ConstCoordinate' has a wrong offset!");
static_assert(offsetof(UMaterialExpressionARKitPassthroughCamera, TextureType) == 0x000074, "Member 'UMaterialExpressionARKitPassthroughCamera::TextureType' has a wrong offset!");
