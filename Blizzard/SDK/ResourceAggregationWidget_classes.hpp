...
static_assert(sizeof(UResourceAggregationWidget_C) == 0x000298, "Wrong size on UResourceAggregationWidget_C");
static_assert(offsetof(UResourceAggregationWidget_C, UberGraphFrame) == 0x000238, "Member 'UResourceAggregationWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UResourceAggregationWidget_C, ResourceIconPulseAnim) == 0x000240, "Member 'UResourceAggregationWidget_C::ResourceIconPulseAnim' has a wrong offset!");
static_assert(offsetof(UResourceAggregationWidget_C, AggregateOutroAnim) == 0x000248, "Member 'UResourceAggregationWidget_C::AggregateOutroAnim' has a wrong offset!");
static_assert(offsetof(UResourceAggregationWidget_C, HBoxTotalAggregation) == 0x000250, "Member 'UResourceAggregationWidget_C::HBoxTotalAggregation' has a wrong offset!");
static_assert(offsetof(UResourceAggregationWidget_C, ImageResourceIcon) == 0x000258, "Member 'UResourceAggregationWidget_C::ImageResourceIcon' has a wrong offset!");
static_assert(offsetof(UResourceAggregationWidget_C, PotentialResourceWidget) == 0x000260, "Member 'UResourceAggregationWidget_C::PotentialResourceWidget' has a wrong offset!");
static_assert(offsetof(UResourceAggregationWidget_C, TextAggregateResourceCollected) == 0x000268, "Member 'UResourceAggregationWidget_C::TextAggregateResourceCollected' has a wrong offset!");
static_assert(offsetof(UResourceAggregationWidget_C, TextAggregateResourceCollectedShadow) == 0x000270, "Member 'UResourceAggregationWidget_C::TextAggregateResourceCollectedShadow' has a wrong offset!");
static_assert(offsetof(UResourceAggregationWidget_C, ResourceHoldingObject) == 0x000278, "Member 'UResourceAggregationWidget_C::ResourceHoldingObject' has a wrong offset!");
static_assert(offsetof(UResourceAggregationWidget_C, AggregateResourceCollected) == 0x000280, "Member 'UResourceAggregationWidget_C::AggregateResourceCollected' has a wrong offset!");
static_assert(offsetof(UResourceAggregationWidget_C, bActivateAggregateAnim) == 0x000284, "Member 'UResourceAggregationWidget_C::bActivateAggregateAnim' has a wrong offset!");
static_assert(offsetof(UResourceAggregationWidget_C, HideWidgetTimer) == 0x000288, "Member 'UResourceAggregationWidget_C::HideWidgetTimer' has a wrong offset!");
static_assert(offsetof(UResourceAggregationWidget_C, bIgnoreHide) == 0x000290, "Member 'UResourceAggregationWidget_C::bIgnoreHide' has a wrong offset!");
