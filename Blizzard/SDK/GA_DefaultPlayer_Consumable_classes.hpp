...
static_assert(sizeof(UGA_DefaultPlayer_Consumable_C) == 0x000AC0, "Wrong size on UGA_DefaultPlayer_Consumable_C");
static_assert(offsetof(UGA_DefaultPlayer_Consumable_C, UberGraphFrame) == 0x000AB0, "Member 'UGA_DefaultPlayer_Consumable_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_DefaultPlayer_Consumable_C, EatMontage) == 0x000AB8, "Member 'UGA_DefaultPlayer_Consumable_C::EatMontage' has a wrong offset!");
