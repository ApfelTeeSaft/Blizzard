...
public:
	...
	struct FVector                                CallFunc_BreakTransform_Location12;                // 0x0120(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                               CallFunc_BreakTransform_Rotation12;                // 0x012C(0x000C)(IsPlainOldData, NoDestructor)
	struct FVector                                CallFunc_BreakTransform_Scale12;                   // 0x0138(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_BreakVector_X12;                          // 0x0180(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_BreakVector_Y12;                          // 0x0184(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_BreakVector_Z12;                          // 0x0188(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_MakeVector_ReturnValue12;                 // 0x0220(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FTransform                             CallFunc_MakeTransform_ReturnValue12;              // 0x0240(0x0030)(IsPlainOldData, NoDestructor)
	...
	TArray<class AWM_Lights_C*>                   CallFunc_GetAllActorsOfClass_OutActors12;          // 0x0450(0x0010)(ZeroConstructor, ReferenceParm)
	class AWM_Lights_C*                           CallFunc_Array_Get_Item12;                         // 0x0460(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(WM_Camera_C_ExecuteUbergraph_WM_Camera, CallFunc_BreakTransform_Location12) == 0x000120, "Member 'WM_Camera_C_ExecuteUbergraph_WM_Camera::CallFunc_BreakTransform_Location12' has a wrong offset!");
static_assert(offsetof(WM_Camera_C_ExecuteUbergraph_WM_Camera, CallFunc_BreakTransform_Rotation12) == 0x00012C, "Member 'WM_Camera_C_ExecuteUbergraph_WM_Camera::CallFunc_BreakTransform_Rotation12' has a wrong offset!");
static_assert(offsetof(WM_Camera_C_ExecuteUbergraph_WM_Camera, CallFunc_BreakTransform_Scale12) == 0x000138, "Member 'WM_Camera_C_ExecuteUbergraph_WM_Camera::CallFunc_BreakTransform_Scale12' has a wrong offset!");
...
static_assert(offsetof(WM_Camera_C_ExecuteUbergraph_WM_Camera, CallFunc_BreakVector_X12) == 0x000180, "Member 'WM_Camera_C_ExecuteUbergraph_WM_Camera::CallFunc_BreakVector_X12' has a wrong offset!");
static_assert(offsetof(WM_Camera_C_ExecuteUbergraph_WM_Camera, CallFunc_BreakVector_Y12) == 0x000184, "Member 'WM_Camera_C_ExecuteUbergraph_WM_Camera::CallFunc_BreakVector_Y12' has a wrong offset!");
static_assert(offsetof(WM_Camera_C_ExecuteUbergraph_WM_Camera, CallFunc_BreakVector_Z12) == 0x000188, "Member 'WM_Camera_C_ExecuteUbergraph_WM_Camera::CallFunc_BreakVector_Z12' has a wrong offset!");
...
static_assert(offsetof(WM_Camera_C_ExecuteUbergraph_WM_Camera, CallFunc_Add_FloatFloat_ReturnValue1) == 0x00021C, "Member 'WM_Camera_C_ExecuteUbergraph_WM_Camera::CallFunc_Add_FloatFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(WM_Camera_C_ExecuteUbergraph_WM_Camera, CallFunc_MakeVector_ReturnValue12) == 0x000220, "Member 'WM_Camera_C_ExecuteUbergraph_WM_Camera::CallFunc_MakeVector_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(WM_Camera_C_ExecuteUbergraph_WM_Camera, CallFunc_MakeTransform_ReturnValue12) == 0x000240, "Member 'WM_Camera_C_ExecuteUbergraph_WM_Camera::CallFunc_MakeTransform_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(WM_Camera_C_ExecuteUbergraph_WM_Camera, CallFunc_GetAllActorsOfClass_OutActors12) == 0x000450, "Member 'WM_Camera_C_ExecuteUbergraph_WM_Camera::CallFunc_GetAllActorsOfClass_OutActors12' has a wrong offset!");
static_assert(offsetof(WM_Camera_C_ExecuteUbergraph_WM_Camera, CallFunc_Array_Get_Item12) == 0x000460, "Member 'WM_Camera_C_ExecuteUbergraph_WM_Camera::CallFunc_Array_Get_Item12' has a wrong offset!");
