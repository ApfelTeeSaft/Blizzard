...
static_assert(offsetof(Results_BonusXpType_C_ExecuteUbergraph_Results_BonusXpType, CallFunc_GetDynamicMaterial_ReturnValue1) == 0x000010, "Member 'Results_BonusXpType_C_ExecuteUbergraph_Results_BonusXpType::CallFunc_GetDynamicMaterial_ReturnValue1' has a wrong offset!");
