...
namespace Offsets
{
	constexpr int32 GObjects          = 0x047B8388;
	constexpr int32 AppendString      = 0x011E9A00;
	constexpr int32 GNames            = 0x047AEFE0;
	constexpr int32 GWorld            = 0x048AF9C0;
	constexpr int32 ProcessEvent      = 0x0137D8E0;
