...
public:
	...
	bool                                          CallFunc_SetState_PassThrough;                     // 0x01B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	EFortPartyMemberDisplayState                  CallFunc_GetPartyMemberDisplayState_ReturnValue;   // 0x01B9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_SwitchEnum_CmpSuccess;                      // 0x01BA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_IsDesignTime;                         // 0x01BB(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_SetState_PassThrough1;                    // 0x01BC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ESlateVisibility                              K2Node_Select_Default;                             // 0x01BD(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1BE[0x2];                                      // 0x01BE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateBrush                            K2Node_MakeStruct_SlateBrush;                      // 0x01C0(0x0078)()
};
...
static_assert(sizeof(PowerWidget_C_ExecuteUbergraph_PowerWidget) == 0x000238, "Wrong size on PowerWidget_C_ExecuteUbergraph_PowerWidget");
...
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, CallFunc_GetContext_ReturnValue) == 0x0001B0, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, CallFunc_SetState_PassThrough) == 0x0001B8, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::CallFunc_SetState_PassThrough' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, CallFunc_GetPartyMemberDisplayState_ReturnValue) == 0x0001B9, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::CallFunc_GetPartyMemberDisplayState_ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, K2Node_SwitchEnum_CmpSuccess) == 0x0001BA, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, K2Node_Event_IsDesignTime) == 0x0001BB, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, CallFunc_SetState_PassThrough1) == 0x0001BC, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::CallFunc_SetState_PassThrough1' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, K2Node_Select_Default) == 0x0001BD, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_ExecuteUbergraph_PowerWidget, K2Node_MakeStruct_SlateBrush) == 0x0001C0, "Member 'PowerWidget_C_ExecuteUbergraph_PowerWidget::K2Node_MakeStruct_SlateBrush' has a wrong offset!");
...
static_assert(sizeof(PowerWidget_C_OnPlayerInfoChanged) == 0x0001A8, "Wrong size on PowerWidget_C_OnPlayerInfoChanged");
...
public:
	...
	struct FSlateBrush                            K2Node_MakeStruct_SlateBrush1;                     // 0x0080(0x0078)()
	struct FSlateBrush                            K2Node_MakeStruct_SlateBrush12;                    // 0x00F8(0x0078)()
	struct FSlateBrush                            K2Node_MakeStruct_SlateBrush123;                   // 0x0170(0x0078)()
	bool                                          CallFunc_PlayerHasTeammates_ReturnValue;           // 0x01E8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(PowerWidget_C_SetState) == 0x0001F0, "Wrong size on PowerWidget_C_SetState");
...
static_assert(offsetof(PowerWidget_C_SetState, K2Node_MakeStruct_SlateBrush1) == 0x000080, "Member 'PowerWidget_C_SetState::K2Node_MakeStruct_SlateBrush1' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_SetState, K2Node_MakeStruct_SlateBrush12) == 0x0000F8, "Member 'PowerWidget_C_SetState::K2Node_MakeStruct_SlateBrush12' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_SetState, K2Node_MakeStruct_SlateBrush123) == 0x000170, "Member 'PowerWidget_C_SetState::K2Node_MakeStruct_SlateBrush123' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_SetState, CallFunc_PlayerHasTeammates_ReturnValue) == 0x0001E8, "Member 'PowerWidget_C_SetState::CallFunc_PlayerHasTeammates_ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerWidget_C_SetState, CallFunc_BooleanAND_ReturnValue) == 0x0001E9, "Member 'PowerWidget_C_SetState::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
