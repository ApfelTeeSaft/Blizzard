...
public:
	...
	float                                         CallFunc_GetGameTimeInSeconds_ReturnValue1;        // 0x0148(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Greater_FloatFloat_ReturnValue;           // 0x014C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_14D[0x3];                                      // 0x014D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UAthenaHUDContext*                      CallFunc_GetContext_ReturnValue;                   // 0x0150(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress) == 0x000158, "Wrong size on AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress");
...
static_assert(offsetof(AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress, CallFunc_Less_FloatFloat_ReturnValue) == 0x000040, "Member 'AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress::CallFunc_Less_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress, CallFunc_GetGameTimeInSeconds_ReturnValue) == 0x000044, "Member 'AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress::CallFunc_GetGameTimeInSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x000048, "Member 'AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress, CallFunc_Divide_FloatFloat_ReturnValue) == 0x00004C, "Member 'AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress, CallFunc_FClamp_ReturnValue) == 0x000050, "Member 'AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress::CallFunc_FClamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress, CallFunc_Subtract_FloatFloat_ReturnValue1) == 0x000054, "Member 'AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress::CallFunc_Subtract_FloatFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x000058, "Member 'AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress, K2Node_SwitchEnum_CmpSuccess) == 0x000128, "Member 'AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress, K2Node_SwitchName_CmpSuccess) == 0x000129, "Member 'AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress::K2Node_SwitchName_CmpSuccess' has a wrong offset!");
static_assert(offsetof(AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000130, "Member 'AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress, CallFunc_GetGameTimeInSeconds_ReturnValue1) == 0x000148, "Member 'AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress::CallFunc_GetGameTimeInSeconds_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress, CallFunc_GetContext_ReturnValue) == 0x000150, "Member 'AthenaEquipProgress_C_ExecuteUbergraph_AthenaEquipProgress::CallFunc_GetContext_ReturnValue' has a wrong offset!");
