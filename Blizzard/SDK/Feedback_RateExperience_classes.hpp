...
static_assert(offsetof(UFeedback_RateExperience_C, TooltipHeaders) == 0x000468, "Member 'UFeedback_RateExperience_C::TooltipHeaders' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, TooltipBodys) == 0x000478, "Member 'UFeedback_RateExperience_C::TooltipBodys' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, LastClickedStar) == 0x000488, "Member 'UFeedback_RateExperience_C::LastClickedStar' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, FeedbackTitle) == 0x000490, "Member 'UFeedback_RateExperience_C::FeedbackTitle' has a wrong offset!");
static_assert(offsetof(UFeedback_RateExperience_C, StarButtons) == 0x0004A8, "Member 'UFeedback_RateExperience_C::StarButtons' has a wrong offset!");
