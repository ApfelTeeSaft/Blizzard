...
static_assert(sizeof(ItemCraftingIngredientListEntryHaveNeed_C_DoDesignTimeRandomization) == 0x000068, "Wrong size on ItemCraftingIngredientListEntryHaveNeed_C_DoDesignTimeRandomization");
...
static_assert(offsetof(ItemCraftingIngredientListEntryHaveNeed_C_DoDesignTimeRandomization, Temp_object_Variable12) == 0x000018, "Member 'ItemCraftingIngredientListEntryHaveNeed_C_DoDesignTimeRandomization::Temp_object_Variable12' has a wrong offset!");
static_assert(offsetof(ItemCraftingIngredientListEntryHaveNeed_C_DoDesignTimeRandomization, Temp_object_Variable123) == 0x000020, "Member 'ItemCraftingIngredientListEntryHaveNeed_C_DoDesignTimeRandomization::Temp_object_Variable123' has a wrong offset!");
