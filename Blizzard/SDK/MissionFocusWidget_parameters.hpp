...
public:
	...
	class FText                                   CallFunc_GetText_ReturnValue1;                     // 0x00A0(0x0018)()
	bool                                          CallFunc_NotEqual_TextText_ReturnValue1;           // 0x00B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_BooleanOR_ReturnValue1) == 0x000042, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_BooleanOR_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_IsValid_ReturnValue1) == 0x000098, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_GetText_ReturnValue1) == 0x0000A0, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_GetText_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateTimer, CallFunc_NotEqual_TextText_ReturnValue1) == 0x0000B8, "Member 'MissionFocusWidget_C_UpdateTimer::CallFunc_NotEqual_TextText_ReturnValue1' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_IsValid_ReturnValue12;                    // 0x0031(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(MissionFocusWidget_C_HandleFocusedMission, K2Node_CreateDelegate_OutputDelegate1) == 0x000020, "Member 'MissionFocusWidget_C_HandleFocusedMission::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_HandleFocusedMission, CallFunc_IsValid_ReturnValue1) == 0x000030, "Member 'MissionFocusWidget_C_HandleFocusedMission::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_HandleFocusedMission, CallFunc_IsValid_ReturnValue12) == 0x000031, "Member 'MissionFocusWidget_C_HandleFocusedMission::CallFunc_IsValid_ReturnValue12' has a wrong offset!");
...
public:
	...
	ESlateVisibility                              K2Node_Select12_Default;                           // 0x0011(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, Temp_byte_Variable1) == 0x000005, "Member 'MissionFocusWidget_C_UpdateVisibility::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, Temp_bool_Variable1) == 0x000006, "Member 'MissionFocusWidget_C_UpdateVisibility::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, Temp_byte_Variable12) == 0x000008, "Member 'MissionFocusWidget_C_UpdateVisibility::Temp_byte_Variable12' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, Temp_byte_Variable123) == 0x000009, "Member 'MissionFocusWidget_C_UpdateVisibility::Temp_byte_Variable123' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, K2Node_Select1_Default) == 0x00000A, "Member 'MissionFocusWidget_C_UpdateVisibility::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, Temp_byte_Variable1234) == 0x00000B, "Member 'MissionFocusWidget_C_UpdateVisibility::Temp_byte_Variable1234' has a wrong offset!");
...
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, Temp_byte_Variable12345) == 0x00000D, "Member 'MissionFocusWidget_C_UpdateVisibility::Temp_byte_Variable12345' has a wrong offset!");
...
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, CallFunc_BooleanOR_ReturnValue1) == 0x00000F, "Member 'MissionFocusWidget_C_UpdateVisibility::CallFunc_BooleanOR_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, Temp_bool_Variable12) == 0x000010, "Member 'MissionFocusWidget_C_UpdateVisibility::Temp_bool_Variable12' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, K2Node_Select12_Default) == 0x000011, "Member 'MissionFocusWidget_C_UpdateVisibility::K2Node_Select12_Default' has a wrong offset!");
...
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, CallFunc_GetText_ReturnValue1) == 0x000038, "Member 'MissionFocusWidget_C_UpdateVisibility::CallFunc_GetText_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, CallFunc_TextIsEmpty_ReturnValue1) == 0x000050, "Member 'MissionFocusWidget_C_UpdateVisibility::CallFunc_TextIsEmpty_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MissionFocusWidget_C_UpdateVisibility, CallFunc_Not_PreBool_ReturnValue1) == 0x000051, "Member 'MissionFocusWidget_C_UpdateVisibility::CallFunc_Not_PreBool_ReturnValue1' has a wrong offset!");
