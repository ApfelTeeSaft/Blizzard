...
static_assert(offsetof(MiniPartyMember_C_ExecuteUbergraph_MiniPartyMember, K2Node_ComponentBoundEvent_Button12) == 0x0001B0, "Member 'MiniPartyMember_C_ExecuteUbergraph_MiniPartyMember::K2Node_ComponentBoundEvent_Button12' has a wrong offset!");
static_assert(offsetof(MiniPartyMember_C_ExecuteUbergraph_MiniPartyMember, K2Node_ComponentBoundEvent_Button1) == 0x0001B8, "Member 'MiniPartyMember_C_ExecuteUbergraph_MiniPartyMember::K2Node_ComponentBoundEvent_Button1' has a wrong offset!");
