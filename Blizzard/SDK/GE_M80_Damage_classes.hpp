...
static_assert(alignof(UGE_M80_Damage_C) == 0x000010, "Wrong alignment on UGE_M80_Damage_C");
static_assert(sizeof(UGE_M80_Damage_C) == 0x000670, "Wrong size on UGE_M80_Damage_C");
