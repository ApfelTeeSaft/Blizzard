...
public:
	...
	struct FMargin                                MinimumPadding;                                    // 0x025C(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	struct FMargin                                ButtonPadding;                                     // 0x03F0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                CustomPadding;                                     // 0x0400(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
class UCommonDynamicEntryBox final : public UWidget
{
public:
	TSubclassOf<class UUserWidget>                EntryWidgetClass;                                  // 0x0100(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_108[0xE8];                                     // 0x0108(0x00E8)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              EntrySpacing;                                      // 0x01F0(0x0008)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FSlateChildSize                        EntrySize;                                         // 0x01F8(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	EHorizontalAlignment                          EntryHAlign;                                       // 0x0200(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EVerticalAlignment                            EntryVAlign;                                       // 0x0201(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_202[0x2];                                      // 0x0202(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxElementSize;                                    // 0x0204(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FVector2D>                      SpacingPattern;                                    // 0x0208(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	EWidgetClipping                               EntryClipping;                                     // 0x0218(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EDynamicBoxType                               BoxType;                                           // 0x0219(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"CommonDynamicEntryBox">();
	}
	static class UCommonDynamicEntryBox* GetDefaultObj()
	{
		return GetDefaultObjImpl<UCommonDynamicEntryBox>();
	}
};
static_assert(alignof(UCommonDynamicEntryBox) == 0x000008, "Wrong alignment on UCommonDynamicEntryBox");
static_assert(sizeof(UCommonDynamicEntryBox) == 0x000230, "Wrong size on UCommonDynamicEntryBox");
static_assert(offsetof(UCommonDynamicEntryBox, EntryWidgetClass) == 0x000100, "Member 'UCommonDynamicEntryBox::EntryWidgetClass' has a wrong offset!");
static_assert(offsetof(UCommonDynamicEntryBox, EntrySpacing) == 0x0001F0, "Member 'UCommonDynamicEntryBox::EntrySpacing' has a wrong offset!");
static_assert(offsetof(UCommonDynamicEntryBox, EntrySize) == 0x0001F8, "Member 'UCommonDynamicEntryBox::EntrySize' has a wrong offset!");
static_assert(offsetof(UCommonDynamicEntryBox, EntryHAlign) == 0x000200, "Member 'UCommonDynamicEntryBox::EntryHAlign' has a wrong offset!");
static_assert(offsetof(UCommonDynamicEntryBox, EntryVAlign) == 0x000201, "Member 'UCommonDynamicEntryBox::EntryVAlign' has a wrong offset!");
static_assert(offsetof(UCommonDynamicEntryBox, MaxElementSize) == 0x000204, "Member 'UCommonDynamicEntryBox::MaxElementSize' has a wrong offset!");
static_assert(offsetof(UCommonDynamicEntryBox, SpacingPattern) == 0x000208, "Member 'UCommonDynamicEntryBox::SpacingPattern' has a wrong offset!");
static_assert(offsetof(UCommonDynamicEntryBox, EntryClipping) == 0x000218, "Member 'UCommonDynamicEntryBox::EntryClipping' has a wrong offset!");
static_assert(offsetof(UCommonDynamicEntryBox, BoxType) == 0x000219, "Member 'UCommonDynamicEntryBox::BoxType' has a wrong offset!");
...
static_assert(alignof(ICommonListItem) == 0x000001, "Wrong alignment on ICommonListItem");
static_assert(sizeof(ICommonListItem) == 0x000001, "Wrong size on ICommonListItem");
...
public:
	...
	UMulticastDelegateProperty_                   OnItemScrolledIntoView;                            // 0x0160(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	float                                         ItemHeight;                                        // 0x0170(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FMargin                                DesiredItemPadding;                                // 0x0174(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnTemplate, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_184[0x4];                                      // 0x0184(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UUserWidget>                ListItemClass;                                     // 0x0188(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	ESelectionMode                                SelectionMode;                                     // 0x0190(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EConsumeMouseWheel                            ConsumeMouseWheel;                                 // 0x0191(0x0001)(Edit, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bClearSelectionOnClick;                            // 0x0192(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_193[0x1];                                      // 0x0193(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         NumPreAllocatedEntries;                            // 0x0194(0x0004)(Edit, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bSimulateDoubleClickOnSelectedItemClick;           // 0x0198(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_199[0x127];                                    // 0x0199(0x0127)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonListViewNullItem*                NullItem;                                          // 0x02C0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCommonListView) == 0x0002C8, "Wrong size on UCommonListView");
...
static_assert(offsetof(UCommonListView, OnItemScrolledIntoView) == 0x000160, "Member 'UCommonListView::OnItemScrolledIntoView' has a wrong offset!");
static_assert(offsetof(UCommonListView, ItemHeight) == 0x000170, "Member 'UCommonListView::ItemHeight' has a wrong offset!");
static_assert(offsetof(UCommonListView, DesiredItemPadding) == 0x000174, "Member 'UCommonListView::DesiredItemPadding' has a wrong offset!");
static_assert(offsetof(UCommonListView, ListItemClass) == 0x000188, "Member 'UCommonListView::ListItemClass' has a wrong offset!");
static_assert(offsetof(UCommonListView, SelectionMode) == 0x000190, "Member 'UCommonListView::SelectionMode' has a wrong offset!");
static_assert(offsetof(UCommonListView, ConsumeMouseWheel) == 0x000191, "Member 'UCommonListView::ConsumeMouseWheel' has a wrong offset!");
static_assert(offsetof(UCommonListView, bClearSelectionOnClick) == 0x000192, "Member 'UCommonListView::bClearSelectionOnClick' has a wrong offset!");
static_assert(offsetof(UCommonListView, NumPreAllocatedEntries) == 0x000194, "Member 'UCommonListView::NumPreAllocatedEntries' has a wrong offset!");
static_assert(offsetof(UCommonListView, bSimulateDoubleClickOnSelectedItemClick) == 0x000198, "Member 'UCommonListView::bSimulateDoubleClickOnSelectedItemClick' has a wrong offset!");
static_assert(offsetof(UCommonListView, NullItem) == 0x0002C0, "Member 'UCommonListView::NullItem' has a wrong offset!");
...
public:
	...
	struct FMargin                                ThrobberPadding;                                   // 0x012C(0x0010)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
...
static_assert(alignof(ICommonObjectListItem) == 0x000001, "Wrong alignment on ICommonObjectListItem");
static_assert(sizeof(ICommonObjectListItem) == 0x000001, "Wrong size on ICommonObjectListItem");
...
public:
	...
	class UCommonTextBlock*                       MyText;                                            // 0x07D0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonRotator) == 0x0007F0, "Wrong size on UCommonRotator");
static_assert(offsetof(UCommonRotator, OnRotated) == 0x0007C0, "Member 'UCommonRotator::OnRotated' has a wrong offset!");
static_assert(offsetof(UCommonRotator, MyText) == 0x0007D0, "Member 'UCommonRotator::MyText' has a wrong offset!");
...
{
public:
	EItemAlignment                                ItemAlignment;                                     // 0x02C8(0x0001)(Edit, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2C9[0x3];                                      // 0x02C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ItemWidth;                                         // 0x02CC(0x0004)(Edit, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonTileView) == 0x0002E0, "Wrong size on UCommonTileView");
static_assert(offsetof(UCommonTileView, ItemAlignment) == 0x0002C8, "Member 'UCommonTileView::ItemAlignment' has a wrong offset!");
static_assert(offsetof(UCommonTileView, ItemWidth) == 0x0002CC, "Member 'UCommonTileView::ItemWidth' has a wrong offset!");
...
{
public:
	TDelegate<void(class UObject* Item)>          OnGetChildrenForCategory;                          // 0x02C8(0x0010)(Edit, ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bAllowInvisibleItemSelection;                      // 0x02D8(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonTreeView) == 0x0002F0, "Wrong size on UCommonTreeView");
static_assert(offsetof(UCommonTreeView, OnGetChildrenForCategory) == 0x0002C8, "Member 'UCommonTreeView::OnGetChildrenForCategory' has a wrong offset!");
static_assert(offsetof(UCommonTreeView, bAllowInvisibleItemSelection) == 0x0002D8, "Member 'UCommonTreeView::bAllowInvisibleItemSelection' has a wrong offset!");
