...
public:
	...
	TDelegate<void(const class AFortObjectiveBase* Objective, EFortObjectiveStatus NewStatus)> K2Node_CreateDelegate_OutputDelegate12; // 0x0038(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(offsetof(DefaultObjectiveContentWidget_C_ExecuteUbergraph_DefaultObjectiveContentWidget, K2Node_CreateDelegate_OutputDelegate12) == 0x000038, "Member 'DefaultObjectiveContentWidget_C_ExecuteUbergraph_DefaultObjectiveContentWidget::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
...
static_assert(offsetof(DefaultObjectiveContentWidget_C_ExecuteUbergraph_DefaultObjectiveContentWidget, K2Node_CreateDelegate_OutputDelegate123) == 0x000078, "Member 'DefaultObjectiveContentWidget_C_ExecuteUbergraph_DefaultObjectiveContentWidget::K2Node_CreateDelegate_OutputDelegate123' has a wrong offset!");
...
static_assert(offsetof(DefaultObjectiveContentWidget_C_Update, CallFunc_IsValid_ReturnValue1) == 0x0000A1, "Member 'DefaultObjectiveContentWidget_C_Update::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(DefaultObjectiveContentWidget_C_Update, K2Node_MakeStruct_FormatArgumentData1) == 0x0000C8, "Member 'DefaultObjectiveContentWidget_C_Update::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
...
static_assert(offsetof(DefaultObjectiveContentWidget_C_Update, K2Node_MakeStruct_FormatArgumentData12) == 0x000160, "Member 'DefaultObjectiveContentWidget_C_Update::K2Node_MakeStruct_FormatArgumentData12' has a wrong offset!");
static_assert(offsetof(DefaultObjectiveContentWidget_C_Update, K2Node_MakeArray_Array1) == 0x0001A0, "Member 'DefaultObjectiveContentWidget_C_Update::K2Node_MakeArray_Array1' has a wrong offset!");
static_assert(offsetof(DefaultObjectiveContentWidget_C_Update, CallFunc_Format_ReturnValue1) == 0x0001B0, "Member 'DefaultObjectiveContentWidget_C_Update::CallFunc_Format_ReturnValue1' has a wrong offset!");
