...
{
public:
	bool                                          ShowTestMesh_0;                                    // 0x03DB(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(AS_Stream_2W_SBend_3L_a_C) == 0x0003E0, "Wrong size on AS_Stream_2W_SBend_3L_a_C");
static_assert(offsetof(AS_Stream_2W_SBend_3L_a_C, ShowTestMesh_0) == 0x0003DB, "Member 'AS_Stream_2W_SBend_3L_a_C::ShowTestMesh_0' has a wrong offset!");
