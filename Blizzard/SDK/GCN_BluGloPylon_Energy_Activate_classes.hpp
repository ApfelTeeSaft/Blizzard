...
static_assert(alignof(AGCN_BluGloPylon_Energy_Activate_C) == 0x000010, "Wrong alignment on AGCN_BluGloPylon_Energy_Activate_C");
static_assert(sizeof(AGCN_BluGloPylon_Energy_Activate_C) == 0x000450, "Wrong size on AGCN_BluGloPylon_Energy_Activate_C");
static_assert(offsetof(AGCN_BluGloPylon_Energy_Activate_C, IconTexture) == 0x000440, "Member 'AGCN_BluGloPylon_Energy_Activate_C::IconTexture' has a wrong offset!");
