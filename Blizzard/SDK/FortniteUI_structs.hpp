...
enum class EFortUIFeature : uint8
{
	...
	ShowAthenaChallenges                     = 22,
	Max_None                                 = 23,
	EFortUIFeature_MAX                       = 24,
};
...
public:
	...
	bool                                          bCurrentlyInteracting;                             // 0x0003(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsSkydiving;                                      // 0x0004(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bInBus;                                            // 0x0005(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortHUDState) == 0x000001, "Wrong alignment on FFortHUDState");
static_assert(sizeof(FFortHUDState) == 0x000006, "Wrong size on FFortHUDState");
...
static_assert(offsetof(FFortHUDState, bCurrentlyInteracting) == 0x000003, "Member 'FFortHUDState::bCurrentlyInteracting' has a wrong offset!");
static_assert(offsetof(FFortHUDState, bIsSkydiving) == 0x000004, "Member 'FFortHUDState::bIsSkydiving' has a wrong offset!");
static_assert(offsetof(FFortHUDState, bInBus) == 0x000005, "Member 'FFortHUDState::bInBus' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            Brush;                                             // 0x0018(0x0078)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRadialOptionData) == 0x000008, "Wrong alignment on FRadialOptionData");
static_assert(sizeof(FRadialOptionData) == 0x000090, "Wrong size on FRadialOptionData");
...
{
public:
	class FText                                   MapNoteText;                                       // 0x0090(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMapNoteOptionData) == 0x000008, "Wrong alignment on FMapNoteOptionData");
static_assert(sizeof(FMapNoteOptionData) == 0x0000A8, "Wrong size on FMapNoteOptionData");
static_assert(offsetof(FMapNoteOptionData, MapNoteText) == 0x000090, "Member 'FMapNoteOptionData::MapNoteText' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            IconBrush;                                         // 0x0018(0x0078)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortTabButtonLabelInfo) == 0x000008, "Wrong alignment on FFortTabButtonLabelInfo");
static_assert(sizeof(FFortTabButtonLabelInfo) == 0x000090, "Wrong size on FFortTabButtonLabelInfo");
...
public:
	...
	struct FFortTabButtonLabelInfo                TabLabelInfo;                                      // 0x0010(0x0090)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TSubclassOf<class UCommonButton>              TabButtonType;                                     // 0x00A0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UCommonUserWidget>          TabContentType;                                    // 0x00A8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidget*                                CreatedTabContentWidget;                           // 0x00B0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortTabListRegistrationInfo) == 0x000008, "Wrong alignment on FFortTabListRegistrationInfo");
static_assert(sizeof(FFortTabListRegistrationInfo) == 0x0000B8, "Wrong size on FFortTabListRegistrationInfo");
...
static_assert(offsetof(FFortTabListRegistrationInfo, TabButtonType) == 0x0000A0, "Member 'FFortTabListRegistrationInfo::TabButtonType' has a wrong offset!");
static_assert(offsetof(FFortTabListRegistrationInfo, TabContentType) == 0x0000A8, "Member 'FFortTabListRegistrationInfo::TabContentType' has a wrong offset!");
static_assert(offsetof(FFortTabListRegistrationInfo, CreatedTabContentWidget) == 0x0000B0, "Member 'FFortTabListRegistrationInfo::CreatedTabContentWidget' has a wrong offset!");
...
{
public:
	struct FSlateBrush                            KillerBrush;                                       // 0x0000(0x0078)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                   KillerName;                                        // 0x0078(0x0018)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortKillerVisualInfo) == 0x000008, "Wrong alignment on FFortKillerVisualInfo");
static_assert(sizeof(FFortKillerVisualInfo) == 0x000090, "Wrong size on FFortKillerVisualInfo");
...
static_assert(offsetof(FFortKillerVisualInfo, KillerName) == 0x000078, "Member 'FFortKillerVisualInfo::KillerName' has a wrong offset!");
...
{
public:
	struct FFortMultiSizeBrush                    ActiveBrush;                                       // 0x0008(0x02D0)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FFortMultiSizeBrush                    InactiveBrush;                                     // 0x02D8(0x02D0)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class UMediaSource*                           PreviewMediaSource;                                // 0x05A8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortNodeStyleData) == 0x000008, "Wrong alignment on FFortNodeStyleData");
static_assert(sizeof(FFortNodeStyleData) == 0x0005B0, "Wrong size on FFortNodeStyleData");
static_assert(offsetof(FFortNodeStyleData, ActiveBrush) == 0x000008, "Member 'FFortNodeStyleData::ActiveBrush' has a wrong offset!");
static_assert(offsetof(FFortNodeStyleData, InactiveBrush) == 0x0002D8, "Member 'FFortNodeStyleData::InactiveBrush' has a wrong offset!");
static_assert(offsetof(FFortNodeStyleData, PreviewMediaSource) == 0x0005A8, "Member 'FFortNodeStyleData::PreviewMediaSource' has a wrong offset!");
...
{
public:
	struct FSlateBrush                            PowerRatingIconBrush;                              // 0x0050(0x0078)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   PowerRatingTextStyle;                              // 0x00C8(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortItemCard_PowerRatingBlock_ItemInstance_Configuration) == 0x0000F0, "Wrong size on FFortItemCard_PowerRatingBlock_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_PowerRatingBlock_ItemInstance_Configuration, PowerRatingTextStyle) == 0x0000C8, "Member 'FFortItemCard_PowerRatingBlock_ItemInstance_Configuration::PowerRatingTextStyle' has a wrong offset!");
...
{
public:
	TSoftClassPtr<class UClass>                   TextStyle;                                         // 0x0000(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FFortItemCard_StackCountBlock_Configuration, TextStyle) == 0x000000, "Member 'FFortItemCard_StackCountBlock_Configuration::TextStyle' has a wrong offset!");
...
public:
	...
	struct FFortItemCard_PowerRatingBlock_ItemInstance_Configuration PowerRatingBlock;               // 0x0020(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FFortItemCard_StackCountBlock_Configuration StackCountBlock;                              // 0x0110(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FMargin                                TraitBoxPadding;                                   // 0x0138(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FMargin                                TierMeterPadding;                                  // 0x015C(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortItemCard_M_ItemInstance_Configuration) == 0x000190, "Wrong size on FFortItemCard_M_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, StackCountBlock) == 0x000110, "Member 'FFortItemCard_M_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, TraitBoxPadding) == 0x000138, "Member 'FFortItemCard_M_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, FirstTraitSize) == 0x000148, "Member 'FFortItemCard_M_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, PaddingBetweenTraitIcons) == 0x000150, "Member 'FFortItemCard_M_ItemInstance_Configuration::PaddingBetweenTraitIcons' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, SecondTraitSize) == 0x000154, "Member 'FFortItemCard_M_ItemInstance_Configuration::SecondTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, TierMeterPadding) == 0x00015C, "Member 'FFortItemCard_M_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, TierMeter) == 0x00016C, "Member 'FFortItemCard_M_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, DurabilityMeter) == 0x000178, "Member 'FFortItemCard_M_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
{
public:
	class FText                                   ChatText;                                          // 0x0090(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FChatOptionData) == 0x000008, "Wrong alignment on FChatOptionData");
static_assert(sizeof(FChatOptionData) == 0x0000A8, "Wrong size on FChatOptionData");
static_assert(offsetof(FChatOptionData, ChatText) == 0x000090, "Member 'FChatOptionData::ChatText' has a wrong offset!");
...
{
public:
	struct FSlateBrush                            PersonnelPowerRatingIconBrush;                     // 0x0050(0x0078)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   PersonnelPowerRatingTextStyle;                     // 0x00C8(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateBrush                            SchematicPowerRatingIconBrush;                     // 0x00F0(0x0078)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   SchematicPowerRatingTextStyle;                     // 0x0168(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration) == 0x000190, "Wrong size on FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration, PersonnelPowerRatingTextStyle) == 0x0000C8, "Member 'FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration::PersonnelPowerRatingTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration, SchematicPowerRatingIconBrush) == 0x0000F0, "Member 'FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration::SchematicPowerRatingIconBrush' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration, SchematicPowerRatingTextStyle) == 0x000168, "Member 'FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration::SchematicPowerRatingTextStyle' has a wrong offset!");
...
public:
	...
	struct FVector2D                              TransformKeyIconSize;                              // 0x0038(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortItemCard_M_TransformKey_Configuration) == 0x000040, "Wrong size on FFortItemCard_M_TransformKey_Configuration");
...
{
public:
	struct FFortMultiSizeBrush                    Brush;                                             // 0x0000(0x02D0)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FLinearColor                           PrimaryColor;                                      // 0x02D0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           SecondaryColor;                                    // 0x02E0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortStateStyle) == 0x000008, "Wrong alignment on FFortStateStyle");
static_assert(sizeof(FFortStateStyle) == 0x0002F0, "Wrong size on FFortStateStyle");
static_assert(offsetof(FFortStateStyle, Brush) == 0x000000, "Member 'FFortStateStyle::Brush' has a wrong offset!");
static_assert(offsetof(FFortStateStyle, PrimaryColor) == 0x0002D0, "Member 'FFortStateStyle::PrimaryColor' has a wrong offset!");
static_assert(offsetof(FFortStateStyle, SecondaryColor) == 0x0002E0, "Member 'FFortStateStyle::SecondaryColor' has a wrong offset!");
...
static_assert(sizeof(FAthenaNewsEntry) == 0x000030, "Wrong size on FAthenaNewsEntry");
...
public:
	...
	struct FSlateBrush                            Brush;                                             // 0x0010(0x0078)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortItemCard_NameplateBorder_Configuration) == 0x000088, "Wrong size on FFortItemCard_NameplateBorder_Configuration");
...
public:
	struct FMargin                                BackgroundPadding;                                 // 0x0000(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration PowerRatingBlock;     // 0x0010(0x0190)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FVector2D                              BookmarkImageSize;                                 // 0x01A0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortItemCard_NameplateBorder_Configuration Nameplate;                                    // 0x01A8(0x0088)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FVector2D                              ClassIconSize;                                     // 0x0230(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              LeadSurvivorTypeIconSize;                          // 0x0238(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              FirstIconSlotSize;                                 // 0x0240(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PaddingBetweenIconSlots;                           // 0x0248(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              SecondIconSlotSize;                                // 0x024C(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortItemCard_DefenderWeaponTypeIcon_Configuration DefenderWeaponTypeIcon;                // 0x0254(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	struct FFortItemCard_DetailAreaBorder_Configuration DetailAreaBorder;                            // 0x025C(0x0014)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	struct FFortItemCard_LevelMeter_Configuration LevelMeter;                                        // 0x0270(0x0014)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	float                                         TierMeterLeftPadding;                              // 0x0284(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortItemCard_TierMeter_Configuration  TierMeter;                                         // 0x0288(0x000C)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortItemCard_S_PersonnelAndSchematics_Configuration) == 0x000298, "Wrong size on FFortItemCard_S_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x0001A0, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, Nameplate) == 0x0001A8, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x000230, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x000238, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x000240, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x000248, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x00024C, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x000254, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x00025C, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, LevelMeter) == 0x000270, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::LevelMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x000284, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, TierMeter) == 0x000288, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_L_TransformKey_Configuration) == 0x000040, "Wrong size on FFortItemCard_L_TransformKey_Configuration");
...
{
public:
	class FName                                   FilterTabNameId;                                   // 0x0090(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortAthenaItemManagementInventoryFilterTabLabelInfo) == 0x000098, "Wrong size on FFortAthenaItemManagementInventoryFilterTabLabelInfo");
static_assert(offsetof(FFortAthenaItemManagementInventoryFilterTabLabelInfo, FilterTabNameId) == 0x000090, "Member 'FFortAthenaItemManagementInventoryFilterTabLabelInfo::FilterTabNameId' has a wrong offset!");
...
static_assert(sizeof(FAthenaNews) == 0x000010, "Wrong size on FAthenaNews");
...
{
public:
	struct FSlateBrush                            Icon;                                              // 0x0000(0x0078)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                   DisplayName;                                       // 0x0078(0x0018)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class UFortItem*                              Item;                                              // 0x0090(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsMissionAlertReward;                             // 0x0098(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_99[0x7];                                       // 0x0099(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortMissionRewardInfo) == 0x000008, "Wrong alignment on FFortMissionRewardInfo");
static_assert(sizeof(FFortMissionRewardInfo) == 0x0000A0, "Wrong size on FFortMissionRewardInfo");
static_assert(offsetof(FFortMissionRewardInfo, Icon) == 0x000000, "Member 'FFortMissionRewardInfo::Icon' has a wrong offset!");
static_assert(offsetof(FFortMissionRewardInfo, DisplayName) == 0x000078, "Member 'FFortMissionRewardInfo::DisplayName' has a wrong offset!");
static_assert(offsetof(FFortMissionRewardInfo, Item) == 0x000090, "Member 'FFortMissionRewardInfo::Item' has a wrong offset!");
static_assert(offsetof(FFortMissionRewardInfo, bIsMissionAlertReward) == 0x000098, "Member 'FFortMissionRewardInfo::bIsMissionAlertReward' has a wrong offset!");
...
public:
	class FName                                   TabNameID;                                         // 0x0000(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortTabButtonLabelInfo                TabLabelInfo;                                      // 0x0008(0x0090)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
static_assert(alignof(FExpeditionTabInfo) == 0x000008, "Wrong alignment on FExpeditionTabInfo");
static_assert(sizeof(FExpeditionTabInfo) == 0x000098, "Wrong size on FExpeditionTabInfo");
...
static_assert(sizeof(FFortItemCard_M_PersonnelAndSchematics_Configuration) == 0x000298, "Wrong size on FFortItemCard_M_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x0001A0, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, Nameplate) == 0x0001A8, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x000230, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x000238, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x000240, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x000248, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x00024C, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x000254, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x00025C, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, LevelMeter) == 0x000270, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::LevelMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x000284, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, TierMeter) == 0x000288, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_S_TransformKey_Configuration) == 0x000040, "Wrong size on FFortItemCard_S_TransformKey_Configuration");
...
public:
	...
	struct FFortMultiSizeBrush                    MissionIcons;                                      // 0x0018(0x02D0)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                   TheaterName;                                       // 0x02E8(0x0018)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                   DifficultyName;                                    // 0x0300(0x0018)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class UMediaSource*                           EndOfMissionMediaSource;                           // 0x0318(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSkipEndOfMissionVideo;                            // 0x0320(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortBasicMissionInfo) == 0x000328, "Wrong size on FFortBasicMissionInfo");
...
static_assert(offsetof(FFortBasicMissionInfo, TheaterName) == 0x0002E8, "Member 'FFortBasicMissionInfo::TheaterName' has a wrong offset!");
static_assert(offsetof(FFortBasicMissionInfo, DifficultyName) == 0x000300, "Member 'FFortBasicMissionInfo::DifficultyName' has a wrong offset!");
static_assert(offsetof(FFortBasicMissionInfo, EndOfMissionMediaSource) == 0x000318, "Member 'FFortBasicMissionInfo::EndOfMissionMediaSource' has a wrong offset!");
static_assert(offsetof(FFortBasicMissionInfo, bSkipEndOfMissionVideo) == 0x000320, "Member 'FFortBasicMissionInfo::bSkipEndOfMissionVideo' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_XS_TransformKey_Configuration) == 0x000040, "Wrong size on FFortItemCard_XS_TransformKey_Configuration");
...
public:
	...
	struct FMargin                                PowerRatingBlockPadding;                           // 0x0010(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FFortItemCard_PowerRatingBlock_ItemInstance_Configuration PowerRatingBlock;               // 0x0020(0x00F0)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FMargin                                TraitBoxPadding;                                   // 0x0110(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector2D                              FirstTraitSize;                                    // 0x0120(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortItemCard_StackCountBlock_Configuration StackCountBlock;                              // 0x0128(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortItemCard_XS_ItemInstance_Configuration) == 0x000168, "Wrong size on FFortItemCard_XS_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, TraitBoxPadding) == 0x000110, "Member 'FFortItemCard_XS_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, FirstTraitSize) == 0x000120, "Member 'FFortItemCard_XS_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, StackCountBlock) == 0x000128, "Member 'FFortItemCard_XS_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, DurabilityMeter) == 0x000150, "Member 'FFortItemCard_XS_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
public:
	...
	struct FMargin                                TraitBoxPadding;                                   // 0x0138(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector2D                              FirstTraitSize;                                    // 0x0148(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMargin                                TierMeterPadding;                                  // 0x0150(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortItemCard_S_ItemInstance_Configuration) == 0x000180, "Wrong size on FFortItemCard_S_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, StackCountBlock) == 0x000110, "Member 'FFortItemCard_S_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, TraitBoxPadding) == 0x000138, "Member 'FFortItemCard_S_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, FirstTraitSize) == 0x000148, "Member 'FFortItemCard_S_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, TierMeterPadding) == 0x000150, "Member 'FFortItemCard_S_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, TierMeter) == 0x000160, "Member 'FFortItemCard_S_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, DurabilityMeter) == 0x00016C, "Member 'FFortItemCard_S_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_L_ItemInstance_Configuration) == 0x000190, "Wrong size on FFortItemCard_L_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, StackCountBlock) == 0x000110, "Member 'FFortItemCard_L_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, TraitBoxPadding) == 0x000138, "Member 'FFortItemCard_L_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, FirstTraitSize) == 0x000148, "Member 'FFortItemCard_L_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, PaddingBetweenTraitIcons) == 0x000150, "Member 'FFortItemCard_L_ItemInstance_Configuration::PaddingBetweenTraitIcons' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, SecondTraitSize) == 0x000154, "Member 'FFortItemCard_L_ItemInstance_Configuration::SecondTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, TierMeterPadding) == 0x00015C, "Member 'FFortItemCard_L_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, TierMeter) == 0x00016C, "Member 'FFortItemCard_L_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, DurabilityMeter) == 0x000178, "Member 'FFortItemCard_L_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_L_PersonnelAndSchematics_Configuration) == 0x000298, "Wrong size on FFortItemCard_L_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x0001A0, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, Nameplate) == 0x0001A8, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x000230, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x000238, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x000240, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x000248, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x00024C, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x000254, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x00025C, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, LevelMeter) == 0x000270, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::LevelMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x000284, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, TierMeter) == 0x000288, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
...
{
public:
	struct FFortMultiSizeBrush                    Icon;                                              // 0x0000(0x02D0)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class UMediaSource*                           PreviewVideoMediaSource;                           // 0x02D0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortSkillTreeNodeDisplayData) == 0x000008, "Wrong alignment on FFortSkillTreeNodeDisplayData");
static_assert(sizeof(FFortSkillTreeNodeDisplayData) == 0x0002D8, "Wrong size on FFortSkillTreeNodeDisplayData");
...
static_assert(offsetof(FFortSkillTreeNodeDisplayData, PreviewVideoMediaSource) == 0x0002D0, "Member 'FFortSkillTreeNodeDisplayData::PreviewVideoMediaSource' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_XL_TransformKey_Configuration) == 0x000040, "Wrong size on FFortItemCard_XL_TransformKey_Configuration");
...
static_assert(sizeof(FFortItemCard_XL_ItemInstance_Configuration) == 0x000190, "Wrong size on FFortItemCard_XL_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, StackCountBlock) == 0x000110, "Member 'FFortItemCard_XL_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, TraitBoxPadding) == 0x000138, "Member 'FFortItemCard_XL_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, FirstTraitSize) == 0x000148, "Member 'FFortItemCard_XL_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, PaddingBetweenTraitIcons) == 0x000150, "Member 'FFortItemCard_XL_ItemInstance_Configuration::PaddingBetweenTraitIcons' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, SecondTraitSize) == 0x000154, "Member 'FFortItemCard_XL_ItemInstance_Configuration::SecondTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, TierMeterPadding) == 0x00015C, "Member 'FFortItemCard_XL_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, TierMeter) == 0x00016C, "Member 'FFortItemCard_XL_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, DurabilityMeter) == 0x000178, "Member 'FFortItemCard_XL_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
public:
	...
	struct FVector2D                              BookmarkImageSize;                                 // 0x01A0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortItemCard_NameplateBorder_Configuration Nameplate;                                    // 0x01A8(0x0088)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   ItemNameTextStyle;                                 // 0x0230(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              LeadSurvivorTypeIconSize;                          // 0x0258(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              FirstIconSlotSize;                                 // 0x0260(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PaddingBetweenIconSlots;                           // 0x0268(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              SecondIconSlotSize;                                // 0x026C(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortItemCard_DefenderWeaponTypeIcon_Configuration DefenderWeaponTypeIcon;                // 0x0274(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	struct FFortItemCard_DetailAreaBorder_Configuration DetailAreaBorder;                            // 0x027C(0x0014)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	float                                         RarityNameTextLeftPadding;                         // 0x0290(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_294[0x4];                                      // 0x0294(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftClassPtr<class UClass>                   RarityNameTextStyle;                               // 0x0298(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ClassIconImageLeftPadding;                         // 0x02C0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              ClassIconSize;                                     // 0x02C4(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PaddingBetweenClassIconAndName;                    // 0x02CC(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   ClassNameTextStyle;                                // 0x02D0(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TierMeterLeftPadding;                              // 0x02F8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortItemCard_TierMeter_Configuration  TierMeter;                                         // 0x02FC(0x000C)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                IconSlotOverNameplatePadding;                      // 0x0308(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector2D                              IconSlotOverNameplateSize;                         // 0x0318(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortItemCard_XL_PersonnelAndSchematics_Configuration) == 0x000320, "Wrong size on FFortItemCard_XL_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x0001A0, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, Nameplate) == 0x0001A8, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ItemNameTextStyle) == 0x000230, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ItemNameTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x000258, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x000260, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x000268, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x00026C, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x000274, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x00027C, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, RarityNameTextLeftPadding) == 0x000290, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::RarityNameTextLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, RarityNameTextStyle) == 0x000298, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::RarityNameTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ClassIconImageLeftPadding) == 0x0002C0, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ClassIconImageLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x0002C4, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, PaddingBetweenClassIconAndName) == 0x0002CC, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::PaddingBetweenClassIconAndName' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ClassNameTextStyle) == 0x0002D0, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ClassNameTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x0002F8, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, TierMeter) == 0x0002FC, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, IconSlotOverNameplatePadding) == 0x000308, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::IconSlotOverNameplatePadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, IconSlotOverNameplateSize) == 0x000318, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::IconSlotOverNameplateSize' has a wrong offset!");
...
static_assert(sizeof(FFortItemManagementInventoryFilterTabLabelInfo) == 0x000098, "Wrong size on FFortItemManagementInventoryFilterTabLabelInfo");
static_assert(offsetof(FFortItemManagementInventoryFilterTabLabelInfo, FilterTabNameId) == 0x000090, "Member 'FFortItemManagementInventoryFilterTabLabelInfo::FilterTabNameId' has a wrong offset!");
...
public:
	class FText                                   DisplayName;                                       // 0x0000(0x0018)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FFortNodeStyleData                     Style;                                             // 0x0018(0x05B0)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	bool                                          bIsNodePage;                                       // 0x05C8(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5C9[0x3];                                      // 0x05C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MinRequiredNodesInPage;                            // 0x05CC(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         OwnedNodesInPage;                                  // 0x05D0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5D4[0x4];                                      // 0x05D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   NodeType;                                          // 0x05D8(0x0018)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortUINodePrerequisite) == 0x000008, "Wrong alignment on FFortUINodePrerequisite");
static_assert(sizeof(FFortUINodePrerequisite) == 0x0005F0, "Wrong size on FFortUINodePrerequisite");
...
static_assert(offsetof(FFortUINodePrerequisite, bIsNodePage) == 0x0005C8, "Member 'FFortUINodePrerequisite::bIsNodePage' has a wrong offset!");
static_assert(offsetof(FFortUINodePrerequisite, MinRequiredNodesInPage) == 0x0005CC, "Member 'FFortUINodePrerequisite::MinRequiredNodesInPage' has a wrong offset!");
static_assert(offsetof(FFortUINodePrerequisite, OwnedNodesInPage) == 0x0005D0, "Member 'FFortUINodePrerequisite::OwnedNodesInPage' has a wrong offset!");
static_assert(offsetof(FFortUINodePrerequisite, NodeType) == 0x0005D8, "Member 'FFortUINodePrerequisite::NodeType' has a wrong offset!");
...
{
public:
	struct FAthenaQuickChatActiveEntry            ChatEntry;                                         // 0x0090(0x0018)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSquadQuickChatOptionData) == 0x000008, "Wrong alignment on FSquadQuickChatOptionData");
static_assert(sizeof(FSquadQuickChatOptionData) == 0x0000A8, "Wrong size on FSquadQuickChatOptionData");
static_assert(offsetof(FSquadQuickChatOptionData, ChatEntry) == 0x000090, "Member 'FSquadQuickChatOptionData::ChatEntry' has a wrong offset!");
...
{
public:
	class UObject*                                ItemDef;                                           // 0x0090(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FItemDefOptionData) == 0x000008, "Wrong alignment on FItemDefOptionData");
static_assert(sizeof(FItemDefOptionData) == 0x000098, "Wrong size on FItemDefOptionData");
static_assert(offsetof(FItemDefOptionData, ItemDef) == 0x000090, "Member 'FItemDefOptionData::ItemDef' has a wrong offset!");
...
{
public:
	class FName                                   EmoteCommand;                                      // 0x0090(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FEmoteOptionData) == 0x000008, "Wrong alignment on FEmoteOptionData");
static_assert(sizeof(FEmoteOptionData) == 0x000098, "Wrong size on FEmoteOptionData");
static_assert(offsetof(FEmoteOptionData, EmoteCommand) == 0x000090, "Member 'FEmoteOptionData::EmoteCommand' has a wrong offset!");
...
static_assert(sizeof(FSquadChatOptionData) == 0x0000A8, "Wrong size on FSquadChatOptionData");
static_assert(offsetof(FSquadChatOptionData, ChatText) == 0x000090, "Member 'FSquadChatOptionData::ChatText' has a wrong offset!");
...
{
public:
	class FString                                 TemplatePrefix;                                    // 0x0090(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EBuildingAttachmentType                       BuildingAttachmentType;                            // 0x00A0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A1[0x7];                                       // 0x00A1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FItemCategoryOptionData) == 0x000008, "Wrong alignment on FItemCategoryOptionData");
static_assert(sizeof(FItemCategoryOptionData) == 0x0000A8, "Wrong size on FItemCategoryOptionData");
static_assert(offsetof(FItemCategoryOptionData, TemplatePrefix) == 0x000090, "Member 'FItemCategoryOptionData::TemplatePrefix' has a wrong offset!");
static_assert(offsetof(FItemCategoryOptionData, BuildingAttachmentType) == 0x0000A0, "Member 'FItemCategoryOptionData::BuildingAttachmentType' has a wrong offset!");
...
{
public:
	class FString                                 ClassSuffix;                                       // 0x0090(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ClassMirrored;                                     // 0x00A0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A1[0x7];                                       // 0x00A1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBuildingOptionData) == 0x000008, "Wrong alignment on FBuildingOptionData");
static_assert(sizeof(FBuildingOptionData) == 0x0000A8, "Wrong size on FBuildingOptionData");
static_assert(offsetof(FBuildingOptionData, ClassSuffix) == 0x000090, "Member 'FBuildingOptionData::ClassSuffix' has a wrong offset!");
static_assert(offsetof(FBuildingOptionData, ClassMirrored) == 0x0000A0, "Member 'FBuildingOptionData::ClassMirrored' has a wrong offset!");
...
{
public:
	EFortBuildingType                             BuildingType;                                      // 0x0090(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_91[0x7];                                       // 0x0091(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBuildingCategoryOptionData) == 0x000008, "Wrong alignment on FBuildingCategoryOptionData");
static_assert(sizeof(FBuildingCategoryOptionData) == 0x000098, "Wrong size on FBuildingCategoryOptionData");
static_assert(offsetof(FBuildingCategoryOptionData, BuildingType) == 0x000090, "Member 'FBuildingCategoryOptionData::BuildingType' has a wrong offset!");
...
{
public:
	class FText                                   Platform;                                          // 0x0000(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   SocialService;                                     // 0x0018(0x0018)(Edit, NativeAccessSpecifierPublic)
	EFortLoginAccountType                         AccountType;                                       // 0x0030(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnabledAtRelease;                                 // 0x0031(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_32[0x6];                                       // 0x0032(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPlatformSupportDesc) == 0x000008, "Wrong alignment on FPlatformSupportDesc");
static_assert(sizeof(FPlatformSupportDesc) == 0x000038, "Wrong size on FPlatformSupportDesc");
static_assert(offsetof(FPlatformSupportDesc, Platform) == 0x000000, "Member 'FPlatformSupportDesc::Platform' has a wrong offset!");
static_assert(offsetof(FPlatformSupportDesc, SocialService) == 0x000018, "Member 'FPlatformSupportDesc::SocialService' has a wrong offset!");
static_assert(offsetof(FPlatformSupportDesc, AccountType) == 0x000030, "Member 'FPlatformSupportDesc::AccountType' has a wrong offset!");
static_assert(offsetof(FPlatformSupportDesc, bEnabledAtRelease) == 0x000031, "Member 'FPlatformSupportDesc::bEnabledAtRelease' has a wrong offset!");
...
{
public:
	struct FTextBlockStyle                        TextStyle;                                         // 0x0008(0x01C8)(Edit, NativeAccessSpecifierPublic)
	bool                                          bHyperlinkStyle;                                   // 0x01D0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortRichTextStyleData) == 0x0001D8, "Wrong size on FFortRichTextStyleData");
...
static_assert(offsetof(FFortRichTextStyleData, bHyperlinkStyle) == 0x0001D0, "Member 'FFortRichTextStyleData::bHyperlinkStyle' has a wrong offset!");
...
public:
	...
	TArray<struct FGameplayTag>                   SetBonusesGained;                                  // 0x0008(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FGameplayTag>                   SetBonusesLost;                                    // 0x0018(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         PreviousPersonalityMatchCount;                     // 0x0028(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         CurrentPersonalityMatchCount;                      // 0x002C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortSurvivorSquadSlottingFeedbackData) == 0x000030, "Wrong size on FFortSurvivorSquadSlottingFeedbackData");
...
static_assert(offsetof(FFortSurvivorSquadSlottingFeedbackData, SetBonusesGained) == 0x000008, "Member 'FFortSurvivorSquadSlottingFeedbackData::SetBonusesGained' has a wrong offset!");
static_assert(offsetof(FFortSurvivorSquadSlottingFeedbackData, SetBonusesLost) == 0x000018, "Member 'FFortSurvivorSquadSlottingFeedbackData::SetBonusesLost' has a wrong offset!");
static_assert(offsetof(FFortSurvivorSquadSlottingFeedbackData, PreviousPersonalityMatchCount) == 0x000028, "Member 'FFortSurvivorSquadSlottingFeedbackData::PreviousPersonalityMatchCount' has a wrong offset!");
static_assert(offsetof(FFortSurvivorSquadSlottingFeedbackData, CurrentPersonalityMatchCount) == 0x00002C, "Member 'FFortSurvivorSquadSlottingFeedbackData::CurrentPersonalityMatchCount' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFortMultiSizeBrush                    PersonalityIcons;                                  // 0x0010(0x02D0)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortSurvivorSquadSelectorButtonPersonalityMatches) == 0x0002E0, "Wrong size on FFortSurvivorSquadSelectorButtonPersonalityMatches");
...
{
public:
	struct FFortMultiSizeBrush                    Icons;                                             // 0x0000(0x02D0)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                   MagnitudeText;                                     // 0x02D0(0x0018)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                   AttributeDisplayName;                              // 0x02E8(0x0018)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	int32                                         NumMembersMeetingCriteria;                         // 0x0300(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumMembersRequired;                                // 0x0304(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFortUISurvivorSquadMatchType                 MatchType;                                         // 0x0308(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFortBuffState                                PreviewEffect;                                     // 0x0309(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortUISurvivorSquadStatMatch) == 0x000310, "Wrong size on FFortUISurvivorSquadStatMatch");
...
static_assert(offsetof(FFortUISurvivorSquadStatMatch, MagnitudeText) == 0x0002D0, "Member 'FFortUISurvivorSquadStatMatch::MagnitudeText' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, AttributeDisplayName) == 0x0002E8, "Member 'FFortUISurvivorSquadStatMatch::AttributeDisplayName' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, NumMembersMeetingCriteria) == 0x000300, "Member 'FFortUISurvivorSquadStatMatch::NumMembersMeetingCriteria' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, NumMembersRequired) == 0x000304, "Member 'FFortUISurvivorSquadStatMatch::NumMembersRequired' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, MatchType) == 0x000308, "Member 'FFortUISurvivorSquadStatMatch::MatchType' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, PreviewEffect) == 0x000309, "Member 'FFortUISurvivorSquadStatMatch::PreviewEffect' has a wrong offset!");
...
public:
	...
	struct FFortTabButtonLabelInfo                TabButtonLabelInfo;                                // 0x0008(0x0090)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TArray<EFortInventoryFilter>                  ItemFilters;                                       // 0x0098(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	EFortItemType                                 ItemType;                                          // 0x00A8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortItemTransformFilterTabLabelInfo) == 0x0000B0, "Wrong size on FFortItemTransformFilterTabLabelInfo");
...
static_assert(offsetof(FFortItemTransformFilterTabLabelInfo, ItemFilters) == 0x000098, "Member 'FFortItemTransformFilterTabLabelInfo::ItemFilters' has a wrong offset!");
static_assert(offsetof(FFortItemTransformFilterTabLabelInfo, ItemType) == 0x0000A8, "Member 'FFortItemTransformFilterTabLabelInfo::ItemType' has a wrong offset!");
...
{
public:
	struct FFortMultiSizeBrush                    Brush;                                             // 0x0008(0x02D0)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortSquadIconData) == 0x000008, "Wrong alignment on FFortSquadIconData");
static_assert(sizeof(FFortSquadIconData) == 0x0002D8, "Wrong size on FFortSquadIconData");
