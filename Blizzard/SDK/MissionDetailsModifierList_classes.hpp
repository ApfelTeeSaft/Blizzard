...
static_assert(sizeof(UMissionDetailsModifierList_C) == 0x000238, "Wrong size on UMissionDetailsModifierList_C");
...
static_assert(offsetof(UMissionDetailsModifierList_C, DebugMods) == 0x000228, "Member 'UMissionDetailsModifierList_C::DebugMods' has a wrong offset!");
