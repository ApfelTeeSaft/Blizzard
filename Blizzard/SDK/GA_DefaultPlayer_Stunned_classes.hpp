...
public:
	...
	struct FFortFeedbackHandle                    StunFeedbackEvent;                                 // 0x0AE8(0x0018)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
...
static_assert(sizeof(UGA_DefaultPlayer_Stunned_C) == 0x000B00, "Wrong size on UGA_DefaultPlayer_Stunned_C");
...
static_assert(offsetof(UGA_DefaultPlayer_Stunned_C, StunFeedbackEvent) == 0x000AE8, "Member 'UGA_DefaultPlayer_Stunned_C::StunFeedbackEvent' has a wrong offset!");
