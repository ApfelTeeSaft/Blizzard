...
public:
	...
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData12;            // 0x00F8(0x0040)(HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>            K2Node_MakeArray_Array12;                          // 0x0138(0x0010)(ZeroConstructor, ReferenceParm)
...
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, CallFunc_Format_ReturnValue) == 0x000078, "Member 'Rewards_Header_C_PopulateFromRewardType::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_MakeStruct_FormatArgumentData1) == 0x000090, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_MakeArray_Array1) == 0x0000D0, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_MakeArray_Array1' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, CallFunc_Format_ReturnValue1) == 0x0000E0, "Member 'Rewards_Header_C_PopulateFromRewardType::CallFunc_Format_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_MakeStruct_FormatArgumentData12) == 0x0000F8, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_MakeStruct_FormatArgumentData12' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, K2Node_MakeArray_Array12) == 0x000138, "Member 'Rewards_Header_C_PopulateFromRewardType::K2Node_MakeArray_Array12' has a wrong offset!");
static_assert(offsetof(Rewards_Header_C_PopulateFromRewardType, CallFunc_Format_ReturnValue12) == 0x000148, "Member 'Rewards_Header_C_PopulateFromRewardType::CallFunc_Format_ReturnValue12' has a wrong offset!");
