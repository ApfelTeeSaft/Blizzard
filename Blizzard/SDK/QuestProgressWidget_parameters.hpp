...
static_assert(offsetof(QuestProgressWidget_C_Update, CallFunc_Conv_IntToText_ReturnValue1) == 0x000078, "Member 'QuestProgressWidget_C_Update::CallFunc_Conv_IntToText_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(QuestProgressWidget_C_Update, K2Node_MakeStruct_FormatArgumentData1) == 0x000098, "Member 'QuestProgressWidget_C_Update::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
static_assert(offsetof(QuestProgressWidget_C_Update, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x0000D8, "Member 'QuestProgressWidget_C_Update::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(QuestProgressWidget_C_Update, Temp_byte_Variable1) == 0x000148, "Member 'QuestProgressWidget_C_Update::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(QuestProgressWidget_C_Update, Temp_bool_Variable1) == 0x000149, "Member 'QuestProgressWidget_C_Update::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(QuestProgressWidget_C_Update, K2Node_Select1_Default) == 0x00014A, "Member 'QuestProgressWidget_C_Update::K2Node_Select1_Default' has a wrong offset!");
