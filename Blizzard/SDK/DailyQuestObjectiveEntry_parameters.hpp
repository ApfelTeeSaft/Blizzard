...
static_assert(offsetof(DailyQuestObjectiveEntry_C_Update, Temp_byte_Variable1) == 0x000079, "Member 'DailyQuestObjectiveEntry_C_Update::Temp_byte_Variable1' has a wrong offset!");
