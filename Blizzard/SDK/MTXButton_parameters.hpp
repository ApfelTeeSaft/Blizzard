...
static_assert(offsetof(MTXButton_C_ExecuteUbergraph_MTXButton, CallFunc_GetContext_ReturnValue1) == 0x000058, "Member 'MTXButton_C_ExecuteUbergraph_MTXButton::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MTXButton_C_ExecuteUbergraph_MTXButton, CallFunc_GetContext_ReturnValue12) == 0x000070, "Member 'MTXButton_C_ExecuteUbergraph_MTXButton::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(MTXButton_C_ExecuteUbergraph_MTXButton, K2Node_CreateDelegate_OutputDelegate1) == 0x0000B8, "Member 'MTXButton_C_ExecuteUbergraph_MTXButton::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(MTXButton_C_Get_Button_ToolTipWidget_0, CallFunc_GetContext_ReturnValue1) == 0x000010, "Member 'MTXButton_C_Get_Button_ToolTipWidget_0::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MTXButton_C_Get_Button_ToolTipWidget_0, CallFunc_MakeLiteralText_ReturnValue12) == 0x000058, "Member 'MTXButton_C_Get_Button_ToolTipWidget_0::CallFunc_MakeLiteralText_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(MTXButton_C_UpdateState, Temp_int_Variable1) == 0x000004, "Member 'MTXButton_C_UpdateState::Temp_int_Variable1' has a wrong offset!");
...
static_assert(offsetof(MTXButton_C_UpdateState, Temp_byte_Variable1) == 0x00000A, "Member 'MTXButton_C_UpdateState::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(MTXButton_C_UpdateState, CallFunc_GetContext_ReturnValue1) == 0x000018, "Member 'MTXButton_C_UpdateState::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MTXButton_C_UpdateState, Temp_bool_Variable1) == 0x000023, "Member 'MTXButton_C_UpdateState::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(MTXButton_C_UpdateState, K2Node_Select1_Default) == 0x000024, "Member 'MTXButton_C_UpdateState::K2Node_Select1_Default' has a wrong offset!");
