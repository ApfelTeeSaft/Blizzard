...
static_assert(offsetof(StoreMain_MTXOffer_C_ExecuteUbergraph_StoreMain_MTXOffer, CallFunc_GetStoreOfferType_ReturnValue1) == 0x000022, "Member 'StoreMain_MTXOffer_C_ExecuteUbergraph_StoreMain_MTXOffer::CallFunc_GetStoreOfferType_ReturnValue1' has a wrong offset!");
static_assert(offsetof(StoreMain_MTXOffer_C_ExecuteUbergraph_StoreMain_MTXOffer, CallFunc_EqualEqual_ByteByte_ReturnValue1) == 0x000023, "Member 'StoreMain_MTXOffer_C_ExecuteUbergraph_StoreMain_MTXOffer::CallFunc_EqualEqual_ByteByte_ReturnValue1' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            CallFunc_GetTileImage_ReturnValue;                 // 0x00B8(0x0078)()
	class FText                                   CallFunc_GetName_ReturnValue;                      // 0x0130(0x0018)()
	int32                                         CallFunc_GetBonusQuantity_ReturnValue1;            // 0x0148(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_14C[0x4];                                      // 0x014C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_Conv_IntToText_ReturnValue;               // 0x0150(0x0018)()
	int32                                         CallFunc_GetBaseQuantity_ReturnValue;              // 0x0168(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   CallFunc_GetNormalPrice_ReturnValue1;              // 0x01A0(0x0018)()
...
static_assert(sizeof(StoreMain_MTXOffer_C_InitOffer) == 0x0001F0, "Wrong size on StoreMain_MTXOffer_C_InitOffer");
...
static_assert(offsetof(StoreMain_MTXOffer_C_InitOffer, Temp_byte_Variable1) == 0x000071, "Member 'StoreMain_MTXOffer_C_InitOffer::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(StoreMain_MTXOffer_C_InitOffer, Temp_bool_Variable1) == 0x00007D, "Member 'StoreMain_MTXOffer_C_InitOffer::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(StoreMain_MTXOffer_C_InitOffer, CallFunc_GetName_ReturnValue) == 0x000130, "Member 'StoreMain_MTXOffer_C_InitOffer::CallFunc_GetName_ReturnValue' has a wrong offset!");
static_assert(offsetof(StoreMain_MTXOffer_C_InitOffer, CallFunc_GetBonusQuantity_ReturnValue1) == 0x000148, "Member 'StoreMain_MTXOffer_C_InitOffer::CallFunc_GetBonusQuantity_ReturnValue1' has a wrong offset!");
static_assert(offsetof(StoreMain_MTXOffer_C_InitOffer, CallFunc_Conv_IntToText_ReturnValue) == 0x000150, "Member 'StoreMain_MTXOffer_C_InitOffer::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(StoreMain_MTXOffer_C_InitOffer, CallFunc_GetBaseQuantity_ReturnValue) == 0x000168, "Member 'StoreMain_MTXOffer_C_InitOffer::CallFunc_GetBaseQuantity_ReturnValue' has a wrong offset!");
static_assert(offsetof(StoreMain_MTXOffer_C_InitOffer, CallFunc_GetNormalPrice_ReturnValue) == 0x000170, "Member 'StoreMain_MTXOffer_C_InitOffer::CallFunc_GetNormalPrice_ReturnValue' has a wrong offset!");
static_assert(offsetof(StoreMain_MTXOffer_C_InitOffer, CallFunc_Conv_IntToText_ReturnValue1) == 0x000188, "Member 'StoreMain_MTXOffer_C_InitOffer::CallFunc_Conv_IntToText_ReturnValue1' has a wrong offset!");
static_assert(offsetof(StoreMain_MTXOffer_C_InitOffer, CallFunc_GetNormalPrice_ReturnValue1) == 0x0001A0, "Member 'StoreMain_MTXOffer_C_InitOffer::CallFunc_GetNormalPrice_ReturnValue1' has a wrong offset!");
static_assert(offsetof(StoreMain_MTXOffer_C_InitOffer, CallFunc_GetSalePrice_SalePrice) == 0x0001B8, "Member 'StoreMain_MTXOffer_C_InitOffer::CallFunc_GetSalePrice_SalePrice' has a wrong offset!");
static_assert(offsetof(StoreMain_MTXOffer_C_InitOffer, CallFunc_GetSalePrice_ReturnValue) == 0x0001D0, "Member 'StoreMain_MTXOffer_C_InitOffer::CallFunc_GetSalePrice_ReturnValue' has a wrong offset!");
static_assert(offsetof(StoreMain_MTXOffer_C_InitOffer, K2Node_Select1_Default) == 0x0001D8, "Member 'StoreMain_MTXOffer_C_InitOffer::K2Node_Select1_Default' has a wrong offset!");
...
public:
	...
	class UStoreMain_OfferDetails_C*              CallFunc_Create_ReturnValue;                       // 0x0010(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
