...
public:
	...
	struct FVector2D                              Temp_struct_Variable12;                            // 0x0018(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              Temp_struct_Variable123;                           // 0x0020(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              Temp_struct_Variable1234;                          // 0x0028(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              Temp_struct_Variable12345;                         // 0x0030(0x0008)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	ESlateVisibility                              K2Node_Select1_Default;                            // 0x00C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget, Temp_struct_Variable12) == 0x000018, "Member 'BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget::Temp_struct_Variable12' has a wrong offset!");
static_assert(offsetof(BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget, Temp_struct_Variable123) == 0x000020, "Member 'BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget::Temp_struct_Variable123' has a wrong offset!");
static_assert(offsetof(BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget, Temp_struct_Variable1234) == 0x000028, "Member 'BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget::Temp_struct_Variable1234' has a wrong offset!");
static_assert(offsetof(BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget, Temp_struct_Variable12345) == 0x000030, "Member 'BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget::Temp_struct_Variable12345' has a wrong offset!");
...
static_assert(offsetof(BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget, Temp_byte_Variable12) == 0x00003A, "Member 'BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget::Temp_byte_Variable12' has a wrong offset!");
...
static_assert(offsetof(BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget, K2Node_Select1_Default) == 0x0000C0, "Member 'BasicRatingWidget_C_ExecuteUbergraph_BasicRatingWidget::K2Node_Select1_Default' has a wrong offset!");
