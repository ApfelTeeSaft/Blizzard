...
static_assert(sizeof(UGA_Athena_ShieldSmall_C) == 0x000B48, "Wrong size on UGA_Athena_ShieldSmall_C");
static_assert(offsetof(UGA_Athena_ShieldSmall_C, UberGraphFrame) == 0x000AB0, "Member 'UGA_Athena_ShieldSmall_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Athena_ShieldSmall_C, AnimMontageInfo) == 0x000AB8, "Member 'UGA_Athena_ShieldSmall_C::AnimMontageInfo' has a wrong offset!");
static_assert(offsetof(UGA_Athena_ShieldSmall_C, SpawnHeading) == 0x000B18, "Member 'UGA_Athena_ShieldSmall_C::SpawnHeading' has a wrong offset!");
static_assert(offsetof(UGA_Athena_ShieldSmall_C, PlayerPawn) == 0x000B28, "Member 'UGA_Athena_ShieldSmall_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGA_Athena_ShieldSmall_C, Projectile) == 0x000B30, "Member 'UGA_Athena_ShieldSmall_C::Projectile' has a wrong offset!");
static_assert(offsetof(UGA_Athena_ShieldSmall_C, ShieldingAmount) == 0x000B38, "Member 'UGA_Athena_ShieldSmall_C::ShieldingAmount' has a wrong offset!");
static_assert(offsetof(UGA_Athena_ShieldSmall_C, TriggerDuration) == 0x000B3C, "Member 'UGA_Athena_ShieldSmall_C::TriggerDuration' has a wrong offset!");
static_assert(offsetof(UGA_Athena_ShieldSmall_C, SmallShieldCap) == 0x000B40, "Member 'UGA_Athena_ShieldSmall_C::SmallShieldCap' has a wrong offset!");
