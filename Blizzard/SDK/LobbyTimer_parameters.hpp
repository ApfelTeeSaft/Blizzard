...
public:
	...
	TDelegate<void(int32 CurrentTime)>            K2Node_CreateDelegate_OutputDelegate12;            // 0x0030(0x0010)(ZeroConstructor, NoDestructor)
	class UFortMatchmakingContext*                CallFunc_GetContext_ReturnValue12;                 // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(LobbyTimer_C_Bind_Delegates, K2Node_CreateDelegate_OutputDelegate12) == 0x000030, "Member 'LobbyTimer_C_Bind_Delegates::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
static_assert(offsetof(LobbyTimer_C_Bind_Delegates, CallFunc_GetContext_ReturnValue12) == 0x000040, "Member 'LobbyTimer_C_Bind_Delegates::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
