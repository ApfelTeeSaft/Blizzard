...
public:
	...
	ESquadSlotSortType                            K2Node_CustomEvent_CurrentSortType;                // 0x0130(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESquadSlotType                                K2Node_CustomEvent_NewParam;                       // 0x0131(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_132[0x6];                                      // 0x0132(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(ESquadSlotSortType CurrentSortType, ESquadSlotType SquadSlotType)> K2Node_CreateDelegate_OutputDelegate; // 0x0138(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(sizeof(SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker) == 0x000178, "Wrong size on SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker");
...
static_assert(offsetof(SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker, K2Node_CustomEvent_CurrentSortType) == 0x000130, "Member 'SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker::K2Node_CustomEvent_CurrentSortType' has a wrong offset!");
static_assert(offsetof(SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker, K2Node_CustomEvent_NewParam) == 0x000131, "Member 'SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker::K2Node_CustomEvent_NewParam' has a wrong offset!");
static_assert(offsetof(SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker, K2Node_CreateDelegate_OutputDelegate) == 0x000138, "Member 'SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker, K2Node_Select_Default) == 0x000148, "Member 'SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker, K2Node_Select1_Default) == 0x000160, "Member 'SquadSlotItemPicker_C_ExecuteUbergraph_SquadSlotItemPicker::K2Node_Select1_Default' has a wrong offset!");
