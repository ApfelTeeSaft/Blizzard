...
public:
	...
	class UFrontEndRewards_Widget_C*              Claimed_Reward_Widget;                             // 0x03E0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ACheckExpeditionRewardsAction_C) == 0x0003E8, "Wrong size on ACheckExpeditionRewardsAction_C");
static_assert(offsetof(ACheckExpeditionRewardsAction_C, UberGraphFrame) == 0x000378, "Member 'ACheckExpeditionRewardsAction_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ACheckExpeditionRewardsAction_C, DefaultSceneRoot) == 0x000380, "Member 'ACheckExpeditionRewardsAction_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(ACheckExpeditionRewardsAction_C, RewardsDefinition) == 0x000388, "Member 'ACheckExpeditionRewardsAction_C::RewardsDefinition' has a wrong offset!");
static_assert(offsetof(ACheckExpeditionRewardsAction_C, ShowRewardsWidget) == 0x0003D8, "Member 'ACheckExpeditionRewardsAction_C::ShowRewardsWidget' has a wrong offset!");
static_assert(offsetof(ACheckExpeditionRewardsAction_C, Claimed_Reward_Widget) == 0x0003E0, "Member 'ACheckExpeditionRewardsAction_C::Claimed_Reward_Widget' has a wrong offset!");
