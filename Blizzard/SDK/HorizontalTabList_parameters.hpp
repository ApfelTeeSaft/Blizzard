...
static_assert(offsetof(HorizontalTabList_C_UpdateGamepadKeyVisibility, K2Node_Select1_Default) == 0x00001C, "Member 'HorizontalTabList_C_UpdateGamepadKeyVisibility::K2Node_Select1_Default' has a wrong offset!");
