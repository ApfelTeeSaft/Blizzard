...
public:
	...
	class UMaterialInstanceDynamic*               CallFunc_GetAnimatingMID_ReturnValue12;            // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(PBWA_W1_QuarterWallS_C_ExecuteUbergraph_PBWA_W1_QuarterWallS, CallFunc_GetAnimatingMID_ReturnValue1) == 0x000010, "Member 'PBWA_W1_QuarterWallS_C_ExecuteUbergraph_PBWA_W1_QuarterWallS::CallFunc_GetAnimatingMID_ReturnValue1' has a wrong offset!");
static_assert(offsetof(PBWA_W1_QuarterWallS_C_ExecuteUbergraph_PBWA_W1_QuarterWallS, CallFunc_GetAnimatingMID_ReturnValue12) == 0x000018, "Member 'PBWA_W1_QuarterWallS_C_ExecuteUbergraph_PBWA_W1_QuarterWallS::CallFunc_GetAnimatingMID_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(PBWA_W1_QuarterWallS_C_ExecuteUbergraph_PBWA_W1_QuarterWallS, K2Node_GameplayCueEvent_EventType1) == 0x0000E2, "Member 'PBWA_W1_QuarterWallS_C_ExecuteUbergraph_PBWA_W1_QuarterWallS::K2Node_GameplayCueEvent_EventType1' has a wrong offset!");
static_assert(offsetof(PBWA_W1_QuarterWallS_C_ExecuteUbergraph_PBWA_W1_QuarterWallS, K2Node_GameplayCueEvent_Parameters1) == 0x0000E8, "Member 'PBWA_W1_QuarterWallS_C_ExecuteUbergraph_PBWA_W1_QuarterWallS::K2Node_GameplayCueEvent_Parameters1' has a wrong offset!");
static_assert(offsetof(PBWA_W1_QuarterWallS_C_ExecuteUbergraph_PBWA_W1_QuarterWallS, K2Node_SwitchEnum1_CmpSuccess) == 0x0001A0, "Member 'PBWA_W1_QuarterWallS_C_ExecuteUbergraph_PBWA_W1_QuarterWallS::K2Node_SwitchEnum1_CmpSuccess' has a wrong offset!");
static_assert(offsetof(PBWA_W1_QuarterWallS_C_ExecuteUbergraph_PBWA_W1_QuarterWallS, CallFunc_IsDedicatedServer_ReturnValue1) == 0x0001A1, "Member 'PBWA_W1_QuarterWallS_C_ExecuteUbergraph_PBWA_W1_QuarterWallS::CallFunc_IsDedicatedServer_ReturnValue1' has a wrong offset!");
