...
public:
	...
	TDelegate<void(const TArray<class FText>& Names)> K2Node_CreateDelegate_OutputDelegate123;       // 0x0078(0x0010)(ZeroConstructor, NoDestructor)
...
{
public:
	struct FSlateBrush                            InBrush;                                           // 0x0000(0x0078)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
...
static_assert(sizeof(BP_FortLiveStreamGrantWindowExpires_C_Set_Stream_Brush) == 0x000078, "Wrong size on BP_FortLiveStreamGrantWindowExpires_C_Set_Stream_Brush");
...
static_assert(offsetof(BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0, CallFunc_MakeLiteralText_ReturnValue1) == 0x000038, "Member 'BP_FortLiveStreamGrantWindowExpires_C_GetToolTipWidget_0::CallFunc_MakeLiteralText_ReturnValue1' has a wrong offset!");
