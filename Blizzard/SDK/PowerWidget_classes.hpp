...
static_assert(sizeof(UPowerWidget_C) == 0x000300, "Wrong size on UPowerWidget_C");
static_assert(offsetof(UPowerWidget_C, UberGraphFrame) == 0x000250, "Member 'UPowerWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UPowerWidget_C, BarBG) == 0x000258, "Member 'UPowerWidget_C::BarBG' has a wrong offset!");
static_assert(offsetof(UPowerWidget_C, BaseRatingValue) == 0x000260, "Member 'UPowerWidget_C::BaseRatingValue' has a wrong offset!");
static_assert(offsetof(UPowerWidget_C, BuffedRatingOuterGlow) == 0x000268, "Member 'UPowerWidget_C::BuffedRatingOuterGlow' has a wrong offset!");
static_assert(offsetof(UPowerWidget_C, BuffedRatingValue) == 0x000270, "Member 'UPowerWidget_C::BuffedRatingValue' has a wrong offset!");
static_assert(offsetof(UPowerWidget_C, HomebaseRatingBar) == 0x000278, "Member 'UPowerWidget_C::HomebaseRatingBar' has a wrong offset!");
static_assert(offsetof(UPowerWidget_C, Image_Power) == 0x000280, "Member 'UPowerWidget_C::Image_Power' has a wrong offset!");
static_assert(offsetof(UPowerWidget_C, Overlay_1) == 0x000288, "Member 'UPowerWidget_C::Overlay_1' has a wrong offset!");
static_assert(offsetof(UPowerWidget_C, PowerIconGlow) == 0x000290, "Member 'UPowerWidget_C::PowerIconGlow' has a wrong offset!");
static_assert(offsetof(UPowerWidget_C, RatingBar) == 0x000298, "Member 'UPowerWidget_C::RatingBar' has a wrong offset!");
...
static_assert(offsetof(UPowerWidget_C, ShowDualPower) == 0x0002F8, "Member 'UPowerWidget_C::ShowDualPower' has a wrong offset!");
static_assert(offsetof(UPowerWidget_C, UseLargeStyle) == 0x0002F9, "Member 'UPowerWidget_C::UseLargeStyle' has a wrong offset!");
static_assert(offsetof(UPowerWidget_C, ShowGlow) == 0x0002FA, "Member 'UPowerWidget_C::ShowGlow' has a wrong offset!");
