...
static_assert(offsetof(UMicIndicator_C, Zero1_NotSpeaking) == 0x000250, "Member 'UMicIndicator_C::Zero1_NotSpeaking' has a wrong offset!");
static_assert(offsetof(UMicIndicator_C, Zero2_Speaking) == 0x000258, "Member 'UMicIndicator_C::Zero2_Speaking' has a wrong offset!");
static_assert(offsetof(UMicIndicator_C, Zero3_Muted) == 0x000260, "Member 'UMicIndicator_C::Zero3_Muted' has a wrong offset!");
