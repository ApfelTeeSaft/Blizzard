...
public:
	...
	int32                                         CallFunc_Add_IntInt_ReturnValue123;                // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Conv_IntToFloat_ReturnValue;              // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Add_IntInt_ReturnValue1234;               // 0x002C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Conv_IntToFloat_ReturnValue12;            // 0x0040(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Conv_IntToFloat_ReturnValue123;           // 0x004C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP) == 0x000004, "Wrong alignment on TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP");
static_assert(sizeof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP) == 0x000050, "Wrong size on TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP");
...
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Add_IntInt_ReturnValue) == 0x000018, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Add_IntInt_ReturnValue1) == 0x00001C, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Add_IntInt_ReturnValue12) == 0x000020, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Add_IntInt_ReturnValue12' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Add_IntInt_ReturnValue123) == 0x000024, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Add_IntInt_ReturnValue123' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000028, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Add_IntInt_ReturnValue1234) == 0x00002C, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Add_IntInt_ReturnValue1234' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_GetLevelProgress_ReturnValue) == 0x000030, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_GetLevelProgress_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x000034, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Lerp_ReturnValue) == 0x000038, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Lerp_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_FTrunc_ReturnValue) == 0x00003C, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_FTrunc_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Conv_IntToFloat_ReturnValue12) == 0x000040, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Conv_IntToFloat_ReturnValue12' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Lerp_ReturnValue1) == 0x000044, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Lerp_ReturnValue1' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_FTrunc_ReturnValue1) == 0x000048, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_FTrunc_ReturnValue1' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Conv_IntToFloat_ReturnValue123) == 0x00004C, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Conv_IntToFloat_ReturnValue123' has a wrong offset!");
