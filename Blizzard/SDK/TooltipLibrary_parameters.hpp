...
public:
	...
	class UTooltip_Basic_S_C*                     CallFunc_Create_ReturnValue;                       // 0x0050(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(TooltipLibrary_C_Create_Item_Tooltip, K2Node_MakeStruct_FormatArgumentData1) == 0x0000B0, "Member 'TooltipLibrary_C_Create_Item_Tooltip::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
...
static_assert(offsetof(TooltipLibrary_C_Create_Compare_Item_Tooltip, K2Node_MakeStruct_FormatArgumentData1) == 0x0000B0, "Member 'TooltipLibrary_C_Create_Compare_Item_Tooltip::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
