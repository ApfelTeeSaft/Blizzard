...
static_assert(sizeof(ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization) == 0x000068, "Wrong size on ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization");
...
static_assert(offsetof(ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization, Temp_object_Variable1) == 0x000010, "Member 'ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization::Temp_object_Variable1' has a wrong offset!");
static_assert(offsetof(ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization, Temp_object_Variable12) == 0x000018, "Member 'ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization::Temp_object_Variable12' has a wrong offset!");
static_assert(offsetof(ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization, Temp_object_Variable123) == 0x000020, "Member 'ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization::Temp_object_Variable123' has a wrong offset!");
...
static_assert(offsetof(ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization, CallFunc_RandomInteger_ReturnValue1) == 0x00002C, "Member 'ItemCraftingIngredientListEntryHaveNeedVerbose_C_DoDesignTimeRandomization::CallFunc_RandomInteger_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(ItemCraftingIngredientListEntryHaveNeedVerbose_C_Refresh, Temp_byte_Variable1) == 0x000020, "Member 'ItemCraftingIngredientListEntryHaveNeedVerbose_C_Refresh::Temp_byte_Variable1' has a wrong offset!");
