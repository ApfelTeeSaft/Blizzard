...
{
public:
	struct FButtonStyle                           Style;                                             // 0x0030(0x0238)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USocialActionButtonStyleDataAsset) == 0x000268, "Wrong size on USocialActionButtonStyleDataAsset");
...
{
public:
	struct FChatChromeStyle                       Style;                                             // 0x0030(0x06F8)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USocialChatChromeStyleDataAsset) == 0x000728, "Wrong size on USocialChatChromeStyleDataAsset");
...
{
public:
	struct FChatMarkupStyle                       Style;                                             // 0x0030(0x0590)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USocialChatMarkupStyleDataAsset) == 0x0005C0, "Wrong size on USocialChatMarkupStyleDataAsset");
...
{
public:
	struct FChatStyle                             Style;                                             // 0x0030(0x1170)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USocialChatStyleDataAsset) == 0x0011A0, "Wrong size on USocialChatStyleDataAsset");
...
{
public:
	struct FCheckBoxStyle                         Style;                                             // 0x0030(0x04F0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USocialCheckBoxStyleDataAsset) == 0x000520, "Wrong size on USocialCheckBoxStyleDataAsset");
...
{
public:
	struct FSocialListStyle                       Style;                                             // 0x0030(0x2268)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USocialListStyleDataAsset) == 0x002298, "Wrong size on USocialListStyleDataAsset");
...
static_assert(sizeof(USocialRadioBoxStyleDataAsset) == 0x000520, "Wrong size on USocialRadioBoxStyleDataAsset");
...
{
public:
	struct FScrollBarStyle                        Style;                                             // 0x0030(0x0440)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USocialScrollBarStyleDataAsset) == 0x000470, "Wrong size on USocialScrollBarStyleDataAsset");
...
public:
	...
	uint8                                         Pad_C0[0x5DD8];                                    // 0x00C0(0x5DD8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USocialStyleDataAsset) == 0x005E98, "Wrong size on USocialStyleDataAsset");
