...
static_assert(sizeof(Results_Summary_C_InitializeLootChest) == 0x000090, "Wrong size on Results_Summary_C_InitializeLootChest");
...
static_assert(offsetof(Results_Summary_C_InitializeLootChest, CallFunc_Add_IntInt_ReturnValue) == 0x000010, "Member 'Results_Summary_C_InitializeLootChest::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeLootChest, CallFunc_Array_Get_Item) == 0x000018, "Member 'Results_Summary_C_InitializeLootChest::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeLootChest, K2Node_MakeStruct_FormatArgumentData) == 0x000020, "Member 'Results_Summary_C_InitializeLootChest::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeLootChest, K2Node_MakeArray_Array) == 0x000060, "Member 'Results_Summary_C_InitializeLootChest::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeLootChest, CallFunc_Format_ReturnValue) == 0x000070, "Member 'Results_Summary_C_InitializeLootChest::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeLootChest, CallFunc_Array_IsValidIndex_ReturnValue) == 0x000088, "Member 'Results_Summary_C_InitializeLootChest::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");
...
public:
	...
	int32                                         CallFunc_GetTeamScore_ReturnValue12;               // 0x0044(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetTeamScore_ReturnValue123;              // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_Add_IntInt_ReturnValue12;                 // 0x0058(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Add_IntInt_ReturnValue123;                // 0x005C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Results_Summary_C_Initialize, CallFunc_GetTeamScore_ReturnValue1) == 0x000040, "Member 'Results_Summary_C_Initialize::CallFunc_GetTeamScore_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_Initialize, CallFunc_GetTeamScore_ReturnValue12) == 0x000044, "Member 'Results_Summary_C_Initialize::CallFunc_GetTeamScore_ReturnValue12' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_Initialize, CallFunc_GetTeamScore_ReturnValue123) == 0x000048, "Member 'Results_Summary_C_Initialize::CallFunc_GetTeamScore_ReturnValue123' has a wrong offset!");
...
static_assert(offsetof(Results_Summary_C_Initialize, CallFunc_Add_IntInt_ReturnValue1) == 0x000054, "Member 'Results_Summary_C_Initialize::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_Initialize, CallFunc_Add_IntInt_ReturnValue12) == 0x000058, "Member 'Results_Summary_C_Initialize::CallFunc_Add_IntInt_ReturnValue12' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_Initialize, CallFunc_Add_IntInt_ReturnValue123) == 0x00005C, "Member 'Results_Summary_C_Initialize::CallFunc_Add_IntInt_ReturnValue123' has a wrong offset!");
...
static_assert(offsetof(Results_Summary_C_Initialize, CallFunc_Create_ReturnValue) == 0x000068, "Member 'Results_Summary_C_Initialize::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_Initialize, CallFunc_GetTotalScoreSortedScoreIndices_OutSortedScoreIndices) == 0x000070, "Member 'Results_Summary_C_Initialize::CallFunc_GetTotalScoreSortedScoreIndices_OutSortedScoreIndices' has a wrong offset!");
...
static_assert(offsetof(Results_Summary_C_Initialize, CallFunc_AddChildToVerticalBox_ReturnValue) == 0x000088, "Member 'Results_Summary_C_Initialize::CallFunc_AddChildToVerticalBox_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_Initialize, CallFunc_Array_Length_ReturnValue) == 0x000090, "Member 'Results_Summary_C_Initialize::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_Initialize, CallFunc_Less_IntInt_ReturnValue) == 0x000094, "Member 'Results_Summary_C_Initialize::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
public:
	...
	int32                                         CallFunc_Add_IntInt_ReturnValue12;                 // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_LessEqual_IntInt_ReturnValue1;            // 0x0030(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_31[0x3];                                       // 0x0031(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_Add_IntInt_ReturnValue123;                // 0x0034(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UResults_PlayerScoreRow_C*              CallFunc_Create_ReturnValue;                       // 0x0038(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UResults_SummaryBadge_C*                CallFunc_Create_ReturnValue1;                      // 0x0040(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Results_Summary_C_DoDesignTimeRandomization, CallFunc_Add_IntInt_ReturnValue1) == 0x000020, "Member 'Results_Summary_C_DoDesignTimeRandomization::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_DoDesignTimeRandomization, CallFunc_Add_IntInt_ReturnValue12) == 0x000024, "Member 'Results_Summary_C_DoDesignTimeRandomization::CallFunc_Add_IntInt_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(Results_Summary_C_DoDesignTimeRandomization, Temp_int_Variable1) == 0x00002C, "Member 'Results_Summary_C_DoDesignTimeRandomization::Temp_int_Variable1' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_DoDesignTimeRandomization, CallFunc_LessEqual_IntInt_ReturnValue1) == 0x000030, "Member 'Results_Summary_C_DoDesignTimeRandomization::CallFunc_LessEqual_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_DoDesignTimeRandomization, CallFunc_Add_IntInt_ReturnValue123) == 0x000034, "Member 'Results_Summary_C_DoDesignTimeRandomization::CallFunc_Add_IntInt_ReturnValue123' has a wrong offset!");
...
static_assert(offsetof(Results_Summary_C_DoDesignTimeRandomization, CallFunc_Create_ReturnValue1) == 0x000040, "Member 'Results_Summary_C_DoDesignTimeRandomization::CallFunc_Create_ReturnValue1' has a wrong offset!");
...
public:
	...
	int32                                         CallFunc_Add_IntInt_ReturnValue12;                 // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UResults_SummaryBadge_C*                CallFunc_Create_ReturnValue;                       // 0x0058(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Results_Summary_C_InitializeRewards) == 0x000068, "Wrong size on Results_Summary_C_InitializeRewards");
...
static_assert(offsetof(Results_Summary_C_InitializeRewards, Temp_int_Loop_Counter_Variable) == 0x000020, "Member 'Results_Summary_C_InitializeRewards::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeRewards, Temp_int_Array_Index_Variable) == 0x000024, "Member 'Results_Summary_C_InitializeRewards::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeRewards, CallFunc_Add_IntInt_ReturnValue) == 0x000028, "Member 'Results_Summary_C_InitializeRewards::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeRewards, CallFunc_Add_IntInt_ReturnValue1) == 0x00002C, "Member 'Results_Summary_C_InitializeRewards::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeRewards, CallFunc_Add_IntInt_ReturnValue12) == 0x000030, "Member 'Results_Summary_C_InitializeRewards::CallFunc_Add_IntInt_ReturnValue12' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeRewards, CallFunc_Array_Get_Item) == 0x000038, "Member 'Results_Summary_C_InitializeRewards::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeRewards, CallFunc_Array_Length_ReturnValue) == 0x000040, "Member 'Results_Summary_C_InitializeRewards::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeRewards, CallFunc_Array_Length_ReturnValue1) == 0x000044, "Member 'Results_Summary_C_InitializeRewards::CallFunc_Array_Length_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeRewards, CallFunc_Greater_IntInt_ReturnValue) == 0x000048, "Member 'Results_Summary_C_InitializeRewards::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeRewards, CallFunc_Less_IntInt_ReturnValue) == 0x000049, "Member 'Results_Summary_C_InitializeRewards::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeRewards, CallFunc_Divide_IntInt_ReturnValue) == 0x00004C, "Member 'Results_Summary_C_InitializeRewards::CallFunc_Divide_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeRewards, CallFunc_Greater_IntInt_ReturnValue1) == 0x000050, "Member 'Results_Summary_C_InitializeRewards::CallFunc_Greater_IntInt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeRewards, CallFunc_Create_ReturnValue) == 0x000058, "Member 'Results_Summary_C_InitializeRewards::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_Summary_C_InitializeRewards, CallFunc_AddChildToUniformGrid_ReturnValue) == 0x000060, "Member 'Results_Summary_C_InitializeRewards::CallFunc_AddChildToUniformGrid_ReturnValue' has a wrong offset!");
