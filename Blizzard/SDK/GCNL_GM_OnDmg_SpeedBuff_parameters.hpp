...
static_assert(offsetof(GCNL_GM_OnDmg_SpeedBuff_C_OnWhileActiveParticleSystemActivate, CallFunc_Multiply_FloatFloat_ReturnValue12) == 0x00010C, "Member 'GCNL_GM_OnDmg_SpeedBuff_C_OnWhileActiveParticleSystemActivate::CallFunc_Multiply_FloatFloat_ReturnValue12' has a wrong offset!");
