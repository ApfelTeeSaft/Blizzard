...
static_assert(offsetof(UAthenaRotator_C, UberGraphFrame) == 0x0007F0, "Member 'UAthenaRotator_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaRotator_C, ButtonLeft) == 0x0007F8, "Member 'UAthenaRotator_C::ButtonLeft' has a wrong offset!");
static_assert(offsetof(UAthenaRotator_C, ButtonRight) == 0x000800, "Member 'UAthenaRotator_C::ButtonRight' has a wrong offset!");
...
static_assert(offsetof(UAthenaRotator_C, OneDirectionalModeActive) == 0x000839, "Member 'UAthenaRotator_C::OneDirectionalModeActive' has a wrong offset!");
