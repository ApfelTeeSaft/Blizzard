...
static_assert(sizeof(UResults_Widget_C) == 0x0005C0, "Wrong size on UResults_Widget_C");
...
static_assert(offsetof(UResults_Widget_C, ACResultsStart) == 0x000550, "Member 'UResults_Widget_C::ACResultsStart' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, ResultsFinished) == 0x000558, "Member 'UResults_Widget_C::ResultsFinished' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, ACResultsFinished) == 0x000560, "Member 'UResults_Widget_C::ACResultsFinished' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, VictoryIntro) == 0x000568, "Member 'UResults_Widget_C::VictoryIntro' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, DefeatIntro) == 0x000570, "Member 'UResults_Widget_C::DefeatIntro' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, DefeatVideo) == 0x000578, "Member 'UResults_Widget_C::DefeatVideo' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, ZoneCompletionResult) == 0x000580, "Member 'UResults_Widget_C::ZoneCompletionResult' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, DelayBetweenVideoAndIntro) == 0x000584, "Member 'UResults_Widget_C::DelayBetweenVideoAndIntro' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, bCanSkipVideo) == 0x000588, "Member 'UResults_Widget_C::bCanSkipVideo' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, VictoryStart) == 0x000590, "Member 'UResults_Widget_C::VictoryStart' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, TeamScoreWhoosh) == 0x000598, "Member 'UResults_Widget_C::TeamScoreWhoosh' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, CommanderXPWhoosh) == 0x0005A0, "Member 'UResults_Widget_C::CommanderXPWhoosh' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, InputSkip) == 0x0005A8, "Member 'UResults_Widget_C::InputSkip' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, bVideoSkipped) == 0x0005B8, "Member 'UResults_Widget_C::bVideoSkipped' has a wrong offset!");
static_assert(offsetof(UResults_Widget_C, TPAnalyticsTimeStart) == 0x0005BC, "Member 'UResults_Widget_C::TPAnalyticsTimeStart' has a wrong offset!");
