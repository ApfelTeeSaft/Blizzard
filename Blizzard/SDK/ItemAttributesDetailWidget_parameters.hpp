...
public:
	...
	bool                                          CallFunc_IsValid_ReturnValue12;                    // 0x0035(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue123;                   // 0x0036(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_37[0x1];                                       // 0x0037(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(bool bItemChanged, bool bAmmoChanged, bool bIngredientsChanged)> K2Node_CreateDelegate_OutputDelegate12; // 0x0038(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(bool bItemChanged, bool bAmmoChanged, bool bIngredientsChanged)> K2Node_CreateDelegate_OutputDelegate123; // 0x0048(0x0010)(ZeroConstructor, NoDestructor)
};
...
static_assert(offsetof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget, K2Node_CustomEvent_bItemChanged1) == 0x000018, "Member 'ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget::K2Node_CustomEvent_bItemChanged1' has a wrong offset!");
static_assert(offsetof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget, K2Node_CustomEvent_bAmmoChanged1) == 0x000019, "Member 'ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget::K2Node_CustomEvent_bAmmoChanged1' has a wrong offset!");
static_assert(offsetof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget, K2Node_CustomEvent_bIngredientsChanged1) == 0x00001A, "Member 'ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget::K2Node_CustomEvent_bIngredientsChanged1' has a wrong offset!");
static_assert(offsetof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget, K2Node_CreateDelegate_OutputDelegate1) == 0x000020, "Member 'ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget, CallFunc_IsValid_ReturnValue1) == 0x000034, "Member 'ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget, CallFunc_IsValid_ReturnValue12) == 0x000035, "Member 'ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget::CallFunc_IsValid_ReturnValue12' has a wrong offset!");
static_assert(offsetof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget, CallFunc_IsValid_ReturnValue123) == 0x000036, "Member 'ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget::CallFunc_IsValid_ReturnValue123' has a wrong offset!");
static_assert(offsetof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget, K2Node_CreateDelegate_OutputDelegate12) == 0x000038, "Member 'ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
static_assert(offsetof(ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget, K2Node_CreateDelegate_OutputDelegate123) == 0x000048, "Member 'ItemAttributesDetailWidget_C_ExecuteUbergraph_ItemAttributesDetailWidget::K2Node_CreateDelegate_OutputDelegate123' has a wrong offset!");
...
public:
	...
	class UFortTooltipUIContext*                  CallFunc_GetContext_ReturnValue12;                 // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ItemAttributesDetailWidget_C_UpdateItemsForWidgets, CallFunc_GetContext_ReturnValue12) == 0x000020, "Member 'ItemAttributesDetailWidget_C_UpdateItemsForWidgets::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
