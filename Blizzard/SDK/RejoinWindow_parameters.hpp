...
public:
	...
	class FText                                   LocalRetryFailure;                                 // 0x0020(0x0018)(Edit, BlueprintVisible)
	float                                         LocalTimeoutSeconds;                               // 0x0038(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FDataTableRowHandle                    K2Node_MakeStruct_DataTableRowHandle1;             // 0x0058(0x0010)(NoDestructor)
...
static_assert(offsetof(RejoinWindow_C_ShowRetryScreen, K2Node_MakeStruct_DataTableRowHandle1) == 0x000058, "Member 'RejoinWindow_C_ShowRetryScreen::K2Node_MakeStruct_DataTableRowHandle1' has a wrong offset!");
static_assert(offsetof(RejoinWindow_C_ShowRetryScreen, CallFunc_Array_Add_ReturnValue1) == 0x000068, "Member 'RejoinWindow_C_ShowRetryScreen::CallFunc_Array_Add_ReturnValue1' has a wrong offset!");
