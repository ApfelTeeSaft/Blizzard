...
static_assert(sizeof(FPlayerReservation) == 0x000040, "Wrong size on FPlayerReservation");
...
static_assert(offsetof(FPlayerReservation, ElapsedTime) == 0x000038, "Member 'FPlayerReservation::ElapsedTime' has a wrong offset!");
