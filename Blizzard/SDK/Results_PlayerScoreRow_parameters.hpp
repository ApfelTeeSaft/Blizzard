...
static_assert(sizeof(Results_PlayerScoreRow_C_Initialize) == 0x000040, "Wrong size on Results_PlayerScoreRow_C_Initialize");
...
static_assert(offsetof(Results_PlayerScoreRow_C_Initialize, CallFunc_IsLocalPlayer_ReturnValue) == 0x000038, "Member 'Results_PlayerScoreRow_C_Initialize::CallFunc_IsLocalPlayer_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Results_PlayerScoreRow_C_InitializeScores, K2Node_MakeArray_Array1) == 0x000068, "Member 'Results_PlayerScoreRow_C_InitializeScores::K2Node_MakeArray_Array1' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreRow_C_InitializeScores, CallFunc_Array_Get_Item1) == 0x000078, "Member 'Results_PlayerScoreRow_C_InitializeScores::CallFunc_Array_Get_Item1' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreRow_C_InitializeScores, CallFunc_Array_Length_ReturnValue) == 0x00007C, "Member 'Results_PlayerScoreRow_C_InitializeScores::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreRow_C_InitializeScores, CallFunc_Less_IntInt_ReturnValue) == 0x000080, "Member 'Results_PlayerScoreRow_C_InitializeScores::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreRow_C_InitializeScores, CallFunc_GetPlayerScore_ReturnValue) == 0x000084, "Member 'Results_PlayerScoreRow_C_InitializeScores::CallFunc_GetPlayerScore_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreRow_C_InitializeScores, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000088, "Member 'Results_PlayerScoreRow_C_InitializeScores::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(Results_PlayerScoreRow_C_InitializeHomeBasePower) == 0x000040, "Wrong size on Results_PlayerScoreRow_C_InitializeHomeBasePower");
...
static_assert(offsetof(Results_PlayerScoreRow_C_InitializeHomeBasePower, CallFunc_GetContext_ReturnValue) == 0x000028, "Member 'Results_PlayerScoreRow_C_InitializeHomeBasePower::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreRow_C_InitializeHomeBasePower, CallFunc_GetTotalHomebaseRating_Rating) == 0x000030, "Member 'Results_PlayerScoreRow_C_InitializeHomeBasePower::CallFunc_GetTotalHomebaseRating_Rating' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreRow_C_InitializeHomeBasePower, CallFunc_GetTotalHomebaseRating_ProgressFraction) == 0x000034, "Member 'Results_PlayerScoreRow_C_InitializeHomeBasePower::CallFunc_GetTotalHomebaseRating_ProgressFraction' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreRow_C_InitializeHomeBasePower, CallFunc_GetTotalHomebaseRating_ReturnValue) == 0x000038, "Member 'Results_PlayerScoreRow_C_InitializeHomeBasePower::CallFunc_GetTotalHomebaseRating_ReturnValue' has a wrong offset!");
static_assert(offsetof(Results_PlayerScoreRow_C_InitializeHomeBasePower, CallFunc_Conv_IntToFloat_ReturnValue) == 0x00003C, "Member 'Results_PlayerScoreRow_C_InitializeHomeBasePower::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
