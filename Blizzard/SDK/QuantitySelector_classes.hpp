...
static_assert(sizeof(UQuantitySelector_C) == 0x000C40, "Wrong size on UQuantitySelector_C");
...
static_assert(offsetof(UQuantitySelector_C, SliderStyle_Touch) == 0x000A50, "Member 'UQuantitySelector_C::SliderStyle_Touch' has a wrong offset!");
