...
static_assert(offsetof(UAthenaTeamMemberIndicator_C, UberGraphFrame) == 0x000278, "Member 'UAthenaTeamMemberIndicator_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaTeamMemberIndicator_C, DBNOIndicator) == 0x000280, "Member 'UAthenaTeamMemberIndicator_C::DBNOIndicator' has a wrong offset!");
static_assert(offsetof(UAthenaTeamMemberIndicator_C, PlayerName) == 0x000288, "Member 'UAthenaTeamMemberIndicator_C::PlayerName' has a wrong offset!");
