...
public:
	...
	class UCommonBorder*                          TouchToExitBorder;                                 // 0x0498(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	bool                                          bUseRetire;                                        // 0x04A0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          bHideCount;                                        // 0x04A1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          bHideResources;                                    // 0x04A2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          bHideTitle;                                        // 0x04A3(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_4A4[0x4];                                      // 0x04A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UQuantitySelector_C*                    MulchQuantitySelector;                             // 0x04A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UQuantitySelector_C*                    QuantitySelectorWidget;                            // 0x04B0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FDataTableRowHandle                    Input_AthenaMoveItem;                              // 0x04B8(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	struct FDataTableRowHandle                    Input_AthenaDropHalf;                              // 0x04C8(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
...
public:
	...
	struct FEventReply OnMouseButtonDownBorder(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent);
...
static_assert(sizeof(UAthenaInventoryPanel_C) == 0x0004D8, "Wrong size on UAthenaInventoryPanel_C");
...
static_assert(offsetof(UAthenaInventoryPanel_C, TouchToExitBorder) == 0x000498, "Member 'UAthenaInventoryPanel_C::TouchToExitBorder' has a wrong offset!");
static_assert(offsetof(UAthenaInventoryPanel_C, bUseRetire) == 0x0004A0, "Member 'UAthenaInventoryPanel_C::bUseRetire' has a wrong offset!");
static_assert(offsetof(UAthenaInventoryPanel_C, bHideCount) == 0x0004A1, "Member 'UAthenaInventoryPanel_C::bHideCount' has a wrong offset!");
static_assert(offsetof(UAthenaInventoryPanel_C, bHideResources) == 0x0004A2, "Member 'UAthenaInventoryPanel_C::bHideResources' has a wrong offset!");
static_assert(offsetof(UAthenaInventoryPanel_C, bHideTitle) == 0x0004A3, "Member 'UAthenaInventoryPanel_C::bHideTitle' has a wrong offset!");
static_assert(offsetof(UAthenaInventoryPanel_C, MulchQuantitySelector) == 0x0004A8, "Member 'UAthenaInventoryPanel_C::MulchQuantitySelector' has a wrong offset!");
static_assert(offsetof(UAthenaInventoryPanel_C, QuantitySelectorWidget) == 0x0004B0, "Member 'UAthenaInventoryPanel_C::QuantitySelectorWidget' has a wrong offset!");
static_assert(offsetof(UAthenaInventoryPanel_C, Input_AthenaMoveItem) == 0x0004B8, "Member 'UAthenaInventoryPanel_C::Input_AthenaMoveItem' has a wrong offset!");
static_assert(offsetof(UAthenaInventoryPanel_C, Input_AthenaDropHalf) == 0x0004C8, "Member 'UAthenaInventoryPanel_C::Input_AthenaDropHalf' has a wrong offset!");
