...
static_assert(offsetof(UAthenaGameOverWidget_C, SoloRequeue) == 0x000468, "Member 'UAthenaGameOverWidget_C::SoloRequeue' has a wrong offset!");
static_assert(offsetof(UAthenaGameOverWidget_C, TeamInfo) == 0x000470, "Member 'UAthenaGameOverWidget_C::TeamInfo' has a wrong offset!");
static_assert(offsetof(UAthenaGameOverWidget_C, WinnerOverlay) == 0x000478, "Member 'UAthenaGameOverWidget_C::WinnerOverlay' has a wrong offset!");
...
static_assert(offsetof(UAthenaGameOverWidget_C, Searching) == 0x0004F8, "Member 'UAthenaGameOverWidget_C::Searching' has a wrong offset!");
static_assert(offsetof(UAthenaGameOverWidget_C, Start_Matchmaking) == 0x000510, "Member 'UAthenaGameOverWidget_C::Start_Matchmaking' has a wrong offset!");
