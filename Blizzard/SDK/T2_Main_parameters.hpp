...
static_assert(alignof(T2_Main_C_ExecuteUbergraph_T2_Main) == 0x000008, "Wrong alignment on T2_Main_C_ExecuteUbergraph_T2_Main");
static_assert(sizeof(T2_Main_C_ExecuteUbergraph_T2_Main) == 0x000010, "Wrong size on T2_Main_C_ExecuteUbergraph_T2_Main");
static_assert(offsetof(T2_Main_C_ExecuteUbergraph_T2_Main, EntryPoint) == 0x000000, "Member 'T2_Main_C_ExecuteUbergraph_T2_Main::EntryPoint' has a wrong offset!");
static_assert(offsetof(T2_Main_C_ExecuteUbergraph_T2_Main, K2Node_Event_IsDesignTime) == 0x000004, "Member 'T2_Main_C_ExecuteUbergraph_T2_Main::K2Node_Event_IsDesignTime' has a wrong offset!");
