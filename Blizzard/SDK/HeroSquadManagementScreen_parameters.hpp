...
static_assert(offsetof(HeroSquadManagementScreen_C_GetInZoneVisibility, Temp_byte_Variable1) == 0x000003, "Member 'HeroSquadManagementScreen_C_GetInZoneVisibility::Temp_byte_Variable1' has a wrong offset!");
