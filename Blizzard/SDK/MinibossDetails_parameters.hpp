...
static_assert(offsetof(MinibossDetails_C_ExecuteUbergraph_MinibossDetails, CallFunc_GetHUDTargetHealthPercentage_ReturnValue1) == 0x000008, "Member 'MinibossDetails_C_ExecuteUbergraph_MinibossDetails::CallFunc_GetHUDTargetHealthPercentage_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MinibossDetails_C_ExecuteUbergraph_MinibossDetails, CallFunc_Conv_InterfaceToObject_ReturnValue1) == 0x000060, "Member 'MinibossDetails_C_ExecuteUbergraph_MinibossDetails::CallFunc_Conv_InterfaceToObject_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MinibossDetails_C_ExecuteUbergraph_MinibossDetails, CallFunc_IsValid_ReturnValue1) == 0x000068, "Member 'MinibossDetails_C_ExecuteUbergraph_MinibossDetails::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MinibossDetails_C_PopulateModifiers, K2Node_MakeStruct_FormatArgumentData1) == 0x0000C8, "Member 'MinibossDetails_C_PopulateModifiers::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
...
static_assert(offsetof(MinibossDetails_C_Intro, CallFunc_IsAnimationPlaying_ReturnValue1) == 0x000018, "Member 'MinibossDetails_C_Intro::CallFunc_IsAnimationPlaying_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MinibossDetails_C_Outro, CallFunc_IsAnimationPlaying_ReturnValue1) == 0x000001, "Member 'MinibossDetails_C_Outro::CallFunc_IsAnimationPlaying_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MinibossDetails_C_Kill, CallFunc_IsAnimationPlaying_ReturnValue1) == 0x000001, "Member 'MinibossDetails_C_Kill::CallFunc_IsAnimationPlaying_ReturnValue1' has a wrong offset!");
