...
public:
	...
	struct FPointerEvent                          K2Node_Event_MouseEvent1;                          // 0x0028(0x0068)(ConstParm)
	struct FGeometry                              K2Node_Event_MyGeometry;                           // 0x0090(0x0038)(IsPlainOldData, NoDestructor)
	struct FPointerEvent                          K2Node_Event_MouseEvent;                           // 0x00C8(0x0068)(ConstParm)
	int32                                         K2Node_ComponentBoundEvent_Value;                  // 0x0130(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_134[0x4];                                      // 0x0134(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UObject*                                K2Node_Event_InData;                               // 0x0138(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonListView*                        K2Node_Event_OwningList;                           // 0x0140(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortHUDVisibilityData*                 K2Node_DynamicCast_AsFort_HUDVisibility_Data;      // 0x0148(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class FText>                           K2Node_MakeArray_Array;                            // 0x0158(0x0010)(ZeroConstructor, ReferenceParm)
...
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, K2Node_Event_MouseEvent1) == 0x000028, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::K2Node_Event_MouseEvent1' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, K2Node_Event_MyGeometry) == 0x000090, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, K2Node_Event_MouseEvent) == 0x0000C8, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::K2Node_Event_MouseEvent' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, K2Node_ComponentBoundEvent_Value) == 0x000130, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::K2Node_ComponentBoundEvent_Value' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, K2Node_Event_InData) == 0x000138, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::K2Node_Event_InData' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, K2Node_Event_OwningList) == 0x000140, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::K2Node_Event_OwningList' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, K2Node_DynamicCast_AsFort_HUDVisibility_Data) == 0x000148, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::K2Node_DynamicCast_AsFort_HUDVisibility_Data' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, K2Node_DynamicCast_bSuccess) == 0x000150, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, CallFunc_Conv_BoolToInt_ReturnValue) == 0x000154, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::CallFunc_Conv_BoolToInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, K2Node_MakeArray_Array) == 0x000158, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, K2Node_ComponentBoundEvent_Button1) == 0x000168, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::K2Node_ComponentBoundEvent_Button1' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator, K2Node_ComponentBoundEvent_Button) == 0x000170, "Member 'OptionsMenuHudRotator_C_ExecuteUbergraph_OptionsMenuHudRotator::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
...
static_assert(sizeof(OptionsMenuHudRotator_C_OnMouseEnter) == 0x0000A0, "Wrong size on OptionsMenuHudRotator_C_OnMouseEnter");
...
static_assert(sizeof(OptionsMenuHudRotator_C_OnMouseLeave) == 0x000068, "Wrong size on OptionsMenuHudRotator_C_OnMouseLeave");
...
static_assert(sizeof(OptionsMenuHudRotator_C_UpdateSize) == 0x000138, "Wrong size on OptionsMenuHudRotator_C_UpdateSize");
...
static_assert(offsetof(OptionsMenuHudRotator_C_UpdateSize, CallFunc_IsBROnly_ReturnValue) == 0x00001A, "Member 'OptionsMenuHudRotator_C_UpdateSize::CallFunc_IsBROnly_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_UpdateSize, CallFunc_IsBROnly_ReturnValue1) == 0x00001B, "Member 'OptionsMenuHudRotator_C_UpdateSize::CallFunc_IsBROnly_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(OptionsMenuHudRotator_C_UpdateSize, Temp_bool_Variable12) == 0x000038, "Member 'OptionsMenuHudRotator_C_UpdateSize::Temp_bool_Variable12' has a wrong offset!");
static_assert(offsetof(OptionsMenuHudRotator_C_UpdateSize, K2Node_Select12_Default) == 0x000040, "Member 'OptionsMenuHudRotator_C_UpdateSize::K2Node_Select12_Default' has a wrong offset!");
...
static_assert(offsetof(OptionsMenuHudRotator_C_UpdateSize, K2Node_MakeStruct_SlateBrush1) == 0x0000C0, "Member 'OptionsMenuHudRotator_C_UpdateSize::K2Node_MakeStruct_SlateBrush1' has a wrong offset!");
