...
static_assert(offsetof(ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter, CallFunc_IsValid_ReturnValue1) == 0x00001D, "Member 'ItemDetailsStackCounter_C_ExecuteUbergraph_ItemDetailsStackCounter::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
