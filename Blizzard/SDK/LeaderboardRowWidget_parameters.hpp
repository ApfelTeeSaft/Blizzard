...
static_assert(offsetof(LeaderboardRowWidget_C_Refresh, CallFunc_Conv_IntToText_ReturnValue1) == 0x000038, "Member 'LeaderboardRowWidget_C_Refresh::CallFunc_Conv_IntToText_ReturnValue1' has a wrong offset!");
