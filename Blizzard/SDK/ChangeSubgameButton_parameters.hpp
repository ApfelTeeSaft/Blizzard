...
public:
	...
	struct FPointerEvent                          K2Node_Event_MouseEvent;                           // 0x00D8(0x0068)(ConstParm)
};
...
static_assert(sizeof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton) == 0x000140, "Wrong size on ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton");
...
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, CallFunc_GetContext_ReturnValue1) == 0x000028, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(sizeof(ChangeSubgameButton_C_OnMouseEnter) == 0x0000A0, "Wrong size on ChangeSubgameButton_C_OnMouseEnter");
