...
public:
	...
	class UFortAttributeListItem_NUI*             K2Node_Event_AttributeListItemWidget;              // 0x0018(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(StatsListWidget_C_AdjustClampCount, CallFunc_EqualEqual_IntInt_ReturnValue1) == 0x000010, "Member 'StatsListWidget_C_AdjustClampCount::CallFunc_EqualEqual_IntInt_ReturnValue1' has a wrong offset!");
