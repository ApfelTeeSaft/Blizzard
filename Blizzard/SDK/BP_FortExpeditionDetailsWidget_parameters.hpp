...
public:
	...
	TArray<struct FConfirmationDialogAction>      K2Node_MakeArray_Array;                            // 0x01A0(0x0010)(ConstParm, ZeroConstructor, ReferenceParm)
...
static_assert(offsetof(BP_FortExpeditionDetailsWidget_C_ExecuteUbergraph_BP_FortExpeditionDetailsWidget, K2Node_MakeArray_Array1) == 0x0001B0, "Member 'BP_FortExpeditionDetailsWidget_C_ExecuteUbergraph_BP_FortExpeditionDetailsWidget::K2Node_MakeArray_Array1' has a wrong offset!");
...
public:
	...
	class UIconAndNameWidget_C*                   CallFunc_Create_ReturnValue;                       // 0x0370(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSlateChildSize                        K2Node_MakeStruct_SlateChildSize;                  // 0x0378(0x0008)(NoDestructor)
	class UHorizontalBoxSlot*                     CallFunc_AddChildToHorizontalBox_ReturnValue;      // 0x0380(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	class UHomeBaseContext*                       CallFunc_GetContext_ReturnValue1;                  // 0x0368(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data, CallFunc_GetContext_ReturnValue1) == 0x000368, "Member 'BP_FortExpeditionDetailsWidget_C_Set_Expedition_Returns_Data::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
public:
	...
	class UIconAndNameWidget_C*                   CallFunc_Create_ReturnValue;                       // 0x00F8(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSlateChildSize                        K2Node_MakeStruct_SlateChildSize;                  // 0x0100(0x0008)(NoDestructor)
	struct FMargin                                K2Node_MakeStruct_Margin;                          // 0x0108(0x0010)(IsPlainOldData, NoDestructor)
...
static_assert(offsetof(BP_FortExpeditionDetailsWidget_C_Set_Bonus_Criteria, Temp_byte_Variable1) == 0x000128, "Member 'BP_FortExpeditionDetailsWidget_C_Set_Bonus_Criteria::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(BP_FortExpeditionDetailsWidget_C_Get_Bonus_Display_Name_and_Brush, K2Node_MakeStruct_FormatArgumentData1) == 0x000210, "Member 'BP_FortExpeditionDetailsWidget_C_Get_Bonus_Display_Name_and_Brush::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
