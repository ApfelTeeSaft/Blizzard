...
public:
	...
	struct FSlateChildSize                        K2Node_MakeStruct_SlateChildSize1;                 // 0x0100(0x0008)(NoDestructor)
	class APlayerController*                      CallFunc_GetOwningPlayer_ReturnValue1;             // 0x0108(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCollectionBar_C*                       CallFunc_Create_ReturnValue1;                      // 0x0110(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UHorizontalBoxSlot*                     CallFunc_AddChildToHorizontalBox_ReturnValue1;     // 0x0118(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsAchievedCountInRange_bIsInRange;        // 0x0120(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(CollectionMultiProgressBar_C_Setup) == 0x000008, "Wrong alignment on CollectionMultiProgressBar_C_Setup");
static_assert(sizeof(CollectionMultiProgressBar_C_Setup) == 0x000128, "Wrong size on CollectionMultiProgressBar_C_Setup");
...
static_assert(offsetof(CollectionMultiProgressBar_C_Setup, CallFunc_IsValid_ReturnValue1) == 0x000068, "Member 'CollectionMultiProgressBar_C_Setup::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(CollectionMultiProgressBar_C_Setup, K2Node_MakeStruct_SlateChildSize1) == 0x000100, "Member 'CollectionMultiProgressBar_C_Setup::K2Node_MakeStruct_SlateChildSize1' has a wrong offset!");
static_assert(offsetof(CollectionMultiProgressBar_C_Setup, CallFunc_GetOwningPlayer_ReturnValue1) == 0x000108, "Member 'CollectionMultiProgressBar_C_Setup::CallFunc_GetOwningPlayer_ReturnValue1' has a wrong offset!");
static_assert(offsetof(CollectionMultiProgressBar_C_Setup, CallFunc_Create_ReturnValue1) == 0x000110, "Member 'CollectionMultiProgressBar_C_Setup::CallFunc_Create_ReturnValue1' has a wrong offset!");
static_assert(offsetof(CollectionMultiProgressBar_C_Setup, CallFunc_AddChildToHorizontalBox_ReturnValue1) == 0x000118, "Member 'CollectionMultiProgressBar_C_Setup::CallFunc_AddChildToHorizontalBox_ReturnValue1' has a wrong offset!");
static_assert(offsetof(CollectionMultiProgressBar_C_Setup, CallFunc_IsAchievedCountInRange_bIsInRange) == 0x000120, "Member 'CollectionMultiProgressBar_C_Setup::CallFunc_IsAchievedCountInRange_bIsInRange' has a wrong offset!");
...
static_assert(offsetof(CollectionMultiProgressBar_C_UpdateVisibleBar, CallFunc_GetChildAt_ReturnValue1) == 0x000030, "Member 'CollectionMultiProgressBar_C_UpdateVisibleBar::CallFunc_GetChildAt_ReturnValue1' has a wrong offset!");
static_assert(offsetof(CollectionMultiProgressBar_C_UpdateVisibleBar, CallFunc_GetChildrenCount_ReturnValue1) == 0x000038, "Member 'CollectionMultiProgressBar_C_UpdateVisibleBar::CallFunc_GetChildrenCount_ReturnValue1' has a wrong offset!");
