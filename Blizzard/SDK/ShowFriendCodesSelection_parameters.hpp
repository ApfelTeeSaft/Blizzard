...
static_assert(offsetof(ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection, CallFunc_GetContext_ReturnValue1) == 0x000030, "Member 'ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection, CallFunc_Create_ReturnValue1) == 0x000088, "Member 'ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection::CallFunc_Create_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection, CallFunc_AddChild_ReturnValue1) == 0x0000A8, "Member 'ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection::CallFunc_AddChild_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection, K2Node_DynamicCast_AsScroll_Box_Slot1) == 0x0000B0, "Member 'ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection::K2Node_DynamicCast_AsScroll_Box_Slot1' has a wrong offset!");
static_assert(offsetof(ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection, K2Node_DynamicCast_bSuccess1) == 0x0000B8, "Member 'ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
static_assert(offsetof(ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection, K2Node_MakeStruct_Margin1) == 0x0000BC, "Member 'ShowFriendCodesSelection_C_ExecuteUbergraph_ShowFriendCodesSelection::K2Node_MakeStruct_Margin1' has a wrong offset!");
