...
static_assert(offsetof(ItemCountOverCost_C_Update, Temp_byte_Variable12) == 0x000004, "Member 'ItemCountOverCost_C_Update::Temp_byte_Variable12' has a wrong offset!");
static_assert(offsetof(ItemCountOverCost_C_Update, Temp_byte_Variable123) == 0x000005, "Member 'ItemCountOverCost_C_Update::Temp_byte_Variable123' has a wrong offset!");
