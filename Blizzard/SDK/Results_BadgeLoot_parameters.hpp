...
static_assert(sizeof(Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot) == 0x000118, "Wrong size on Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot");
...
static_assert(offsetof(Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot, Temp_bool_A_Execution_Happened_Variable1) == 0x000010, "Member 'Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot::Temp_bool_A_Execution_Happened_Variable1' has a wrong offset!");
static_assert(offsetof(Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot, Temp_bool_B_Execution_Happened_Variable1) == 0x000011, "Member 'Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot::Temp_bool_B_Execution_Happened_Variable1' has a wrong offset!");
...
static_assert(offsetof(Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot, K2Node_HandleClientEvent_EventSource) == 0x0000D8, "Member 'Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot::K2Node_HandleClientEvent_EventSource' has a wrong offset!");
static_assert(offsetof(Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot, K2Node_HandleClientEvent_EventFocus) == 0x0000E0, "Member 'Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot::K2Node_HandleClientEvent_EventFocus' has a wrong offset!");
static_assert(offsetof(Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot, K2Node_HandleClientEvent_ClientEvent) == 0x0000E8, "Member 'Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot::K2Node_HandleClientEvent_ClientEvent' has a wrong offset!");
static_assert(offsetof(Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot, CallFunc_HasMoreBadgesToShow_bMoreBadgesToShow) == 0x000108, "Member 'Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot::CallFunc_HasMoreBadgesToShow_bMoreBadgesToShow' has a wrong offset!");
static_assert(offsetof(Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot, K2Node_ComponentBoundEvent_Button) == 0x000110, "Member 'Results_BadgeLoot_C_ExecuteUbergraph_Results_BadgeLoot::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
...
static_assert(offsetof(Results_BadgeLoot_C_StepBadgeQueues, CallFunc_Array_Get_Item1) == 0x000020, "Member 'Results_BadgeLoot_C_StepBadgeQueues::CallFunc_Array_Get_Item1' has a wrong offset!");
static_assert(offsetof(Results_BadgeLoot_C_StepBadgeQueues, CallFunc_Array_Add_ReturnValue1) == 0x000028, "Member 'Results_BadgeLoot_C_StepBadgeQueues::CallFunc_Array_Add_ReturnValue1' has a wrong offset!");
