...
static_assert(sizeof(ActiveModifiersHUD_C_PopulateModifiers) == 0x0000F0, "Wrong size on ActiveModifiersHUD_C_PopulateModifiers");
...
static_assert(offsetof(ActiveModifiersHUD_C_PopulateModifiers, CallFunc_Array_Length_ReturnValue) == 0x000060, "Member 'ActiveModifiersHUD_C_PopulateModifiers::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ActiveModifiersHUD_C_PopulateModifiers, CallFunc_Less_IntInt_ReturnValue) == 0x0000E0, "Member 'ActiveModifiersHUD_C_PopulateModifiers::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ActiveModifiersHUD_C_PopulateModifiers, CallFunc_AddChildToHorizontalBox_ReturnValue) == 0x0000E8, "Member 'ActiveModifiersHUD_C_PopulateModifiers::CallFunc_AddChildToHorizontalBox_ReturnValue' has a wrong offset!");
