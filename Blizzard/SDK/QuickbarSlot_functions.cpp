...
void UQuickbarSlot_C::SetTopComboSwitcherVisibility(ESlateVisibility InVisibility)
{
	static class UFunction* Func = nullptr;
...
void UQuickbarSlot_C::SetBottomComboSwitcherVisibility(ESlateVisibility InVisibility)
{
	static class UFunction* Func = nullptr;
