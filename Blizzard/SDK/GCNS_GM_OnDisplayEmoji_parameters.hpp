...
static_assert(offsetof(GCNS_GM_OnDisplayEmoji_C_OnStartParticleSystemSpawned, CallFunc_Add_FloatFloat_ReturnValue12) == 0x00019C, "Member 'GCNS_GM_OnDisplayEmoji_C_OnStartParticleSystemSpawned::CallFunc_Add_FloatFloat_ReturnValue12' has a wrong offset!");
