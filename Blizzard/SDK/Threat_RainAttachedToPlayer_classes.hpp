...
static_assert(sizeof(AThreat_RainAttachedToPlayer_C) == 0x000328, "Wrong size on AThreat_RainAttachedToPlayer_C");
static_assert(offsetof(AThreat_RainAttachedToPlayer_C, ParticleSystem) == 0x000318, "Member 'AThreat_RainAttachedToPlayer_C::ParticleSystem' has a wrong offset!");
static_assert(offsetof(AThreat_RainAttachedToPlayer_C, DefaultSceneRoot) == 0x000320, "Member 'AThreat_RainAttachedToPlayer_C::DefaultSceneRoot' has a wrong offset!");
