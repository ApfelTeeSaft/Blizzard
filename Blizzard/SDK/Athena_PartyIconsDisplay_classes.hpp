...
static_assert(sizeof(UAthena_PartyIconsDisplay_C) == 0x000238, "Wrong size on UAthena_PartyIconsDisplay_C");
...
static_assert(offsetof(UAthena_PartyIconsDisplay_C, CommonWidgetSwitcher_0) == 0x000210, "Member 'UAthena_PartyIconsDisplay_C::CommonWidgetSwitcher_0' has a wrong offset!");
...
static_assert(offsetof(UAthena_PartyIconsDisplay_C, PreviewIndex) == 0x000230, "Member 'UAthena_PartyIconsDisplay_C::PreviewIndex' has a wrong offset!");
