...
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x00006C, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel, CallFunc_Add_IntInt_ReturnValue1) == 0x000080, "Member 'AthenaPlayerLevel_C_ExecuteUbergraph_AthenaPlayerLevel::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(AthenaPlayerLevel_C_UpdateXp, CallFunc_Conv_IntToText_ReturnValue1) == 0x000038, "Member 'AthenaPlayerLevel_C_UpdateXp::CallFunc_Conv_IntToText_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AthenaPlayerLevel_C_UpdateXp, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x000050, "Member 'AthenaPlayerLevel_C_UpdateXp::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
