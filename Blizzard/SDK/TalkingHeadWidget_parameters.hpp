...
static_assert(offsetof(TalkingHeadWidget_C_ExecuteUbergraph_TalkingHeadWidget, K2Node_CreateDelegate_OutputDelegate1) == 0x000018, "Member 'TalkingHeadWidget_C_ExecuteUbergraph_TalkingHeadWidget::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(TalkingHeadWidget_C_HandleTalkingHeadBegin, Temp_byte_Variable1) == 0x00003A, "Member 'TalkingHeadWidget_C_HandleTalkingHeadBegin::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(TalkingHeadWidget_C_HandleTalkingHeadBegin, Temp_byte_Variable12) == 0x00003B, "Member 'TalkingHeadWidget_C_HandleTalkingHeadBegin::Temp_byte_Variable12' has a wrong offset!");
static_assert(offsetof(TalkingHeadWidget_C_HandleTalkingHeadBegin, Temp_byte_Variable123) == 0x00003C, "Member 'TalkingHeadWidget_C_HandleTalkingHeadBegin::Temp_byte_Variable123' has a wrong offset!");
