...
static_assert(sizeof(AGCN_MiniBoss_C) == 0x0005A0, "Wrong size on AGCN_MiniBoss_C");
static_assert(offsetof(AGCN_MiniBoss_C, UberGraphFrame) == 0x000440, "Member 'AGCN_MiniBoss_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCN_MiniBoss_C, MiniMapCrosshair) == 0x000448, "Member 'AGCN_MiniBoss_C::MiniMapCrosshair' has a wrong offset!");
static_assert(offsetof(AGCN_MiniBoss_C, TC_NPCCharacterTypeMiniBoss1P) == 0x000450, "Member 'AGCN_MiniBoss_C::TC_NPCCharacterTypeMiniBoss1P' has a wrong offset!");
static_assert(offsetof(AGCN_MiniBoss_C, TC_NPCCharacterTypeMiniBoss4P) == 0x000470, "Member 'AGCN_MiniBoss_C::TC_NPCCharacterTypeMiniBoss4P' has a wrong offset!");
static_assert(offsetof(AGCN_MiniBoss_C, FourP_Color) == 0x000490, "Member 'AGCN_MiniBoss_C::FourP_Color' has a wrong offset!");
static_assert(offsetof(AGCN_MiniBoss_C, OneP_Color) == 0x0004A0, "Member 'AGCN_MiniBoss_C::OneP_Color' has a wrong offset!");
static_assert(offsetof(AGCN_MiniBoss_C, VectorParameters) == 0x0004B0, "Member 'AGCN_MiniBoss_C::VectorParameters' has a wrong offset!");
static_assert(offsetof(AGCN_MiniBoss_C, ScalarParameters) == 0x000500, "Member 'AGCN_MiniBoss_C::ScalarParameters' has a wrong offset!");
static_assert(offsetof(AGCN_MiniBoss_C, ElementalParticlesMap) == 0x000550, "Member 'AGCN_MiniBoss_C::ElementalParticlesMap' has a wrong offset!");
