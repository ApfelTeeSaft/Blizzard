...
static_assert(sizeof(UAthenaStatsTab_C) == 0x000588, "Wrong size on UAthenaStatsTab_C");
...
static_assert(offsetof(UAthenaStatsTab_C, CommonWidgetSwitcher_0) == 0x0004A0, "Member 'UAthenaStatsTab_C::CommonWidgetSwitcher_0' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, Divider) == 0x0004A8, "Member 'UAthenaStatsTab_C::Divider' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, Divider1) == 0x0004B0, "Member 'UAthenaStatsTab_C::Divider1' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, Divider2) == 0x0004B8, "Member 'UAthenaStatsTab_C::Divider2' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, FriendMatchXpBoostPointsLabel) == 0x0004C0, "Member 'UAthenaStatsTab_C::FriendMatchXpBoostPointsLabel' has a wrong offset!");
...
static_assert(offsetof(UAthenaStatsTab_C, KillsRow) == 0x0004D0, "Member 'UAthenaStatsTab_C::KillsRow' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, LastUpdatedTime) == 0x0004D8, "Member 'UAthenaStatsTab_C::LastUpdatedTime' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, LastUpdatedTimeBox) == 0x0004E0, "Member 'UAthenaStatsTab_C::LastUpdatedTimeBox' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, MatchesPlayedRow) == 0x0004E8, "Member 'UAthenaStatsTab_C::MatchesPlayedRow' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, MatchXpBoostPointsLabel) == 0x0004F0, "Member 'UAthenaStatsTab_C::MatchXpBoostPointsLabel' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, PlayerRankEmblem) == 0x0004F8, "Member 'UAthenaStatsTab_C::PlayerRankEmblem' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, ProgressSpinner) == 0x000500, "Member 'UAthenaStatsTab_C::ProgressSpinner' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, SeasonLabel) == 0x000508, "Member 'UAthenaStatsTab_C::SeasonLabel' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, SecondTierTile) == 0x000510, "Member 'UAthenaStatsTab_C::SecondTierTile' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, ThirdTierTile) == 0x000518, "Member 'UAthenaStatsTab_C::ThirdTierTile' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, TimePlayedRow) == 0x000520, "Member 'UAthenaStatsTab_C::TimePlayedRow' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, UpdatingBox) == 0x000528, "Member 'UAthenaStatsTab_C::UpdatingBox' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, WinsTile) == 0x000530, "Member 'UAthenaStatsTab_C::WinsTile' has a wrong offset!");
static_assert(offsetof(UAthenaStatsTab_C, TagToDisplayName) == 0x000538, "Member 'UAthenaStatsTab_C::TagToDisplayName' has a wrong offset!");
