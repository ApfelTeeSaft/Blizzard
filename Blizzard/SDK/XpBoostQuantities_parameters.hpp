...
static_assert(offsetof(XpBoostQuantities_C_ExecuteUbergraph_XpBoostQuantities, K2Node_CreateDelegate_OutputDelegate1) == 0x000018, "Member 'XpBoostQuantities_C_ExecuteUbergraph_XpBoostQuantities::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(XpBoostQuantities_C_UpdateXPQuantitiesInfo, CallFunc_GetContext_ReturnValue1) == 0x000028, "Member 'XpBoostQuantities_C_UpdateXPQuantitiesInfo::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(XpBoostQuantities_C_UpdateXPQuantitiesInfo, K2Node_MakeStruct_FormatArgumentData1) == 0x0000F0, "Member 'XpBoostQuantities_C_UpdateXPQuantitiesInfo::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
...
static_assert(offsetof(XpBoostQuantities_C_UpdateXPQuantitiesInfo, K2Node_MakeArray_Array1) == 0x000138, "Member 'XpBoostQuantities_C_UpdateXPQuantitiesInfo::K2Node_MakeArray_Array1' has a wrong offset!");
...
static_assert(offsetof(XpBoostQuantities_C_ScaledBoostBalance, CallFunc_GetXpPerAccountLevel_ReturnValue) == 0x000008, "Member 'XpBoostQuantities_C_ScaledBoostBalance::CallFunc_GetXpPerAccountLevel_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(XpBoostQuantities_C_ScaledBoostBalance, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x000010, "Member 'XpBoostQuantities_C_ScaledBoostBalance::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(XpBoostQuantities_C_ScaledRestBalance, CallFunc_GetXpPerAccountLevel_ReturnValue) == 0x000008, "Member 'XpBoostQuantities_C_ScaledRestBalance::CallFunc_GetXpPerAccountLevel_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(XpBoostQuantities_C_ScaledRestBalance, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x000010, "Member 'XpBoostQuantities_C_ScaledRestBalance::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
