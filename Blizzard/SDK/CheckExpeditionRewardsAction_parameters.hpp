...
static_assert(offsetof(CheckExpeditionRewardsAction_C_OpenFrontEndRewards, K2Node_CreateDelegate_OutputDelegate1) == 0x000030, "Member 'CheckExpeditionRewardsAction_C_OpenFrontEndRewards::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
