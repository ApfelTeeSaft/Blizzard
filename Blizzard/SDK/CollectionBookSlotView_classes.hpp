...
static_assert(sizeof(UCollectionBookSlotView_C) == 0x000358, "Wrong size on UCollectionBookSlotView_C");
static_assert(offsetof(UCollectionBookSlotView_C, UberGraphFrame) == 0x000350, "Member 'UCollectionBookSlotView_C::UberGraphFrame' has a wrong offset!");
