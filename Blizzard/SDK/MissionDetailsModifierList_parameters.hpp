...
public:
	...
	int32                                         CallFunc_Array_Length_ReturnValue12;               // 0x0040(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TSoftObjectPtr<class UTexture2D>              CallFunc_GetLargePreviewImage_ReturnValue;         // 0x0058(0x0028)(HasGetValueTypeHash)
	struct FSlateBrush                            CallFunc_GetSmallPreviewImageBrush_ReturnValue;    // 0x0080(0x0078)()
	class FText                                   CallFunc_GetShortDescription_ReturnValue;          // 0x00F8(0x0018)()
	...
	class FText                                   CallFunc_GetDisplayName_ReturnValue;               // 0x0118(0x0018)()
	...
	bool                                          CallFunc_BooleanAND_ReturnValue1;                  // 0x01C1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanAND_ReturnValue12;                 // 0x01C2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ESlateVisibility                              K2Node_Select_Default;                             // 0x01C3(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Temp_float_Variable;                               // 0x01C4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Temp_float_Variable1;                              // 0x01C8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FMargin                                K2Node_MakeStruct_Margin;                          // 0x01D4(0x0010)(IsPlainOldData, NoDestructor)
	...
	class UMissionDetailsModifierRow_C*           CallFunc_Create_ReturnValue;                       // 0x01F0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(MissionDetailsModifierList_C_PopulateModifiers) == 0x000200, "Wrong size on MissionDetailsModifierList_C_PopulateModifiers");
...
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_Array_Length_ReturnValue12) == 0x000040, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_Array_Length_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_GetSmallPreviewImageBrush_ReturnValue) == 0x000080, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_GetSmallPreviewImageBrush_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_GetShortDescription_ReturnValue) == 0x0000F8, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_GetShortDescription_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_GetBrushResourceAsTexture2D_ReturnValue) == 0x000110, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_GetBrushResourceAsTexture2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_GetDisplayName_ReturnValue) == 0x000118, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, Temp_int_Loop_Counter_Variable) == 0x000134, "Member 'MissionDetailsModifierList_C_PopulateModifiers::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, Temp_byte_Variable) == 0x000138, "Member 'MissionDetailsModifierList_C_PopulateModifiers::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_Less_IntInt_ReturnValue) == 0x000139, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_Add_IntInt_ReturnValue) == 0x00013C, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_BooleanAND_ReturnValue) == 0x000140, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, Temp_byte_Variable1) == 0x000141, "Member 'MissionDetailsModifierList_C_PopulateModifiers::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_Subtract_IntInt_ReturnValue) == 0x000144, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_Greater_IntInt_ReturnValue) == 0x000148, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, K2Node_MakeStruct_FormatArgumentData) == 0x000150, "Member 'MissionDetailsModifierList_C_PopulateModifiers::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, K2Node_MakeArray_Array) == 0x000190, "Member 'MissionDetailsModifierList_C_PopulateModifiers::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x0001A0, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_Format_ReturnValue) == 0x0001A8, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, Temp_bool_Variable) == 0x0001C0, "Member 'MissionDetailsModifierList_C_PopulateModifiers::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_BooleanAND_ReturnValue1) == 0x0001C1, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_BooleanAND_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_BooleanAND_ReturnValue12) == 0x0001C2, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_BooleanAND_ReturnValue12' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, K2Node_Select_Default) == 0x0001C3, "Member 'MissionDetailsModifierList_C_PopulateModifiers::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, Temp_float_Variable) == 0x0001C4, "Member 'MissionDetailsModifierList_C_PopulateModifiers::Temp_float_Variable' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, Temp_float_Variable1) == 0x0001C8, "Member 'MissionDetailsModifierList_C_PopulateModifiers::Temp_float_Variable1' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, Temp_bool_Variable1) == 0x0001CC, "Member 'MissionDetailsModifierList_C_PopulateModifiers::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, K2Node_Select1_Default) == 0x0001D0, "Member 'MissionDetailsModifierList_C_PopulateModifiers::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, K2Node_MakeStruct_Margin) == 0x0001D4, "Member 'MissionDetailsModifierList_C_PopulateModifiers::K2Node_MakeStruct_Margin' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_GetOwningPlayer_ReturnValue) == 0x0001E8, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_Create_ReturnValue) == 0x0001F0, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(MissionDetailsModifierList_C_PopulateModifiers, CallFunc_AddChildToVerticalBox_ReturnValue) == 0x0001F8, "Member 'MissionDetailsModifierList_C_PopulateModifiers::CallFunc_AddChildToVerticalBox_ReturnValue' has a wrong offset!");
