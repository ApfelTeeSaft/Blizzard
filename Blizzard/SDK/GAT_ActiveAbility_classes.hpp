...
static_assert(sizeof(UGAT_ActiveAbility_C) == 0x000AC0, "Wrong size on UGAT_ActiveAbility_C");
static_assert(offsetof(UGAT_ActiveAbility_C, UberGraphFrame) == 0x000AB0, "Member 'UGAT_ActiveAbility_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGAT_ActiveAbility_C, TC_AbilitiesGenericActiveAbilityActivate) == 0x000AB8, "Member 'UGAT_ActiveAbility_C::TC_AbilitiesGenericActiveAbilityActivate' has a wrong offset!");
