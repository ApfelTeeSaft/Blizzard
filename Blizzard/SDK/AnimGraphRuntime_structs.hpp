...
public:
	...
	struct FInputScaleBiasClamp                   PitchScaleBiasClamp;                               // 0x0050(0x0014)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FInputScaleBiasClamp                   YawScaleBiasClamp;                                 // 0x0064(0x0014)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FRotator                               MeshToComponent;                                   // 0x0078(0x000C)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_84[0x4];                                       // 0x0084(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_RotateRootBone) == 0x000008, "Wrong alignment on FAnimNode_RotateRootBone");
static_assert(sizeof(FAnimNode_RotateRootBone) == 0x000088, "Wrong size on FAnimNode_RotateRootBone");
...
static_assert(offsetof(FAnimNode_RotateRootBone, YawScaleBiasClamp) == 0x000064, "Member 'FAnimNode_RotateRootBone::YawScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotateRootBone, MeshToComponent) == 0x000078, "Member 'FAnimNode_RotateRootBone::MeshToComponent' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_RotationOffsetBlendSpace) == 0x000158, "Wrong size on FAnimNode_RotationOffsetBlendSpace");
...
static_assert(sizeof(FAnimNode_LegIK) == 0x0000A0, "Wrong size on FAnimNode_LegIK");
...
static_assert(sizeof(FAnimNode_Slot) == 0x000070, "Wrong size on FAnimNode_Slot");
...
{
public:
	uint8                                         Pad_580[0x1A0];                                    // 0x0580(0x01A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000720, "Wrong size on FAnimSequencerInstanceProxy");
