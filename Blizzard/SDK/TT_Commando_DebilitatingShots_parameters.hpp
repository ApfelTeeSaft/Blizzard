...
public:
	...
	class FText                                   Temp_text_Variable1;                               // 0x00E8(0x0018)()
...
static_assert(offsetof(TT_Commando_DebilitatingShots_C_GetTextForTokenFromAbilityInstanceInternal, Temp_text_Variable1) == 0x0000E8, "Member 'TT_Commando_DebilitatingShots_C_GetTextForTokenFromAbilityInstanceInternal::Temp_text_Variable1' has a wrong offset!");
...
{
public:
	const class UObject*                          ObjectToDescribe;                                  // 0x0000(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           Tag;                                               // 0x0008(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash)
	const class UFortTooltipContext*              Context;                                           // 0x0010(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
