...
static_assert(offsetof(ScoreBarsWidget_C_ExecuteUbergraph_ScoreBarsWidget, K2Node_CreateDelegate_OutputDelegate1) == 0x000030, "Member 'ScoreBarsWidget_C_ExecuteUbergraph_ScoreBarsWidget::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(ScoreBarsWidget_C_InitializeScoreBars, K2Node_DynamicCast_AsScore_Badge_Provider_Mission1) == 0x000020, "Member 'ScoreBarsWidget_C_InitializeScoreBars::K2Node_DynamicCast_AsScore_Badge_Provider_Mission1' has a wrong offset!");
...
static_assert(offsetof(ScoreBarsWidget_C_UpdateScoreTotals, K2Node_DynamicCast_AsScore_Badge_Provider_Mission1) == 0x000028, "Member 'ScoreBarsWidget_C_UpdateScoreTotals::K2Node_DynamicCast_AsScore_Badge_Provider_Mission1' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue; // 0x0008(0x0078)(ConstParm)
	struct FSlateBrush                            CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue1; // 0x0080(0x0078)(ConstParm)
	struct FSlateBrush                            CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue12; // 0x00F8(0x0078)(ConstParm)
};
...
static_assert(offsetof(ScoreBarsWidget_C_InitializeIcons, CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue1) == 0x000080, "Member 'ScoreBarsWidget_C_InitializeIcons::CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ScoreBarsWidget_C_InitializeIcons, CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue12) == 0x0000F8, "Member 'ScoreBarsWidget_C_InitializeIcons::CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(ScoreBarsWidget_C_TryGetNextScoreMessage, K2Node_CreateDelegate_OutputDelegate1) == 0x000018, "Member 'ScoreBarsWidget_C_TryGetNextScoreMessage::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(ScoreBarsWidget_C_HandleScoreMessageExpired, K2Node_CreateDelegate_OutputDelegate1) == 0x000030, "Member 'ScoreBarsWidget_C_HandleScoreMessageExpired::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
public:
	...
	TDelegate<void(int32 StatDelta, const class FText& StatName, EFortReplicatedStat StatType, EStatCategory StatCategory)> K2Node_CreateDelegate_OutputDelegate1234; // 0x0060(0x0010)(ZeroConstructor, NoDestructor)
};
...
static_assert(offsetof(ScoreBarsWidget_C_RegisterForScoreStreamEvents, CallFunc_GetContext_ReturnValue1) == 0x000008, "Member 'ScoreBarsWidget_C_RegisterForScoreStreamEvents::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
public:
	...
	TDelegate<void(int32 StatDelta, const class FText& StatName, EFortReplicatedStat StatType, EStatCategory StatCategory)> K2Node_CreateDelegate_OutputDelegate1234; // 0x0050(0x0010)(ZeroConstructor, NoDestructor)
};
