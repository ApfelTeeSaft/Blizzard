...
static_assert(offsetof(OutpostScreenStormShield_C_ExecuteUbergraph_OutpostScreenStormShield, K2Node_ComponentBoundEvent_TabId1) == 0x000008, "Member 'OutpostScreenStormShield_C_ExecuteUbergraph_OutpostScreenStormShield::K2Node_ComponentBoundEvent_TabId1' has a wrong offset!");
...
static_assert(offsetof(OutpostScreenStormShield_C_ExecuteUbergraph_OutpostScreenStormShield, CallFunc_GetWidgetAtIndex_ReturnValue1) == 0x000030, "Member 'OutpostScreenStormShield_C_ExecuteUbergraph_OutpostScreenStormShield::CallFunc_GetWidgetAtIndex_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(OutpostScreenStormShield_C_ExecuteUbergraph_OutpostScreenStormShield, K2Node_DynamicCast_bSuccess1) == 0x000050, "Member 'OutpostScreenStormShield_C_ExecuteUbergraph_OutpostScreenStormShield::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
...
static_assert(offsetof(OutpostScreenStormShield_C_ExecuteUbergraph_OutpostScreenStormShield, K2Node_DynamicCast_bSuccess12) == 0x000070, "Member 'OutpostScreenStormShield_C_ExecuteUbergraph_OutpostScreenStormShield::K2Node_DynamicCast_bSuccess12' has a wrong offset!");
...
static_assert(offsetof(OutpostScreenStormShield_C_SetCoreBuilding, CallFunc_GetWidgetAtIndex_ReturnValue1) == 0x000010, "Member 'OutpostScreenStormShield_C_SetCoreBuilding::CallFunc_GetWidgetAtIndex_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(OutpostScreenStormShield_C_SetCoreBuilding, K2Node_DynamicCast_bSuccess1) == 0x000030, "Member 'OutpostScreenStormShield_C_SetCoreBuilding::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
