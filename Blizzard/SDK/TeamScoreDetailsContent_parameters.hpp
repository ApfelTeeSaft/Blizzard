...
static_assert(offsetof(TeamScoreDetailsContent_C_TrimUnusedRows, CallFunc_GetChildrenCount_ReturnValue1) == 0x000014, "Member 'TeamScoreDetailsContent_C_TrimUnusedRows::CallFunc_GetChildrenCount_ReturnValue1' has a wrong offset!");
