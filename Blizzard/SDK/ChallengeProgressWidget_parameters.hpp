...
static_assert(sizeof(ChallengeProgressWidget_C_ExecuteUbergraph_ChallengeProgressWidget) == 0x00000C, "Wrong size on ChallengeProgressWidget_C_ExecuteUbergraph_ChallengeProgressWidget");
...
static_assert(offsetof(ChallengeProgressWidget_C_ExecuteUbergraph_ChallengeProgressWidget, Temp_bool_Variable) == 0x000004, "Member 'ChallengeProgressWidget_C_ExecuteUbergraph_ChallengeProgressWidget::Temp_bool_Variable' has a wrong offset!");
...
static_assert(offsetof(ChallengeProgressWidget_C_ExecuteUbergraph_ChallengeProgressWidget, Temp_bool_Variable1) == 0x000007, "Member 'ChallengeProgressWidget_C_ExecuteUbergraph_ChallengeProgressWidget::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(ChallengeProgressWidget_C_ExecuteUbergraph_ChallengeProgressWidget, K2Node_Select1_Default) == 0x00000B, "Member 'ChallengeProgressWidget_C_ExecuteUbergraph_ChallengeProgressWidget::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(sizeof(ChallengeProgressWidget_C_Update) == 0x000120, "Wrong size on ChallengeProgressWidget_C_Update");
static_assert(offsetof(ChallengeProgressWidget_C_Update, Required) == 0x000000, "Member 'ChallengeProgressWidget_C_Update::Required' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, Achieved) == 0x000004, "Member 'ChallengeProgressWidget_C_Update::Achieved' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, Current) == 0x000008, "Member 'ChallengeProgressWidget_C_Update::Current' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, Total) == 0x00000C, "Member 'ChallengeProgressWidget_C_Update::Total' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000010, "Member 'ChallengeProgressWidget_C_Update::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, CallFunc_Conv_IntToText_ReturnValue) == 0x000018, "Member 'ChallengeProgressWidget_C_Update::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x000030, "Member 'ChallengeProgressWidget_C_Update::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, K2Node_MakeStruct_FormatArgumentData) == 0x000038, "Member 'ChallengeProgressWidget_C_Update::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, CallFunc_Conv_IntToText_ReturnValue1) == 0x000078, "Member 'ChallengeProgressWidget_C_Update::CallFunc_Conv_IntToText_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000090, "Member 'ChallengeProgressWidget_C_Update::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, K2Node_MakeStruct_FormatArgumentData1) == 0x000098, "Member 'ChallengeProgressWidget_C_Update::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, CallFunc_Max_ReturnValue) == 0x0000D8, "Member 'ChallengeProgressWidget_C_Update::CallFunc_Max_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ChallengeProgressWidget_C_Update, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x0000F0, "Member 'ChallengeProgressWidget_C_Update::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, CallFunc_Format_ReturnValue) == 0x0000F8, "Member 'ChallengeProgressWidget_C_Update::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000110, "Member 'ChallengeProgressWidget_C_Update::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, Temp_bool_Variable) == 0x000114, "Member 'ChallengeProgressWidget_C_Update::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(ChallengeProgressWidget_C_Update, K2Node_Select_Default) == 0x000118, "Member 'ChallengeProgressWidget_C_Update::K2Node_Select_Default' has a wrong offset!");
