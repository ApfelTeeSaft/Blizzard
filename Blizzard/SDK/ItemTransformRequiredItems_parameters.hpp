...
public:
	...
	int32                                         Temp_int_Variable12;                               // 0x00D0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_Select_Default;                             // 0x00D4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         Temp_int_Variable123;                              // 0x00D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_DC[0x4];                                       // 0x00DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateColor                            K2Node_Select1_Default;                            // 0x00E0(0x0028)()
	bool                                          Temp_bool_Variable12;                              // 0x0108(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_109[0x3];                                      // 0x0109(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         K2Node_Select12_Default;                           // 0x010C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          Temp_bool_Variable123;                             // 0x0112(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ESlateVisibility                              K2Node_Select123_Default;                          // 0x0113(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, Temp_int_Variable1) == 0x00007C, "Member 'ItemTransformRequiredItems_C_UpdateItems::Temp_int_Variable1' has a wrong offset!");
...
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x0000C8, "Member 'ItemTransformRequiredItems_C_UpdateItems::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, Temp_bool_Variable1) == 0x0000CC, "Member 'ItemTransformRequiredItems_C_UpdateItems::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, Temp_int_Variable12) == 0x0000D0, "Member 'ItemTransformRequiredItems_C_UpdateItems::Temp_int_Variable12' has a wrong offset!");
...
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, Temp_int_Variable123) == 0x0000D8, "Member 'ItemTransformRequiredItems_C_UpdateItems::Temp_int_Variable123' has a wrong offset!");
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, K2Node_Select1_Default) == 0x0000E0, "Member 'ItemTransformRequiredItems_C_UpdateItems::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, Temp_bool_Variable12) == 0x000108, "Member 'ItemTransformRequiredItems_C_UpdateItems::Temp_bool_Variable12' has a wrong offset!");
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, K2Node_Select12_Default) == 0x00010C, "Member 'ItemTransformRequiredItems_C_UpdateItems::K2Node_Select12_Default' has a wrong offset!");
...
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, Temp_byte_Variable1) == 0x000111, "Member 'ItemTransformRequiredItems_C_UpdateItems::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, Temp_bool_Variable123) == 0x000112, "Member 'ItemTransformRequiredItems_C_UpdateItems::Temp_bool_Variable123' has a wrong offset!");
static_assert(offsetof(ItemTransformRequiredItems_C_UpdateItems, K2Node_Select123_Default) == 0x000113, "Member 'ItemTransformRequiredItems_C_UpdateItems::K2Node_Select123_Default' has a wrong offset!");
