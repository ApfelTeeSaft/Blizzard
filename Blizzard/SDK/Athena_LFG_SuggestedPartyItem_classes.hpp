...
static_assert(sizeof(UAthena_LFG_SuggestedPartyItem_C) == 0x000250, "Wrong size on UAthena_LFG_SuggestedPartyItem_C");
static_assert(offsetof(UAthena_LFG_SuggestedPartyItem_C, UberGraphFrame) == 0x000208, "Member 'UAthena_LFG_SuggestedPartyItem_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthena_LFG_SuggestedPartyItem_C, B_InviteButton) == 0x000210, "Member 'UAthena_LFG_SuggestedPartyItem_C::B_InviteButton' has a wrong offset!");
static_assert(offsetof(UAthena_LFG_SuggestedPartyItem_C, B_InviteButtonContainer) == 0x000218, "Member 'UAthena_LFG_SuggestedPartyItem_C::B_InviteButtonContainer' has a wrong offset!");
static_assert(offsetof(UAthena_LFG_SuggestedPartyItem_C, Button_0) == 0x000220, "Member 'UAthena_LFG_SuggestedPartyItem_C::Button_0' has a wrong offset!");
static_assert(offsetof(UAthena_LFG_SuggestedPartyItem_C, CommonBorder_0) == 0x000228, "Member 'UAthena_LFG_SuggestedPartyItem_C::CommonBorder_0' has a wrong offset!");
static_assert(offsetof(UAthena_LFG_SuggestedPartyItem_C, I_LeaderImage) == 0x000230, "Member 'UAthena_LFG_SuggestedPartyItem_C::I_LeaderImage' has a wrong offset!");
static_assert(offsetof(UAthena_LFG_SuggestedPartyItem_C, T_PartyName) == 0x000238, "Member 'UAthena_LFG_SuggestedPartyItem_C::T_PartyName' has a wrong offset!");
static_assert(offsetof(UAthena_LFG_SuggestedPartyItem_C, PartyFocused) == 0x000240, "Member 'UAthena_LFG_SuggestedPartyItem_C::PartyFocused' has a wrong offset!");
