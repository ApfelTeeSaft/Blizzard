...
static_assert(sizeof(UAthenaPlayersLeftWidget_C) == 0x000260, "Wrong size on UAthenaPlayersLeftWidget_C");
static_assert(offsetof(UAthenaPlayersLeftWidget_C, UberGraphFrame) == 0x000248, "Member 'UAthenaPlayersLeftWidget_C::UberGraphFrame' has a wrong offset!");
...
static_assert(offsetof(UAthenaPlayersLeftWidget_C, PlayersLeftText) == 0x000258, "Member 'UAthenaPlayersLeftWidget_C::PlayersLeftText' has a wrong offset!");
