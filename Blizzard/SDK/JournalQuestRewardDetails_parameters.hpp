...
static_assert(offsetof(JournalQuestRewardDetails_C_Setup, K2Node_CreateDelegate_OutputDelegate1) == 0x000010, "Member 'JournalQuestRewardDetails_C_Setup::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
