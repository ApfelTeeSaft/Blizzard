...
static_assert(offsetof(InterestIndicatorWidget_C_SetDisplayText, Temp_byte_Variable1) == 0x00001B, "Member 'InterestIndicatorWidget_C_SetDisplayText::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(InterestIndicatorWidget_C_SetDisplayImage, Temp_byte_Variable1) == 0x00000B, "Member 'InterestIndicatorWidget_C_SetDisplayImage::Temp_byte_Variable1' has a wrong offset!");
