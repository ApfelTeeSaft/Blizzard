...
static_assert(offsetof(BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation, CallFunc_Add_FloatFloat_ReturnValue12) == 0x000034, "Member 'BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation::CallFunc_Add_FloatFloat_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation, CallFunc_Add_FloatFloat_ReturnValue123) == 0x00003C, "Member 'BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation::CallFunc_Add_FloatFloat_ReturnValue123' has a wrong offset!");
