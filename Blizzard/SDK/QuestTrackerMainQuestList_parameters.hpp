...
static_assert(offsetof(QuestTrackerMainQuestList_C_GetQuestsToDisplay, CallFunc_IsValid_ReturnValue1) == 0x000021, "Member 'QuestTrackerMainQuestList_C_GetQuestsToDisplay::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(QuestTrackerMainQuestList_C_GetQuestsToDisplay, CallFunc_IsValid_ReturnValue12) == 0x000040, "Member 'QuestTrackerMainQuestList_C_GetQuestsToDisplay::CallFunc_IsValid_ReturnValue12' has a wrong offset!");
