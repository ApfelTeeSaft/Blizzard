...
static_assert(offsetof(UQuickbarSlot_C, ItemCardMaximized) == 0x000268, "Member 'UQuickbarSlot_C::ItemCardMaximized' has a wrong offset!");
static_assert(offsetof(UQuickbarSlot_C, ItemCardMinimized) == 0x000270, "Member 'UQuickbarSlot_C::ItemCardMinimized' has a wrong offset!");
static_assert(offsetof(UQuickbarSlot_C, KeybindBottom) == 0x000278, "Member 'UQuickbarSlot_C::KeybindBottom' has a wrong offset!");
static_assert(offsetof(UQuickbarSlot_C, KeybindBottomCombo1) == 0x000280, "Member 'UQuickbarSlot_C::KeybindBottomCombo1' has a wrong offset!");
static_assert(offsetof(UQuickbarSlot_C, KeybindBottomCombo2) == 0x000288, "Member 'UQuickbarSlot_C::KeybindBottomCombo2' has a wrong offset!");
static_assert(offsetof(UQuickbarSlot_C, KeybindBottomComboArrow1) == 0x000290, "Member 'UQuickbarSlot_C::KeybindBottomComboArrow1' has a wrong offset!");
static_assert(offsetof(UQuickbarSlot_C, KeybindBottomComboArrow2) == 0x000298, "Member 'UQuickbarSlot_C::KeybindBottomComboArrow2' has a wrong offset!");
static_assert(offsetof(UQuickbarSlot_C, KeybindTop) == 0x0002A0, "Member 'UQuickbarSlot_C::KeybindTop' has a wrong offset!");
static_assert(offsetof(UQuickbarSlot_C, KeybindTopCombo1) == 0x0002A8, "Member 'UQuickbarSlot_C::KeybindTopCombo1' has a wrong offset!");
static_assert(offsetof(UQuickbarSlot_C, KeybindTopCombo2) == 0x0002B0, "Member 'UQuickbarSlot_C::KeybindTopCombo2' has a wrong offset!");
static_assert(offsetof(UQuickbarSlot_C, KeybindTopComboArrow1) == 0x0002B8, "Member 'UQuickbarSlot_C::KeybindTopComboArrow1' has a wrong offset!");
static_assert(offsetof(UQuickbarSlot_C, KeybindTopComboArrow2) == 0x0002C0, "Member 'UQuickbarSlot_C::KeybindTopComboArrow2' has a wrong offset!");
static_assert(offsetof(UQuickbarSlot_C, QuickbarSlotCooldown) == 0x0002C8, "Member 'UQuickbarSlot_C::QuickbarSlotCooldown' has a wrong offset!");
static_assert(offsetof(UQuickbarSlot_C, QuickBarSlotInvalidationBox) == 0x0002D0, "Member 'UQuickbarSlot_C::QuickBarSlotInvalidationBox' has a wrong offset!");
