...
public:
	...
	ESlateVisibility                              K2Node_Select1_Default;                            // 0x0047(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(LobbyPlayerPadTop_C_Refresh, Temp_bool_Variable1) == 0x000045, "Member 'LobbyPlayerPadTop_C_Refresh::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(LobbyPlayerPadTop_C_Refresh, K2Node_Select1_Default) == 0x000047, "Member 'LobbyPlayerPadTop_C_Refresh::K2Node_Select1_Default' has a wrong offset!");
...
public:
	...
	TDelegate<void(const struct FUniqueNetIdRepl& UniqueId, bool bMuted)> K2Node_CreateDelegate_OutputDelegate1; // 0x0010(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(const struct FUniqueNetIdRepl& UniqueId, bool bTalking)> K2Node_CreateDelegate_OutputDelegate12; // 0x0020(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const struct FUniqueNetIdRepl& UniqueId, bool bReady)> K2Node_CreateDelegate_OutputDelegate123; // 0x0038(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(int32 PlayerIndex)>            K2Node_CreateDelegate_OutputDelegate1234;          // 0x0050(0x0010)(ZeroConstructor, NoDestructor)
	class UFortPartyContext*                      CallFunc_GetContext_ReturnValue12;                 // 0x0060(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(int32 PlayerIndex)>            K2Node_CreateDelegate_OutputDelegate12345;         // 0x0068(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(offsetof(LobbyPlayerPadTop_C_InitializeContextEvents, K2Node_CreateDelegate_OutputDelegate12) == 0x000020, "Member 'LobbyPlayerPadTop_C_InitializeContextEvents::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
...
static_assert(offsetof(LobbyPlayerPadTop_C_InitializeContextEvents, K2Node_CreateDelegate_OutputDelegate123) == 0x000038, "Member 'LobbyPlayerPadTop_C_InitializeContextEvents::K2Node_CreateDelegate_OutputDelegate123' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadTop_C_InitializeContextEvents, CallFunc_GetContext_ReturnValue1) == 0x000048, "Member 'LobbyPlayerPadTop_C_InitializeContextEvents::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadTop_C_InitializeContextEvents, K2Node_CreateDelegate_OutputDelegate1234) == 0x000050, "Member 'LobbyPlayerPadTop_C_InitializeContextEvents::K2Node_CreateDelegate_OutputDelegate1234' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadTop_C_InitializeContextEvents, CallFunc_GetContext_ReturnValue12) == 0x000060, "Member 'LobbyPlayerPadTop_C_InitializeContextEvents::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadTop_C_InitializeContextEvents, K2Node_CreateDelegate_OutputDelegate12345) == 0x000068, "Member 'LobbyPlayerPadTop_C_InitializeContextEvents::K2Node_CreateDelegate_OutputDelegate12345' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadTop_C_InitializeContextEvents, CallFunc_GetContext_ReturnValue123) == 0x000078, "Member 'LobbyPlayerPadTop_C_InitializeContextEvents::CallFunc_GetContext_ReturnValue123' has a wrong offset!");
...
static_assert(offsetof(LobbyPlayerPadTop_C_RefreshReadyState, Temp_class_Variable1) == 0x000010, "Member 'LobbyPlayerPadTop_C_RefreshReadyState::Temp_class_Variable1' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadTop_C_RefreshReadyState, Temp_bool_Variable1) == 0x000018, "Member 'LobbyPlayerPadTop_C_RefreshReadyState::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(LobbyPlayerPadTop_C_RefreshReadyState, Temp_text_Variable1) == 0x000040, "Member 'LobbyPlayerPadTop_C_RefreshReadyState::Temp_text_Variable1' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadTop_C_RefreshReadyState, K2Node_Select1_Default) == 0x000058, "Member 'LobbyPlayerPadTop_C_RefreshReadyState::K2Node_Select1_Default' has a wrong offset!");
