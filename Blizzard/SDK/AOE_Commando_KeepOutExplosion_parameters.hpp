...
{
public:
	struct FSoundAttenuationSettings              CallFunc_BP_GetAttenuationSettingsToApply_OutAttenuationSettings; // 0x0000(0x02F0)()
	bool                                          CallFunc_BP_GetAttenuationSettingsToApply_ReturnValue; // 0x02F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_2F1[0x3];                                      // 0x02F1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CallFunc_MakeVector_ReturnValue;                   // 0x02F4(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSoundAttenuationSettings              K2Node_MakeStruct_SoundAttenuationSettings;        // 0x0300(0x02F0)()
};
...
static_assert(sizeof(AOE_Commando_KeepOutExplosion_C_OnRep_Radius) == 0x0005F0, "Wrong size on AOE_Commando_KeepOutExplosion_C_OnRep_Radius");
...
static_assert(offsetof(AOE_Commando_KeepOutExplosion_C_OnRep_Radius, CallFunc_BP_GetAttenuationSettingsToApply_ReturnValue) == 0x0002F0, "Member 'AOE_Commando_KeepOutExplosion_C_OnRep_Radius::CallFunc_BP_GetAttenuationSettingsToApply_ReturnValue' has a wrong offset!");
static_assert(offsetof(AOE_Commando_KeepOutExplosion_C_OnRep_Radius, CallFunc_MakeVector_ReturnValue) == 0x0002F4, "Member 'AOE_Commando_KeepOutExplosion_C_OnRep_Radius::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(AOE_Commando_KeepOutExplosion_C_OnRep_Radius, K2Node_MakeStruct_SoundAttenuationSettings) == 0x000300, "Member 'AOE_Commando_KeepOutExplosion_C_OnRep_Radius::K2Node_MakeStruct_SoundAttenuationSettings' has a wrong offset!");
