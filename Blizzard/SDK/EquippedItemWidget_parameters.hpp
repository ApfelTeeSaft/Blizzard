...
static_assert(offsetof(EquippedItemWidget_C_ExecuteUbergraph_EquippedItemWidget, CallFunc_IsValid_ReturnValue1) == 0x000021, "Member 'EquippedItemWidget_C_ExecuteUbergraph_EquippedItemWidget::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(EquippedItemWidget_C_ExecuteUbergraph_EquippedItemWidget, K2Node_DynamicCast_bSuccess1) == 0x000040, "Member 'EquippedItemWidget_C_ExecuteUbergraph_EquippedItemWidget::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
...
static_assert(offsetof(EquippedItemWidget_C_UpdateVisibility, K2Node_DynamicCast_bSuccess1) == 0x000028, "Member 'EquippedItemWidget_C_UpdateVisibility::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
...
public:
	...
	struct FLinearColor                           K2Node_Select1_Default;                            // 0x0058(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(EquippedItemWidget_C_UpdateWidgetColor, K2Node_Select1_Default) == 0x000058, "Member 'EquippedItemWidget_C_UpdateWidgetColor::K2Node_Select1_Default' has a wrong offset!");
...
public:
	...
	float                                         Temp_float_Variable12;                             // 0x0130(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_Select1_Default;                            // 0x0134(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Temp_float_Variable123;                            // 0x0138(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable12;                              // 0x013C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_13D[0x3];                                      // 0x013D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         K2Node_Select12_Default;                           // 0x0140(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(EquippedItemWidget_C_UpdateCurrentAmmo, Temp_float_Variable1) == 0x000128, "Member 'EquippedItemWidget_C_UpdateCurrentAmmo::Temp_float_Variable1' has a wrong offset!");
static_assert(offsetof(EquippedItemWidget_C_UpdateCurrentAmmo, Temp_bool_Variable1) == 0x00012C, "Member 'EquippedItemWidget_C_UpdateCurrentAmmo::Temp_bool_Variable1' has a wrong offset!");
static_assert(offsetof(EquippedItemWidget_C_UpdateCurrentAmmo, Temp_float_Variable12) == 0x000130, "Member 'EquippedItemWidget_C_UpdateCurrentAmmo::Temp_float_Variable12' has a wrong offset!");
static_assert(offsetof(EquippedItemWidget_C_UpdateCurrentAmmo, K2Node_Select1_Default) == 0x000134, "Member 'EquippedItemWidget_C_UpdateCurrentAmmo::K2Node_Select1_Default' has a wrong offset!");
static_assert(offsetof(EquippedItemWidget_C_UpdateCurrentAmmo, Temp_float_Variable123) == 0x000138, "Member 'EquippedItemWidget_C_UpdateCurrentAmmo::Temp_float_Variable123' has a wrong offset!");
static_assert(offsetof(EquippedItemWidget_C_UpdateCurrentAmmo, Temp_bool_Variable12) == 0x00013C, "Member 'EquippedItemWidget_C_UpdateCurrentAmmo::Temp_bool_Variable12' has a wrong offset!");
static_assert(offsetof(EquippedItemWidget_C_UpdateCurrentAmmo, K2Node_Select12_Default) == 0x000140, "Member 'EquippedItemWidget_C_UpdateCurrentAmmo::K2Node_Select12_Default' has a wrong offset!");
...
static_assert(offsetof(EquippedItemWidget_C_GetCurrentAmmoText, K2Node_MakeStruct_FormatArgumentData1) == 0x000078, "Member 'EquippedItemWidget_C_GetCurrentAmmoText::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
...
static_assert(offsetof(EquippedItemWidget_C_GetCurrentAmmoText, K2Node_MakeArray_Array1) == 0x0000D0, "Member 'EquippedItemWidget_C_GetCurrentAmmoText::K2Node_MakeArray_Array1' has a wrong offset!");
static_assert(offsetof(EquippedItemWidget_C_GetCurrentAmmoText, CallFunc_Format_ReturnValue1) == 0x0000E0, "Member 'EquippedItemWidget_C_GetCurrentAmmoText::CallFunc_Format_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(EquippedItemWidget_C_GetCurrentAmmoText, CallFunc_Less_IntInt_ReturnValue1) == 0x000110, "Member 'EquippedItemWidget_C_GetCurrentAmmoText::CallFunc_Less_IntInt_ReturnValue1' has a wrong offset!");
