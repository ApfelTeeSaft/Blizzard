...
static_assert(offsetof(BadgesEarnedPanelContent_C_ExecuteUbergraph_BadgesEarnedPanelContent, K2Node_CreateDelegate_OutputDelegate1) == 0x000028, "Member 'BadgesEarnedPanelContent_C_ExecuteUbergraph_BadgesEarnedPanelContent::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_ExecuteUbergraph_BadgesEarnedPanelContent, K2Node_CreateDelegate_OutputDelegate12) == 0x000038, "Member 'BadgesEarnedPanelContent_C_ExecuteUbergraph_BadgesEarnedPanelContent::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
...
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdateBadgeWidgets, CallFunc_Array_Length_ReturnValue1) == 0x000050, "Member 'BadgesEarnedPanelContent_C_UpdateBadgeWidgets::CallFunc_Array_Length_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdateBadgeWidgets, Temp_byte_Variable1) == 0x000061, "Member 'BadgesEarnedPanelContent_C_UpdateBadgeWidgets::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdateBadgeWidgets, K2Node_DynamicCast_AsFort_Player_Controller) == 0x000070, "Member 'BadgesEarnedPanelContent_C_UpdateBadgeWidgets::K2Node_DynamicCast_AsFort_Player_Controller' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdateBadgeWidgets, K2Node_DynamicCast_bSuccess) == 0x000078, "Member 'BadgesEarnedPanelContent_C_UpdateBadgeWidgets::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdateBadgeWidgets, CallFunc_Get_Badge_And_Count_For_Player_Found) == 0x000079, "Member 'BadgesEarnedPanelContent_C_UpdateBadgeWidgets::CallFunc_Get_Badge_And_Count_For_Player_Found' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdateBadgeWidgets, CallFunc_Get_Badge_And_Count_For_Player_FortPC) == 0x000080, "Member 'BadgesEarnedPanelContent_C_UpdateBadgeWidgets::CallFunc_Get_Badge_And_Count_For_Player_FortPC' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdateBadgeWidgets, CallFunc_Get_Badge_And_Count_For_Player_Badge) == 0x000088, "Member 'BadgesEarnedPanelContent_C_UpdateBadgeWidgets::CallFunc_Get_Badge_And_Count_For_Player_Badge' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdateBadgeWidgets, CallFunc_Get_Badge_And_Count_For_Player_Count) == 0x000090, "Member 'BadgesEarnedPanelContent_C_UpdateBadgeWidgets::CallFunc_Get_Badge_And_Count_For_Player_Count' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdateBadgeWidgets, Temp_bool_Variable) == 0x000094, "Member 'BadgesEarnedPanelContent_C_UpdateBadgeWidgets::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdateBadgeWidgets, CallFunc_Create_ReturnValue) == 0x000098, "Member 'BadgesEarnedPanelContent_C_UpdateBadgeWidgets::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdateBadgeWidgets, K2Node_Select_Default) == 0x0000A0, "Member 'BadgesEarnedPanelContent_C_UpdateBadgeWidgets::K2Node_Select_Default' has a wrong offset!");
...
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdatePotentialBadges, CallFunc_GetContext_ReturnValue) == 0x000008, "Member 'BadgesEarnedPanelContent_C_UpdatePotentialBadges::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdatePotentialBadges, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'BadgesEarnedPanelContent_C_UpdatePotentialBadges::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdatePotentialBadges, CallFunc_GetPotentialBadges_ReturnValue) == 0x000018, "Member 'BadgesEarnedPanelContent_C_UpdatePotentialBadges::CallFunc_GetPotentialBadges_ReturnValue' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdatePotentialBadges, Temp_int_Loop_Counter_Variable) == 0x000028, "Member 'BadgesEarnedPanelContent_C_UpdatePotentialBadges::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdatePotentialBadges, CallFunc_Array_Get_Item) == 0x000030, "Member 'BadgesEarnedPanelContent_C_UpdatePotentialBadges::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdatePotentialBadges, CallFunc_Add_IntInt_ReturnValue) == 0x000050, "Member 'BadgesEarnedPanelContent_C_UpdatePotentialBadges::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdatePotentialBadges, CallFunc_Array_Length_ReturnValue) == 0x000054, "Member 'BadgesEarnedPanelContent_C_UpdatePotentialBadges::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdatePotentialBadges, CallFunc_Create_ReturnValue) == 0x000058, "Member 'BadgesEarnedPanelContent_C_UpdatePotentialBadges::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdatePotentialBadges, CallFunc_Less_IntInt_ReturnValue) == 0x000060, "Member 'BadgesEarnedPanelContent_C_UpdatePotentialBadges::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_UpdatePotentialBadges, CallFunc_AddChildToVerticalBox_ReturnValue) == 0x000068, "Member 'BadgesEarnedPanelContent_C_UpdatePotentialBadges::CallFunc_AddChildToVerticalBox_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BadgesEarnedPanelContent_C_Get_Badge_And_Count_For_Player) == 0x0000D8, "Wrong size on BadgesEarnedPanelContent_C_Get_Badge_And_Count_For_Player");
...
static_assert(offsetof(BadgesEarnedPanelContent_C_Get_Badge_And_Count_For_Player, CallFunc_Less_IntInt_ReturnValue) == 0x0000A0, "Member 'BadgesEarnedPanelContent_C_Get_Badge_And_Count_For_Player::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_Get_Badge_And_Count_For_Player, CallFunc_BooleanAND_ReturnValue) == 0x0000A1, "Member 'BadgesEarnedPanelContent_C_Get_Badge_And_Count_For_Player::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_Get_Badge_And_Count_For_Player, CallFunc_Add_IntInt_ReturnValue) == 0x0000A4, "Member 'BadgesEarnedPanelContent_C_Get_Badge_And_Count_For_Player::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_Get_Badge_And_Count_For_Player, CallFunc_GetGameAccountId_ReturnValue) == 0x0000A8, "Member 'BadgesEarnedPanelContent_C_Get_Badge_And_Count_For_Player::CallFunc_GetGameAccountId_ReturnValue' has a wrong offset!");
static_assert(offsetof(BadgesEarnedPanelContent_C_Get_Badge_And_Count_For_Player, CallFunc_AreUniqueIDsIdentical_ReturnValue) == 0x0000D0, "Member 'BadgesEarnedPanelContent_C_Get_Badge_And_Count_For_Player::CallFunc_AreUniqueIDsIdentical_ReturnValue' has a wrong offset!");
