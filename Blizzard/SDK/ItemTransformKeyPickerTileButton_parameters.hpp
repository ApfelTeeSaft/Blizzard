...
static_assert(offsetof(ItemTransformKeyPickerTileButton_C_Update_Bang_State, CallFunc_HasBeenSeenLocally_ReturnValue1) == 0x000060, "Member 'ItemTransformKeyPickerTileButton_C_Update_Bang_State::CallFunc_HasBeenSeenLocally_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ItemTransformKeyPickerTileButton_C_Update_Bang_State, CallFunc_Not_PreBool_ReturnValue1) == 0x000061, "Member 'ItemTransformKeyPickerTileButton_C_Update_Bang_State::CallFunc_Not_PreBool_ReturnValue1' has a wrong offset!");
