...
static_assert(sizeof(ABluGloManager_C) == 0x0003F8, "Wrong size on ABluGloManager_C");
static_assert(offsetof(ABluGloManager_C, UberGraphFrame) == 0x000398, "Member 'ABluGloManager_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABluGloManager_C, DefaultSceneRoot) == 0x0003A0, "Member 'ABluGloManager_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(ABluGloManager_C, PossibleSpawnLocationsArray) == 0x0003A8, "Member 'ABluGloManager_C::PossibleSpawnLocationsArray' has a wrong offset!");
static_assert(offsetof(ABluGloManager_C, OccupiedNodes) == 0x0003B8, "Member 'ABluGloManager_C::OccupiedNodes' has a wrong offset!");
static_assert(offsetof(ABluGloManager_C, AmountOfBluGloToSpawn) == 0x0003C8, "Member 'ABluGloManager_C::AmountOfBluGloToSpawn' has a wrong offset!");
static_assert(offsetof(ABluGloManager_C, QueryActor) == 0x0003D0, "Member 'ABluGloManager_C::QueryActor' has a wrong offset!");
static_assert(offsetof(ABluGloManager_C, OnestRequestArraySet) == 0x0003D8, "Member 'ABluGloManager_C::OnestRequestArraySet' has a wrong offset!");
static_assert(offsetof(ABluGloManager_C, BluGloNavigablePointRadius) == 0x0003DC, "Member 'ABluGloManager_C::BluGloNavigablePointRadius' has a wrong offset!");
static_assert(offsetof(ABluGloManager_C, Reward_Start_Sound) == 0x0003E0, "Member 'ABluGloManager_C::Reward_Start_Sound' has a wrong offset!");
static_assert(offsetof(ABluGloManager_C, Reward_Appear_Sound) == 0x0003E8, "Member 'ABluGloManager_C::Reward_Appear_Sound' has a wrong offset!");
static_assert(offsetof(ABluGloManager_C, LocationLength) == 0x0003F0, "Member 'ABluGloManager_C::LocationLength' has a wrong offset!");
static_assert(offsetof(ABluGloManager_C, BluGloSpawnAnimationTime) == 0x0003F4, "Member 'ABluGloManager_C::BluGloSpawnAnimationTime' has a wrong offset!");
