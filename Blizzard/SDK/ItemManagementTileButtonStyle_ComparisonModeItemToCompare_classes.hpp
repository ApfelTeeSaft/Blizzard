...
static_assert(sizeof(UItemManagementTileButtonStyle_ComparisonModeItemToCompare_C) == 0x000470, "Wrong size on UItemManagementTileButtonStyle_ComparisonModeItemToCompare_C");
