...
public:
	...
	struct FPointerEvent                          K2Node_Event_MouseEvent1;                          // 0x00F0(0x0068)(ConstParm)
	struct FPointerEvent                          K2Node_Event_MouseEvent;                           // 0x0158(0x0068)(ConstParm)
};
...
static_assert(sizeof(SquadSlotGroup_C_ExecuteUbergraph_SquadSlotGroup) == 0x0001C0, "Wrong size on SquadSlotGroup_C_ExecuteUbergraph_SquadSlotGroup");
...
static_assert(offsetof(SquadSlotGroup_C_ExecuteUbergraph_SquadSlotGroup, K2Node_Event_MouseEvent1) == 0x0000F0, "Member 'SquadSlotGroup_C_ExecuteUbergraph_SquadSlotGroup::K2Node_Event_MouseEvent1' has a wrong offset!");
static_assert(offsetof(SquadSlotGroup_C_ExecuteUbergraph_SquadSlotGroup, K2Node_Event_MouseEvent) == 0x000158, "Member 'SquadSlotGroup_C_ExecuteUbergraph_SquadSlotGroup::K2Node_Event_MouseEvent' has a wrong offset!");
...
static_assert(sizeof(SquadSlotGroup_C_OnMouseLeave) == 0x000068, "Wrong size on SquadSlotGroup_C_OnMouseLeave");
...
static_assert(sizeof(SquadSlotGroup_C_OnMouseEnter) == 0x0000A0, "Wrong size on SquadSlotGroup_C_OnMouseEnter");
