...
public:
	...
	uint8                                         Pad_B9[0x18];                                      // 0x00B9(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UPartyGameState, bStayWithPartyOnDisconnect) == 0x0000D1, "Member 'UPartyGameState::bStayWithPartyOnDisconnect' has a wrong offset!");
static_assert(offsetof(UPartyGameState, PartyMemberStateClass) == 0x0000D8, "Member 'UPartyGameState::PartyMemberStateClass' has a wrong offset!");
static_assert(offsetof(UPartyGameState, ReservationBeaconClientClass) == 0x0001E8, "Member 'UPartyGameState::ReservationBeaconClientClass' has a wrong offset!");
static_assert(offsetof(UPartyGameState, ReservationBeaconClient) == 0x0001F0, "Member 'UPartyGameState::ReservationBeaconClient' has a wrong offset!");
