...
public:
	...
	struct FVector                                CallFunc_Subtract_VectorVector_ReturnValue;        // 0x0134(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FRotator                               CallFunc_FindLookAtRotation_ReturnValue;           // 0x0160(0x000C)(IsPlainOldData, NoDestructor)
...
static_assert(offsetof(GCN_GM_Vortex_Activate_C_ExecuteUbergraph_GCN_GM_Vortex_Activate, CallFunc_Subtract_VectorVector_ReturnValue) == 0x000134, "Member 'GCN_GM_Vortex_Activate_C_ExecuteUbergraph_GCN_GM_Vortex_Activate::CallFunc_Subtract_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_GM_Vortex_Activate_C_ExecuteUbergraph_GCN_GM_Vortex_Activate, CallFunc_SpawnEmitterAtLocation_ReturnValue) == 0x000140, "Member 'GCN_GM_Vortex_Activate_C_ExecuteUbergraph_GCN_GM_Vortex_Activate::CallFunc_SpawnEmitterAtLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_GM_Vortex_Activate_C_ExecuteUbergraph_GCN_GM_Vortex_Activate, CallFunc_VSize_ReturnValue) == 0x000148, "Member 'GCN_GM_Vortex_Activate_C_ExecuteUbergraph_GCN_GM_Vortex_Activate::CallFunc_VSize_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GCN_GM_Vortex_Activate_C_ExecuteUbergraph_GCN_GM_Vortex_Activate, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000150, "Member 'GCN_GM_Vortex_Activate_C_ExecuteUbergraph_GCN_GM_Vortex_Activate::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_GM_Vortex_Activate_C_ExecuteUbergraph_GCN_GM_Vortex_Activate, CallFunc_MakeVector_ReturnValue) == 0x000154, "Member 'GCN_GM_Vortex_Activate_C_ExecuteUbergraph_GCN_GM_Vortex_Activate::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_GM_Vortex_Activate_C_ExecuteUbergraph_GCN_GM_Vortex_Activate, CallFunc_FindLookAtRotation_ReturnValue) == 0x000160, "Member 'GCN_GM_Vortex_Activate_C_ExecuteUbergraph_GCN_GM_Vortex_Activate::CallFunc_FindLookAtRotation_ReturnValue' has a wrong offset!");
