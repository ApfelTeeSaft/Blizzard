...
static_assert(offsetof(AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget, CallFunc_GetOwningPlayer_ReturnValue1) == 0x000048, "Member 'AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget::CallFunc_GetOwningPlayer_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget, CallFunc_GetOwningPlayer_ReturnValue12) == 0x000050, "Member 'AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget::CallFunc_GetOwningPlayer_ReturnValue12' has a wrong offset!");
static_assert(offsetof(AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget, CallFunc_Create_ReturnValue1) == 0x000058, "Member 'AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget::CallFunc_Create_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget, CallFunc_Create_ReturnValue12) == 0x000060, "Member 'AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget::CallFunc_Create_ReturnValue12' has a wrong offset!");
static_assert(offsetof(AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget, CallFunc_AddChildToVerticalBox_ReturnValue1) == 0x000068, "Member 'AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget::CallFunc_AddChildToVerticalBox_ReturnValue1' has a wrong offset!");
static_assert(offsetof(AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget, CallFunc_AddChildToVerticalBox_ReturnValue12) == 0x000070, "Member 'AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget::CallFunc_AddChildToVerticalBox_ReturnValue12' has a wrong offset!");
static_assert(offsetof(AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget, CallFunc_AddChildToVerticalBox_ReturnValue123) == 0x000078, "Member 'AlterationsWidget_C_ExecuteUbergraph_AlterationsWidget::CallFunc_AddChildToVerticalBox_ReturnValue123' has a wrong offset!");
