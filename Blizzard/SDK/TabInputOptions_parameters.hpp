...
public:
	...
	int32                                         K2Node_CustomEvent_Number_In_List1;                // 0x0018(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UOptionsMenuInput_C*                    K2Node_DynamicCast_AsOptions_Menu_Input1;          // 0x0050(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	ESlateVisibility                              Temp_byte_Variable12;                              // 0x007A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESlateVisibility                              Temp_byte_Variable123;                             // 0x007B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Not_PreBool_ReturnValue1;                 // 0x007C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	ESlateVisibility                              K2Node_Select1_Default;                            // 0x009C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(TabInputOptions_C_ExecuteUbergraph_TabInputOptions, K2Node_CustomEvent_Number_In_List1) == 0x000018, "Member 'TabInputOptions_C_ExecuteUbergraph_TabInputOptions::K2Node_CustomEvent_Number_In_List1' has a wrong offset!");
...
static_assert(offsetof(TabInputOptions_C_ExecuteUbergraph_TabInputOptions, Temp_byte_Variable1) == 0x00001D, "Member 'TabInputOptions_C_ExecuteUbergraph_TabInputOptions::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(TabInputOptions_C_ExecuteUbergraph_TabInputOptions, K2Node_DynamicCast_AsOptions_Menu_Input1) == 0x000050, "Member 'TabInputOptions_C_ExecuteUbergraph_TabInputOptions::K2Node_DynamicCast_AsOptions_Menu_Input1' has a wrong offset!");
static_assert(offsetof(TabInputOptions_C_ExecuteUbergraph_TabInputOptions, K2Node_DynamicCast_bSuccess1) == 0x000058, "Member 'TabInputOptions_C_ExecuteUbergraph_TabInputOptions::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
...
static_assert(offsetof(TabInputOptions_C_ExecuteUbergraph_TabInputOptions, Temp_byte_Variable12) == 0x00007A, "Member 'TabInputOptions_C_ExecuteUbergraph_TabInputOptions::Temp_byte_Variable12' has a wrong offset!");
static_assert(offsetof(TabInputOptions_C_ExecuteUbergraph_TabInputOptions, Temp_byte_Variable123) == 0x00007B, "Member 'TabInputOptions_C_ExecuteUbergraph_TabInputOptions::Temp_byte_Variable123' has a wrong offset!");
static_assert(offsetof(TabInputOptions_C_ExecuteUbergraph_TabInputOptions, CallFunc_Not_PreBool_ReturnValue1) == 0x00007C, "Member 'TabInputOptions_C_ExecuteUbergraph_TabInputOptions::CallFunc_Not_PreBool_ReturnValue1' has a wrong offset!");
static_assert(offsetof(TabInputOptions_C_ExecuteUbergraph_TabInputOptions, Temp_bool_Variable1) == 0x00007D, "Member 'TabInputOptions_C_ExecuteUbergraph_TabInputOptions::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(TabInputOptions_C_ExecuteUbergraph_TabInputOptions, K2Node_Select1_Default) == 0x00009C, "Member 'TabInputOptions_C_ExecuteUbergraph_TabInputOptions::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(TabInputOptions_C_ExecuteUbergraph_TabInputOptions, K2Node_CreateDelegate_OutputDelegate1) == 0x0000B8, "Member 'TabInputOptions_C_ExecuteUbergraph_TabInputOptions::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
public:
	...
	class UWidget*                                CallFunc_GetListWidget_ReturnValue;                // 0x0020(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
