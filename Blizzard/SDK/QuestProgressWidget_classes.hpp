...
static_assert(sizeof(UQuestProgressWidget_C) == 0x000220, "Wrong size on UQuestProgressWidget_C");
static_assert(offsetof(UQuestProgressWidget_C, _ProgressBar__Quest_Progress) == 0x000210, "Member 'UQuestProgressWidget_C::_ProgressBar__Quest_Progress' has a wrong offset!");
static_assert(offsetof(UQuestProgressWidget_C, ProgressValue) == 0x000218, "Member 'UQuestProgressWidget_C::ProgressValue' has a wrong offset!");
