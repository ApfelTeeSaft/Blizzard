...
static_assert(offsetof(AVaultCharacterPlacementHelper_C, UberGraphFrame) == 0x000318, "Member 'AVaultCharacterPlacementHelper_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AVaultCharacterPlacementHelper_C, Floor) == 0x000320, "Member 'AVaultCharacterPlacementHelper_C::Floor' has a wrong offset!");
static_assert(offsetof(AVaultCharacterPlacementHelper_C, CharacterPlacement) == 0x000328, "Member 'AVaultCharacterPlacementHelper_C::CharacterPlacement' has a wrong offset!");
static_assert(offsetof(AVaultCharacterPlacementHelper_C, Root) == 0x000330, "Member 'AVaultCharacterPlacementHelper_C::Root' has a wrong offset!");
static_assert(offsetof(AVaultCharacterPlacementHelper_C, NewEventDispatcher_0) == 0x000338, "Member 'AVaultCharacterPlacementHelper_C::NewEventDispatcher_0' has a wrong offset!");
