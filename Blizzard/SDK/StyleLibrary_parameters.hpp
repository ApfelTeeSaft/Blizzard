...
public:
	...
	struct FSlateBrush                            CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue; // 0x0A18(0x0078)(ConstParm)
};
...
public:
	...
	struct FLinearColor                           Temp_struct_Variable1;                             // 0x0AA4(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           Temp_struct_Variable12;                            // 0x0AB4(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EFortBuffState                                Temp_byte_Variable1;                               // 0x0AC4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                           K2Node_Select1_Default;                            // 0x0AD8(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(StyleLibrary_C_Get_Base___Buff_Colors, Temp_struct_Variable1) == 0x000AA4, "Member 'StyleLibrary_C_Get_Base___Buff_Colors::Temp_struct_Variable1' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Base___Buff_Colors, Temp_struct_Variable12) == 0x000AB4, "Member 'StyleLibrary_C_Get_Base___Buff_Colors::Temp_struct_Variable12' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Base___Buff_Colors, Temp_byte_Variable1) == 0x000AC4, "Member 'StyleLibrary_C_Get_Base___Buff_Colors::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(StyleLibrary_C_Get_Base___Buff_Colors, K2Node_Select1_Default) == 0x000AD8, "Member 'StyleLibrary_C_Get_Base___Buff_Colors::K2Node_Select1_Default' has a wrong offset!");
...
public:
	...
	int32                                         MultipleGreenHexIndexOffset;                       // 0x013C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         GreenBottomArrayElementIndex;                      // 0x0140(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Content_DL_In;                                     // 0x0144(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                   DifficultyColorName;                               // 0x0148(0x0018)(Edit, BlueprintVisible)
	class FText                                   ConningTooltipText;                                // 0x0160(0x0018)(Edit, BlueprintVisible)
	int32                                         Content_SP;                                        // 0x0178(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Valid;                                             // 0x017C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_17D[0x3];                                      // 0x017D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Player_Skill_Level_In;                             // 0x0180(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_184[0x4];                                      // 0x0184(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<float>                                 SPCutoffValues;                                    // 0x0188(0x0010)(Edit, BlueprintVisible, ZeroConstructor)
	int32                                         Stonewood_VLT_Skill_Level;                         // 0x0198(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           DifficultyColor;                                   // 0x019C(0x0010)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         BucketOffsetValue;                                 // 0x01AC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                   CallFunc_Array_Get_Item;                           // 0x01B0(0x0018)()
	class FText                                   CallFunc_Array_Get_Item1;                          // 0x01C8(0x0018)()
	struct FLinearColor                           CallFunc_Array_Get_Item12;                         // 0x01E0(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<float>                                 K2Node_MakeArray_Array;                            // 0x01F0(0x0010)(ZeroConstructor, ReferenceParm)
	...
	int32                                         CallFunc_Array_Get_Item1234;                       // 0x024C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Array_Get_Item12345;                      // 0x0250(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	EEvaluateCurveTableResult                     CallFunc_EvaluateCurveTableRow_OutResult;          // 0x0268(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          Temp_bool_True_if_break_was_hit_Variable;          // 0x0271(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TArray<class FText>                           K2Node_MakeArray_Array12345;                       // 0x0290(0x0010)(ZeroConstructor, ReferenceParm)
};
...
static_assert(sizeof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value) == 0x0002A0, "Wrong size on StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value");
...
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, Content_Skill_Points) == 0x0000A0, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::Content_Skill_Points' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, __WorldContext) == 0x0000A8, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::__WorldContext' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, Difficulty_Linear_Color) == 0x0000B0, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::Difficulty_Linear_Color' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, Success) == 0x0000C0, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::Success' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, ToolTipText) == 0x0000C8, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::ToolTipText' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, DifficultyValue) == 0x0000E0, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::DifficultyValue' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, DifficultyColorNames) == 0x0000E8, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::DifficultyColorNames' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, DifficultyTooltips) == 0x0000F8, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::DifficultyTooltips' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, DifficultyIndices) == 0x000108, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::DifficultyIndices' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, DifficultyColors) == 0x000118, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::DifficultyColors' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, RowNames) == 0x000128, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::RowNames' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, DifficultyOut) == 0x000138, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::DifficultyOut' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, MultipleGreenHexIndexOffset) == 0x00013C, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::MultipleGreenHexIndexOffset' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, GreenBottomArrayElementIndex) == 0x000140, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::GreenBottomArrayElementIndex' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, Content_DL_In) == 0x000144, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::Content_DL_In' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, DifficultyColorName) == 0x000148, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::DifficultyColorName' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, ConningTooltipText) == 0x000160, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::ConningTooltipText' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, Content_SP) == 0x000178, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::Content_SP' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, Valid) == 0x00017C, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::Valid' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, Player_Skill_Level_In) == 0x000180, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::Player_Skill_Level_In' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, SPCutoffValues) == 0x000188, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::SPCutoffValues' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, Stonewood_VLT_Skill_Level) == 0x000198, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::Stonewood_VLT_Skill_Level' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, DifficultyColor) == 0x00019C, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::DifficultyColor' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, BucketOffsetValue) == 0x0001AC, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::BucketOffsetValue' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_Array_Get_Item) == 0x0001B0, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_Array_Get_Item1) == 0x0001C8, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_Array_Get_Item1' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_Array_Get_Item12) == 0x0001E0, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_Array_Get_Item12' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, K2Node_MakeArray_Array) == 0x0001F0, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000200, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, Temp_int_Loop_Counter_Variable) == 0x000204, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_Add_IntInt_ReturnValue) == 0x000208, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, Temp_int_Variable) == 0x00020C, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::Temp_int_Variable' has a wrong offset!");
...
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000228, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_Add_IntInt_ReturnValue1) == 0x00022C, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_Add_IntInt_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_Array_Length_ReturnValue) == 0x000240, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, Temp_int_Array_Index_Variable) == 0x000244, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_Less_IntInt_ReturnValue) == 0x000248, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_Array_Get_Item1234) == 0x00024C, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_Array_Get_Item1234' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_Array_Get_Item12345) == 0x000250, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_Array_Get_Item12345' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_Greater_FloatFloat_ReturnValue) == 0x000254, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_Greater_FloatFloat_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_EvaluateCurveTableRow_OutResult) == 0x000268, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_EvaluateCurveTableRow_OutResult' has a wrong offset!");
...
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, Temp_bool_True_if_break_was_hit_Variable) == 0x000271, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::Temp_bool_True_if_break_was_hit_Variable' has a wrong offset!");
...
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_Not_PreBool_ReturnValue) == 0x000288, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, CallFunc_BooleanAND_ReturnValue) == 0x000289, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value, K2Node_MakeArray_Array12345) == 0x000290, "Member 'StyleLibrary_C_Get_Conning_Color_From_Difficulty_Value::K2Node_MakeArray_Array12345' has a wrong offset!");
