...
static_assert(offsetof(SquadStatsWidget_C_ExecuteUbergraph_SquadStatsWidget, K2Node_ComponentBoundEvent_Button1) == 0x000008, "Member 'SquadStatsWidget_C_ExecuteUbergraph_SquadStatsWidget::K2Node_ComponentBoundEvent_Button1' has a wrong offset!");
...
static_assert(sizeof(SquadStatsWidget_C_BindToAttributeChanges) == 0x000098, "Wrong size on SquadStatsWidget_C_BindToAttributeChanges");
...
static_assert(offsetof(SquadStatsWidget_C_BindToAttributeChanges, CallFunc_GetContext_ReturnValue) == 0x000008, "Member 'SquadStatsWidget_C_BindToAttributeChanges::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_BindToAttributeChanges, Temp_int_Loop_Counter_Variable) == 0x000010, "Member 'SquadStatsWidget_C_BindToAttributeChanges::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_BindToAttributeChanges, CallFunc_Add_IntInt_ReturnValue) == 0x000014, "Member 'SquadStatsWidget_C_BindToAttributeChanges::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(SquadStatsWidget_C_BindToAttributeChanges, CallFunc_GetContext_ReturnValue1) == 0x000040, "Member 'SquadStatsWidget_C_BindToAttributeChanges::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(SquadStatsWidget_C_BindToAttributeChanges, CallFunc_IsValid_ReturnValue) == 0x000088, "Member 'SquadStatsWidget_C_BindToAttributeChanges::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_BindToAttributeChanges, CallFunc_Array_Length_ReturnValue) == 0x00008C, "Member 'SquadStatsWidget_C_BindToAttributeChanges::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(SquadStatsWidget_C_BindToAttributeChanges, CallFunc_Less_IntInt_ReturnValue) == 0x000090, "Member 'SquadStatsWidget_C_BindToAttributeChanges::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
