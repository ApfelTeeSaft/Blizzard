...
static_assert(alignof(AGCNL_GM_OnDmg_SpeedBuff_C) == 0x000010, "Wrong alignment on AGCNL_GM_OnDmg_SpeedBuff_C");
static_assert(sizeof(AGCNL_GM_OnDmg_SpeedBuff_C) == 0x000440, "Wrong size on AGCNL_GM_OnDmg_SpeedBuff_C");
