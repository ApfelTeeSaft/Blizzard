...
static_assert(sizeof(URotatingStarburstWidget_C) == 0x000220, "Wrong size on URotatingStarburstWidget_C");
static_assert(offsetof(URotatingStarburstWidget_C, UberGraphFrame) == 0x000208, "Member 'URotatingStarburstWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(URotatingStarburstWidget_C, Image_0) == 0x000210, "Member 'URotatingStarburstWidget_C::Image_0' has a wrong offset!");
static_assert(offsetof(URotatingStarburstWidget_C, rotationSpeed) == 0x000218, "Member 'URotatingStarburstWidget_C::rotationSpeed' has a wrong offset!");
