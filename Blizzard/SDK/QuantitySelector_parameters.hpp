...
static_assert(sizeof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector) == 0x000088, "Wrong size on QuantitySelector_C_ExecuteUbergraph_QuantitySelector");
...
static_assert(offsetof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector, CallFunc_IsUsingGamepad_ReturnValue) == 0x000068, "Member 'QuantitySelector_C_ExecuteUbergraph_QuantitySelector::CallFunc_IsUsingGamepad_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(QuantitySelector_C_ExecuteUbergraph_QuantitySelector, CallFunc_IsBROnly_ReturnValue) == 0x000080, "Member 'QuantitySelector_C_ExecuteUbergraph_QuantitySelector::CallFunc_IsBROnly_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(QuantitySelector_C_SetupForInputMode, CallFunc_IsBROnly_ReturnValue) == 0x000001, "Member 'QuantitySelector_C_SetupForInputMode::CallFunc_IsBROnly_ReturnValue' has a wrong offset!");
