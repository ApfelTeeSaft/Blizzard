...
public:
	...
	struct FLinearColor                           K2Node_Select1_Default;                            // 0x002C(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(PotentialResourceWidget_C_SetupFont, Temp_bool_Variable1) == 0x000024, "Member 'PotentialResourceWidget_C_SetupFont::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(PotentialResourceWidget_C_SetupFont, K2Node_Select1_Default) == 0x00002C, "Member 'PotentialResourceWidget_C_SetupFont::K2Node_Select1_Default' has a wrong offset!");
