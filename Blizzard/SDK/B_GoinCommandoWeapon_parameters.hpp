...
public:
	...
	struct FTransform                             Temp_struct_Variable;                              // 0x0B40(0x0030)(ConstParm, IsPlainOldData, NoDestructor)
	class UParticleSystemComponent*               CallFunc_AddComponent_ReturnValue;                 // 0x0B70(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             K2Node_Event_HitResult;                            // 0x0BB8(0x0088)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	EPhysicalSurface                              K2Node_Event_ImpactPhysicalSurface;                // 0x0C40(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_C41[0x7];                                      // 0x0C41(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UParticleSystemComponent*               K2Node_Event_SpawnedPSC;                           // 0x0C48(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(B_GoinCommandoWeapon_C_ExecuteUbergraph_B_GoinCommandoWeapon, K2Node_Event_ImpactPhysicalSurface) == 0x000C40, "Member 'B_GoinCommandoWeapon_C_ExecuteUbergraph_B_GoinCommandoWeapon::K2Node_Event_ImpactPhysicalSurface' has a wrong offset!");
static_assert(offsetof(B_GoinCommandoWeapon_C_ExecuteUbergraph_B_GoinCommandoWeapon, K2Node_Event_SpawnedPSC) == 0x000C48, "Member 'B_GoinCommandoWeapon_C_ExecuteUbergraph_B_GoinCommandoWeapon::K2Node_Event_SpawnedPSC' has a wrong offset!");
