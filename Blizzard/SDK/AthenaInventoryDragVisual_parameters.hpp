...
static_assert(offsetof(AthenaInventoryDragVisual_C_ShowDropIcon, Temp_byte_Variable1) == 0x000030, "Member 'AthenaInventoryDragVisual_C_ShowDropIcon::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(AthenaInventoryDragVisual_C_ShowDropIcon, Temp_byte_Variable12) == 0x000031, "Member 'AthenaInventoryDragVisual_C_ShowDropIcon::Temp_byte_Variable12' has a wrong offset!");
static_assert(offsetof(AthenaInventoryDragVisual_C_ShowDropIcon, K2Node_Select1_Default) == 0x000032, "Member 'AthenaInventoryDragVisual_C_ShowDropIcon::K2Node_Select1_Default' has a wrong offset!");
