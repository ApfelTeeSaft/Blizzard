...
static_assert(sizeof(HitPointBar_C_ExecuteUbergraph_HitPointBar) == 0x000088, "Wrong size on HitPointBar_C_ExecuteUbergraph_HitPointBar");
...
static_assert(sizeof(HitPointBar_C_Tick) == 0x00003C, "Wrong size on HitPointBar_C_Tick");
static_assert(offsetof(HitPointBar_C_Tick, MyGeometry) == 0x000000, "Member 'HitPointBar_C_Tick::MyGeometry' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_Tick, InDeltaTime) == 0x000038, "Member 'HitPointBar_C_Tick::InDeltaTime' has a wrong offset!");
...
static_assert(offsetof(HitPointBar_C_Update_Fill_Bar, CallFunc_FMax_ReturnValue1) == 0x00002C, "Member 'HitPointBar_C_Update_Fill_Bar::CallFunc_FMax_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(HitPointBar_C_Update_Fill_Bar, CallFunc_Multiply_FloatFloat_ReturnValue1) == 0x000034, "Member 'HitPointBar_C_Update_Fill_Bar::CallFunc_Multiply_FloatFloat_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(HitPointBar_C_Update_Fill_Bar, CallFunc_Divide_FloatFloat_ReturnValue1) == 0x00003C, "Member 'HitPointBar_C_Update_Fill_Bar::CallFunc_Divide_FloatFloat_ReturnValue1' has a wrong offset!");
...
static_assert(alignof(HitPointBar_C_SetInitialValues) == 0x000008, "Wrong alignment on HitPointBar_C_SetInitialValues");
static_assert(sizeof(HitPointBar_C_SetInitialValues) == 0x000050, "Wrong size on HitPointBar_C_SetInitialValues");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetContext_ReturnValue) == 0x000000, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_IsValid_ReturnValue) == 0x000008, "Member 'HitPointBar_C_SetInitialValues::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, K2Node_SwitchEnum_CmpSuccess) == 0x000009, "Member 'HitPointBar_C_SetInitialValues::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetPlayerController_ReturnValue) == 0x000010, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_K2_GetPawn_ReturnValue) == 0x000018, "Member 'HitPointBar_C_SetInitialValues::CallFunc_K2_GetPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_IsValid_ReturnValue1) == 0x000020, "Member 'HitPointBar_C_SetInitialValues::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, K2Node_DynamicCast_AsFort_Player_Pawn) == 0x000028, "Member 'HitPointBar_C_SetInitialValues::K2Node_DynamicCast_AsFort_Player_Pawn' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, K2Node_DynamicCast_bSuccess) == 0x000030, "Member 'HitPointBar_C_SetInitialValues::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetShield_ReturnValue) == 0x000034, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetShield_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetMaxShield_ReturnValue) == 0x000038, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetMaxShield_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetMaxStamina_ReturnValue) == 0x00003C, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetMaxStamina_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetStamina_ReturnValue) == 0x000040, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetStamina_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetMaxHealth_ReturnValue) == 0x000044, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetMaxHealth_ReturnValue' has a wrong offset!");
static_assert(offsetof(HitPointBar_C_SetInitialValues, CallFunc_GetHealth_ReturnValue) == 0x000048, "Member 'HitPointBar_C_SetInitialValues::CallFunc_GetHealth_ReturnValue' has a wrong offset!");
