...
static_assert(offsetof(MainTabTutorialBangWrapper_C_ExecuteUbergraph_MainTabTutorialBangWrapper, CallFunc_GetContext_ReturnValue1) == 0x000038, "Member 'MainTabTutorialBangWrapper_C_ExecuteUbergraph_MainTabTutorialBangWrapper::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(MainTabTutorialBangWrapper_C_ExecuteUbergraph_MainTabTutorialBangWrapper, CallFunc_EqualEqual_ByteByte_ReturnValue1) == 0x000044, "Member 'MainTabTutorialBangWrapper_C_ExecuteUbergraph_MainTabTutorialBangWrapper::CallFunc_EqualEqual_ByteByte_ReturnValue1' has a wrong offset!");
static_assert(offsetof(MainTabTutorialBangWrapper_C_ExecuteUbergraph_MainTabTutorialBangWrapper, Temp_byte_Variable1) == 0x000045, "Member 'MainTabTutorialBangWrapper_C_ExecuteUbergraph_MainTabTutorialBangWrapper::Temp_byte_Variable1' has a wrong offset!");
