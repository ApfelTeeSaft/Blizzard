...
public:
	...
	class FString                                 Temp_string_Variable1234;                          // 0x0048(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 Temp_string_Variable12345;                         // 0x0058(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 Temp_string_Variable123456;                        // 0x0068(0x0010)(ZeroConstructor, HasGetValueTypeHash)
...
static_assert(offsetof(Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge, Temp_string_Variable1) == 0x000018, "Member 'Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge::Temp_string_Variable1' has a wrong offset!");
static_assert(offsetof(Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge, Temp_string_Variable12) == 0x000028, "Member 'Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge::Temp_string_Variable12' has a wrong offset!");
static_assert(offsetof(Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge, Temp_string_Variable123) == 0x000038, "Member 'Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge::Temp_string_Variable123' has a wrong offset!");
static_assert(offsetof(Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge, Temp_string_Variable1234) == 0x000048, "Member 'Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge::Temp_string_Variable1234' has a wrong offset!");
static_assert(offsetof(Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge, Temp_string_Variable12345) == 0x000058, "Member 'Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge::Temp_string_Variable12345' has a wrong offset!");
static_assert(offsetof(Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge, Temp_string_Variable123456) == 0x000068, "Member 'Results_SummaryBadge_C_ExecuteUbergraph_Results_SummaryBadge::Temp_string_Variable123456' has a wrong offset!");
