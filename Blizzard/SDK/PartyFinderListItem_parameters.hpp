...
public:
	...
	struct FUniqueNetIdRepl                       CallFunc_GetUniquePlayerId_ReturnValue;            // 0x0030(0x0028)(HasGetValueTypeHash)
...
static_assert(sizeof(PartyFinderListItem_C_InitializeItem) == 0x000060, "Wrong size on PartyFinderListItem_C_InitializeItem");
...
static_assert(offsetof(PartyFinderListItem_C_InitializeItem, K2Node_SwitchEnum_CmpSuccess) == 0x000058, "Member 'PartyFinderListItem_C_InitializeItem::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
...
static_assert(offsetof(PartyFinderListItem_C_SetupExpansion, Temp_float_Variable1) == 0x000008, "Member 'PartyFinderListItem_C_SetupExpansion::Temp_float_Variable1' has a wrong offset!");
...
static_assert(offsetof(PartyFinderListItem_C_UpdateStateText, Temp_text_Variable1) == 0x000018, "Member 'PartyFinderListItem_C_UpdateStateText::Temp_text_Variable1' has a wrong offset!");
static_assert(offsetof(PartyFinderListItem_C_UpdateStateText, Temp_text_Variable12) == 0x000030, "Member 'PartyFinderListItem_C_UpdateStateText::Temp_text_Variable12' has a wrong offset!");
static_assert(offsetof(PartyFinderListItem_C_UpdateStateText, Temp_text_Variable123) == 0x000048, "Member 'PartyFinderListItem_C_UpdateStateText::Temp_text_Variable123' has a wrong offset!");
static_assert(offsetof(PartyFinderListItem_C_UpdateStateText, Temp_text_Variable1234) == 0x000060, "Member 'PartyFinderListItem_C_UpdateStateText::Temp_text_Variable1234' has a wrong offset!");
static_assert(offsetof(PartyFinderListItem_C_UpdateStateText, Temp_text_Variable12345) == 0x000078, "Member 'PartyFinderListItem_C_UpdateStateText::Temp_text_Variable12345' has a wrong offset!");
static_assert(offsetof(PartyFinderListItem_C_UpdateStateText, Temp_text_Variable123456) == 0x000090, "Member 'PartyFinderListItem_C_UpdateStateText::Temp_text_Variable123456' has a wrong offset!");
static_assert(offsetof(PartyFinderListItem_C_UpdateStateText, Temp_text_Variable1234567) == 0x0000A8, "Member 'PartyFinderListItem_C_UpdateStateText::Temp_text_Variable1234567' has a wrong offset!");
static_assert(offsetof(PartyFinderListItem_C_UpdateStateText, Temp_text_Variable12345678) == 0x0000C0, "Member 'PartyFinderListItem_C_UpdateStateText::Temp_text_Variable12345678' has a wrong offset!");
...
static_assert(sizeof(PartyFinderListItem_C_UnbindSocialItemDelegates) == 0x000018, "Wrong size on PartyFinderListItem_C_UnbindSocialItemDelegates");
...
static_assert(offsetof(PartyFinderListItem_C_UnbindSocialItemDelegates, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'PartyFinderListItem_C_UnbindSocialItemDelegates::CallFunc_IsValid_ReturnValue' has a wrong offset!");
