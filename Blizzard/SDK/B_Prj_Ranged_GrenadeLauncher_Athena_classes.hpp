...
static_assert(sizeof(AB_Prj_Ranged_GrenadeLauncher_Athena_C) == 0x000910, "Wrong size on AB_Prj_Ranged_GrenadeLauncher_Athena_C");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, UberGraphFrame) == 0x000790, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, Mesh) == 0x000798, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::Mesh' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, RibbonTrail_PS) == 0x0007A0, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::RibbonTrail_PS' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, RibbonTrail_PSC) == 0x0007A8, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::RibbonTrail_PSC' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, TrailLifetime) == 0x0007B0, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::TrailLifetime' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, WaterPhysMat) == 0x0007B4, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::WaterPhysMat' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, Bounce_WaterSplash_PS) == 0x0007B8, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::Bounce_WaterSplash_PS' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, WaterSplash_PSC) == 0x0007C0, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::WaterSplash_PSC' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, Bounce_Generic_PSC) == 0x0007C8, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::Bounce_Generic_PSC' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, Bounce_Generic_PS) == 0x0007D0, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::Bounce_Generic_PS' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, Explosion_PS) == 0x0007D8, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::Explosion_PS' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, Explosion_PSC) == 0x0007E0, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::Explosion_PSC' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, StopLocation) == 0x0007E8, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::StopLocation' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, ObjectsToTraceAgainst) == 0x0007F8, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::ObjectsToTraceAgainst' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, StopRotX) == 0x000808, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::StopRotX' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, Grenade_Explosion_Sound) == 0x000818, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::Grenade_Explosion_Sound' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, Explosion_Flesh_Damage_PS) == 0x000820, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::Explosion_Flesh_Damage_PS' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, Explosion_Water_PS) == 0x000828, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::Explosion_Water_PS' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, Explosion_Water_PSC) == 0x000830, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::Explosion_Water_PSC' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, SpawnBounceFXHitActor) == 0x000838, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::SpawnBounceFXHitActor' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, OnBounceHitResult) == 0x000840, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::OnBounceHitResult' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, FuseTimer_Spawn) == 0x0008C8, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::FuseTimer_Spawn' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, FuseTimerAfterBounce) == 0x0008CC, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::FuseTimerAfterBounce' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, WaterLandDelayRipplePSC) == 0x0008D0, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::WaterLandDelayRipplePSC' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, WaterLandDelayPS) == 0x0008D8, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::WaterLandDelayPS' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, GrenadeInWaterLocation) == 0x0008E0, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::GrenadeInWaterLocation' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, Grenade_Explosion_Water_Sound) == 0x0008E8, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::Grenade_Explosion_Water_Sound' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, StopSurfaceType) == 0x0008F0, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::StopSurfaceType' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, StopRotZ) == 0x0008F4, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::StopRotZ' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, ExplosionForceFeedbackNear) == 0x000900, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::ExplosionForceFeedbackNear' has a wrong offset!");
static_assert(offsetof(AB_Prj_Ranged_GrenadeLauncher_Athena_C, ExplosionForceFeedbackFar) == 0x000908, "Member 'AB_Prj_Ranged_GrenadeLauncher_Athena_C::ExplosionForceFeedbackFar' has a wrong offset!");
