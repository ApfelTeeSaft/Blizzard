...
struct FTransform UARBlueprintLibrary::GetLocalToTrackingTransform(const struct FARTraceResult& TraceResult)
{
	static class UFunction* Func = nullptr;
...
struct FTransform UARBlueprintLibrary::GetLocalToWorldTransform(const struct FARTraceResult& TraceResult)
{
	static class UFunction* Func = nullptr;
...
class UARTrackedGeometry* UARBlueprintLibrary::GetTrackedGeometry(const struct FARTraceResult& TraceResult)
{
	static class UFunction* Func = nullptr;
...
TArray<struct FARTraceResult> UARBlueprintLibrary::LineTraceTrackedObjects(const struct FVector2D& ScreenCoord)
{
	static class UFunction* Func = nullptr;
