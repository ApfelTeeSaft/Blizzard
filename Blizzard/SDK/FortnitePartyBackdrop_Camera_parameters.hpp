...
public:
	...
	TArray<class ABP_FortniteLobbyLightSwitcher_C*> CallFunc_GetAllActorsOfClass_OutActors12;        // 0x0058(0x0010)(ZeroConstructor, ReferenceParm)
...
static_assert(sizeof(FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera) == 0x000088, "Wrong size on FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera");
...
static_assert(offsetof(FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera, CallFunc_GetAllActorsOfClass_OutActors) == 0x000008, "Member 'FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera::CallFunc_GetAllActorsOfClass_OutActors' has a wrong offset!");
static_assert(offsetof(FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera, CallFunc_GetTimeOfDayManagerFromContext_ReturnValue) == 0x000018, "Member 'FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera::CallFunc_GetTimeOfDayManagerFromContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera, CallFunc_Array_Get_Item) == 0x000020, "Member 'FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera, Temp_int_Array_Index_Variable) == 0x000028, "Member 'FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera, Temp_int_Loop_Counter_Variable) == 0x00002C, "Member 'FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera, CallFunc_Add_IntInt_ReturnValue) == 0x000030, "Member 'FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera, Temp_int_Array_Index_Variable1) == 0x000034, "Member 'FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera::Temp_int_Array_Index_Variable1' has a wrong offset!");
...
static_assert(offsetof(FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera, CallFunc_GetAllActorsOfClass_OutActors12) == 0x000058, "Member 'FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera::CallFunc_GetAllActorsOfClass_OutActors12' has a wrong offset!");
...
static_assert(offsetof(FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera, CallFunc_Array_Get_Item12) == 0x000070, "Member 'FortnitePartyBackdrop_Camera_C_ExecuteUbergraph_FortnitePartyBackdrop_Camera::CallFunc_Array_Get_Item12' has a wrong offset!");
