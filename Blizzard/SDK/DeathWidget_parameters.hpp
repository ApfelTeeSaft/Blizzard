...
public:
	...
	class UFortHUDContext*                        CallFunc_GetContext_ReturnValue12;                 // 0x0118(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortHeroManagementContext*             CallFunc_GetContext_ReturnValue123;                // 0x0120(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(DeathWidget_C_OnPawnDied, CallFunc_GetContext_ReturnValue12) == 0x000118, "Member 'DeathWidget_C_OnPawnDied::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
static_assert(offsetof(DeathWidget_C_OnPawnDied, CallFunc_GetContext_ReturnValue123) == 0x000120, "Member 'DeathWidget_C_OnPawnDied::CallFunc_GetContext_ReturnValue123' has a wrong offset!");
...
public:
	...
	struct FSlateColor                            K2Node_MakeStruct_SlateColor1;                     // 0x0128(0x0028)()
};
...
static_assert(offsetof(DeathWidget_C_ShowExtraLivesText, CallFunc_BooleanAND_ReturnValue1) == 0x0000F8, "Member 'DeathWidget_C_ShowExtraLivesText::CallFunc_BooleanAND_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(DeathWidget_C_ShowExtraLivesText, K2Node_MakeStruct_SlateColor1) == 0x000128, "Member 'DeathWidget_C_ShowExtraLivesText::K2Node_MakeStruct_SlateColor1' has a wrong offset!");
