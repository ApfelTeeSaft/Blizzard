...
static_assert(offsetof(AthenaPlayerActionAlert_C_ExecuteUbergraph_AthenaPlayerActionAlert, Temp_int_Variable1) == 0x000008, "Member 'AthenaPlayerActionAlert_C_ExecuteUbergraph_AthenaPlayerActionAlert::Temp_int_Variable1' has a wrong offset!");
...
static_assert(offsetof(AthenaPlayerActionAlert_C_ExecuteUbergraph_AthenaPlayerActionAlert, Temp_int_Variable12) == 0x00002C, "Member 'AthenaPlayerActionAlert_C_ExecuteUbergraph_AthenaPlayerActionAlert::Temp_int_Variable12' has a wrong offset!");
