...
static_assert(alignof(UGCNS_GM_OnDisplayEmoji_C) == 0x000010, "Wrong alignment on UGCNS_GM_OnDisplayEmoji_C");
static_assert(sizeof(UGCNS_GM_OnDisplayEmoji_C) == 0x0000B0, "Wrong size on UGCNS_GM_OnDisplayEmoji_C");
