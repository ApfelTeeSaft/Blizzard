...
static_assert(offsetof(InfoEntry_C_ExecuteUbergraph_InfoEntry, K2Node_ComponentBoundEvent_Button1) == 0x000048, "Member 'InfoEntry_C_ExecuteUbergraph_InfoEntry::K2Node_ComponentBoundEvent_Button1' has a wrong offset!");
