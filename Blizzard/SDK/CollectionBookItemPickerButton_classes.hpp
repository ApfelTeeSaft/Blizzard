...
{
public:
	class UWidgetSwitcher*                        RootWidgetSwitcher;                                // 0x07B0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UCollectionBookItemPickerButton_C) == 0x0007B8, "Wrong size on UCollectionBookItemPickerButton_C");
static_assert(offsetof(UCollectionBookItemPickerButton_C, RootWidgetSwitcher) == 0x0007B0, "Member 'UCollectionBookItemPickerButton_C::RootWidgetSwitcher' has a wrong offset!");
