...
public:
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue12;        // 0x0174(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FTimerHandle                           CallFunc_K2_SetTimer_ReturnValue1;                 // 0x0180(0x0008)(NoDestructor)
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue123;       // 0x01C8(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ProjectileHuskRanged_C_ExecuteUbergraph_ProjectileHuskRanged, K2Node_DynamicCast_bSuccess12) == 0x000158, "Member 'ProjectileHuskRanged_C_ExecuteUbergraph_ProjectileHuskRanged::K2Node_DynamicCast_bSuccess12' has a wrong offset!");
...
static_assert(offsetof(ProjectileHuskRanged_C_ExecuteUbergraph_ProjectileHuskRanged, CallFunc_K2_GetActorLocation_ReturnValue12) == 0x000174, "Member 'ProjectileHuskRanged_C_ExecuteUbergraph_ProjectileHuskRanged::CallFunc_K2_GetActorLocation_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(ProjectileHuskRanged_C_ExecuteUbergraph_ProjectileHuskRanged, CallFunc_K2_GetActorLocation_ReturnValue123) == 0x0001C8, "Member 'ProjectileHuskRanged_C_ExecuteUbergraph_ProjectileHuskRanged::CallFunc_K2_GetActorLocation_ReturnValue123' has a wrong offset!");
