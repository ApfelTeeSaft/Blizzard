...
static_assert(offsetof(GAB_PlayerDBNO_C_ExecuteUbergraph_GAB_PlayerDBNO, K2Node_CreateDelegate_OutputDelegate1) == 0x000018, "Member 'GAB_PlayerDBNO_C_ExecuteUbergraph_GAB_PlayerDBNO::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
static_assert(offsetof(GAB_PlayerDBNO_C_ExecuteUbergraph_GAB_PlayerDBNO, K2Node_CreateDelegate_OutputDelegate12) == 0x000028, "Member 'GAB_PlayerDBNO_C_ExecuteUbergraph_GAB_PlayerDBNO::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
...
static_assert(offsetof(GAB_PlayerDBNO_C_ExecuteUbergraph_GAB_PlayerDBNO, K2Node_CreateDelegate_OutputDelegate123) == 0x000108, "Member 'GAB_PlayerDBNO_C_ExecuteUbergraph_GAB_PlayerDBNO::K2Node_CreateDelegate_OutputDelegate123' has a wrong offset!");
