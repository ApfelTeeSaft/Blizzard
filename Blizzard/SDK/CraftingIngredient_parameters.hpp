...
static_assert(offsetof(CraftingIngredient_C_Refresh, CallFunc_Conv_IntToText_ReturnValue1) == 0x000140, "Member 'CraftingIngredient_C_Refresh::CallFunc_Conv_IntToText_ReturnValue1' has a wrong offset!");
