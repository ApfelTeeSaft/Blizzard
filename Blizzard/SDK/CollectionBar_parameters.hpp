...
static_assert(offsetof(CollectionBar_C_GetProgressBarPercentage, CallFunc_Subtract_IntInt_ReturnValue1) == 0x000018, "Member 'CollectionBar_C_GetProgressBarPercentage::CallFunc_Subtract_IntInt_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(CollectionBar_C_GetProgressBarPercentage, CallFunc_Max_ReturnValue1) == 0x000020, "Member 'CollectionBar_C_GetProgressBarPercentage::CallFunc_Max_ReturnValue1' has a wrong offset!");
static_assert(offsetof(CollectionBar_C_GetProgressBarPercentage, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x000024, "Member 'CollectionBar_C_GetProgressBarPercentage::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
