...
static_assert(sizeof(BP_FortExpeditionMasterWidget_C_Update_Master_Widget) == 0x000010, "Wrong size on BP_FortExpeditionMasterWidget_C_Update_Master_Widget");
...
static_assert(offsetof(BP_FortExpeditionMasterWidget_C_Update_Master_Widget, CallFunc_AreProfilesAvailableToWIFE_ReturnValue) == 0x000008, "Member 'BP_FortExpeditionMasterWidget_C_Update_Master_Widget::CallFunc_AreProfilesAvailableToWIFE_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionMasterWidget_C_Update_Master_Widget, CallFunc_AreAnyExpeditionsComplete_ReturnValue) == 0x000009, "Member 'BP_FortExpeditionMasterWidget_C_Update_Master_Widget::CallFunc_AreAnyExpeditionsComplete_ReturnValue' has a wrong offset!");
