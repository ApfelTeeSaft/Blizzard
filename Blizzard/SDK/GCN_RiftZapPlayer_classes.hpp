...
static_assert(alignof(UGCN_RiftZapPlayer_C) == 0x000010, "Wrong alignment on UGCN_RiftZapPlayer_C");
static_assert(sizeof(UGCN_RiftZapPlayer_C) == 0x0000B0, "Wrong size on UGCN_RiftZapPlayer_C");
