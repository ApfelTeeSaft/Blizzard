...
public:
	...
	TDelegate<void(const struct FFortTeamMemberInfo& PlayerInfo)> K2Node_CreateDelegate_OutputDelegate; // 0x01B0(0x0010)(ZeroConstructor, NoDestructor)
	class UFortBaseButton*                        K2Node_ComponentBoundEvent_Button1;                // 0x01C0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_ComponentBoundEvent_Selected1;              // 0x01C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1C9[0x7];                                      // 0x01C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(int32 PlayerIndex)>            K2Node_CreateDelegate_OutputDelegate1;             // 0x01D0(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const struct FFortTeamMemberInfo& NewTeamMemberInfo)> K2Node_CreateDelegate_OutputDelegate12; // 0x0390(0x0010)(ZeroConstructor, NoDestructor)
	...
	class UCommonButton*                          K2Node_ComponentBoundEvent_Button;                 // 0x03A8(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(OutpostScreenCanEditPanel_C_ExecuteUbergraph_OutpostScreenCanEditPanel, K2Node_ComponentBoundEvent_Button1) == 0x0001C0, "Member 'OutpostScreenCanEditPanel_C_ExecuteUbergraph_OutpostScreenCanEditPanel::K2Node_ComponentBoundEvent_Button1' has a wrong offset!");
static_assert(offsetof(OutpostScreenCanEditPanel_C_ExecuteUbergraph_OutpostScreenCanEditPanel, K2Node_ComponentBoundEvent_Selected1) == 0x0001C8, "Member 'OutpostScreenCanEditPanel_C_ExecuteUbergraph_OutpostScreenCanEditPanel::K2Node_ComponentBoundEvent_Selected1' has a wrong offset!");
static_assert(offsetof(OutpostScreenCanEditPanel_C_ExecuteUbergraph_OutpostScreenCanEditPanel, K2Node_CreateDelegate_OutputDelegate1) == 0x0001D0, "Member 'OutpostScreenCanEditPanel_C_ExecuteUbergraph_OutpostScreenCanEditPanel::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(OutpostScreenCanEditPanel_C_ExecuteUbergraph_OutpostScreenCanEditPanel, K2Node_CreateDelegate_OutputDelegate12) == 0x000390, "Member 'OutpostScreenCanEditPanel_C_ExecuteUbergraph_OutpostScreenCanEditPanel::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
...
static_assert(offsetof(OutpostScreenCanEditPanel_C_Init, Temp_byte_Variable1) == 0x000068, "Member 'OutpostScreenCanEditPanel_C_Init::Temp_byte_Variable1' has a wrong offset!");
...
static_assert(offsetof(OutpostScreenCanEditPanel_C_Init, K2Node_DynamicCast_AsFort_Player_State_Outpost1) == 0x000080, "Member 'OutpostScreenCanEditPanel_C_Init::K2Node_DynamicCast_AsFort_Player_State_Outpost1' has a wrong offset!");
static_assert(offsetof(OutpostScreenCanEditPanel_C_Init, K2Node_DynamicCast_bSuccess1) == 0x000088, "Member 'OutpostScreenCanEditPanel_C_Init::K2Node_DynamicCast_bSuccess1' has a wrong offset!");
...
static_assert(offsetof(OutpostScreenCanEditPanel_C_Init, CallFunc_BooleanAND_ReturnValue1) == 0x000090, "Member 'OutpostScreenCanEditPanel_C_Init::CallFunc_BooleanAND_ReturnValue1' has a wrong offset!");
