...
static_assert(sizeof(UTabGamePadConfig_C) == 0x0002A0, "Wrong size on UTabGamePadConfig_C");
static_assert(offsetof(UTabGamePadConfig_C, UberGraphFrame) == 0x000258, "Member 'UTabGamePadConfig_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTabGamePadConfig_C, ControllerPlatformConfig) == 0x000260, "Member 'UTabGamePadConfig_C::ControllerPlatformConfig' has a wrong offset!");
static_assert(offsetof(UTabGamePadConfig_C, GamepadConfig) == 0x000268, "Member 'UTabGamePadConfig_C::GamepadConfig' has a wrong offset!");
static_assert(offsetof(UTabGamePadConfig_C, GamepadMappingInfo) == 0x000270, "Member 'UTabGamePadConfig_C::GamepadMappingInfo' has a wrong offset!");
static_assert(offsetof(UTabGamePadConfig_C, SizeBoxControllerPlatform) == 0x000278, "Member 'UTabGamePadConfig_C::SizeBoxControllerPlatform' has a wrong offset!");
static_assert(offsetof(UTabGamePadConfig_C, IsCombatMode) == 0x000280, "Member 'UTabGamePadConfig_C::IsCombatMode' has a wrong offset!");
static_assert(offsetof(UTabGamePadConfig_C, InputPresets) == 0x000288, "Member 'UTabGamePadConfig_C::InputPresets' has a wrong offset!");
static_assert(offsetof(UTabGamePadConfig_C, ControllerPlatformMappingIndex) == 0x000298, "Member 'UTabGamePadConfig_C::ControllerPlatformMappingIndex' has a wrong offset!");
static_assert(offsetof(UTabGamePadConfig_C, ControllerConfiguration) == 0x00029C, "Member 'UTabGamePadConfig_C::ControllerConfiguration' has a wrong offset!");
