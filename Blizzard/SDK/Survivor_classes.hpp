...
static_assert(sizeof(ASurvivor_C) == 0x001CC0, "Wrong size on ASurvivor_C");
static_assert(offsetof(ASurvivor_C, UberGraphFrame) == 0x001B50, "Member 'ASurvivor_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, FortMiniMap) == 0x001B58, "Member 'ASurvivor_C::FortMiniMap' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, SpeechBubbleComponent) == 0x001B60, "Member 'ASurvivor_C::SpeechBubbleComponent' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, InteractBox) == 0x001B68, "Member 'ASurvivor_C::InteractBox' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, SurvivorAnchor) == 0x001B70, "Member 'ASurvivor_C::SurvivorAnchor' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, SurvivorAnchorClass) == 0x001B78, "Member 'ASurvivor_C::SurvivorAnchorClass' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, TC_DamageTagsServer) == 0x001B80, "Member 'ASurvivor_C::TC_DamageTagsServer' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, TC_MeleeDamage) == 0x001BA0, "Member 'ASurvivor_C::TC_MeleeDamage' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, TC_NPCStatusAOE) == 0x001BC0, "Member 'ASurvivor_C::TC_NPCStatusAOE' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, TC_NPCStatusLockedInPlace) == 0x001BE0, "Member 'ASurvivor_C::TC_NPCStatusLockedInPlace' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, TC_NPCBehaviorCower) == 0x001BE8, "Member 'ASurvivor_C::TC_NPCBehaviorCower' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, Event_NPCAbilityNonAttackAvoidEnemy) == 0x001C08, "Member 'ASurvivor_C::Event_NPCAbilityNonAttackAvoidEnemy' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, Event_NPCAbilityNonAttackCowerTrue) == 0x001C10, "Member 'ASurvivor_C::Event_NPCAbilityNonAttackCowerTrue' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, Event_NPCAbilityNonAttackCowerFalse) == 0x001C18, "Member 'ASurvivor_C::Event_NPCAbilityNonAttackCowerFalse' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, Event_NPCAbilityNonAttackRescueTrue) == 0x001C20, "Member 'ASurvivor_C::Event_NPCAbilityNonAttackRescueTrue' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, Event_NPCAbilityNonAttackConversationOrScriptedAnimation) == 0x001C28, "Member 'ASurvivor_C::Event_NPCAbilityNonAttackConversationOrScriptedAnimation' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, GE_SurvivorLockedInPlace) == 0x001C30, "Member 'ASurvivor_C::GE_SurvivorLockedInPlace' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, ScriptedAnimMontage) == 0x001C38, "Member 'ASurvivor_C::ScriptedAnimMontage' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, SpeechBubbleWidgetClass) == 0x001C40, "Member 'ASurvivor_C::SpeechBubbleWidgetClass' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, bToggleInteractChannel) == 0x001C48, "Member 'ASurvivor_C::bToggleInteractChannel' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, ZoneState) == 0x001C50, "Member 'ASurvivor_C::ZoneState' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, SurvivorName) == 0x001C58, "Member 'ASurvivor_C::SurvivorName' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, ShowAnchorBoundsWhenTeleportingIn) == 0x001C68, "Member 'ASurvivor_C::ShowAnchorBoundsWhenTeleportingIn' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, MeshMIDArray) == 0x001C70, "Member 'ASurvivor_C::MeshMIDArray' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, MIDs_Initialized) == 0x001C80, "Member 'ASurvivor_C::MIDs_Initialized' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, TeleportInWantsToHappen) == 0x001C81, "Member 'ASurvivor_C::TeleportInWantsToHappen' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, TeleportOutWantsToHappen) == 0x001C82, "Member 'ASurvivor_C::TeleportOutWantsToHappen' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, LastSpeechText) == 0x001C88, "Member 'ASurvivor_C::LastSpeechText' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, TeleportEffectModeReplicated) == 0x001CA0, "Member 'ASurvivor_C::TeleportEffectModeReplicated' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, TeleportEffectModeLocal) == 0x001CA4, "Member 'ASurvivor_C::TeleportEffectModeLocal' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, InteractionBangRef) == 0x001CA8, "Member 'ASurvivor_C::InteractionBangRef' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, InteractionBangRelativeOffset) == 0x001CB0, "Member 'ASurvivor_C::InteractionBangRelativeOffset' has a wrong offset!");
static_assert(offsetof(ASurvivor_C, InteractionBangEnabled) == 0x001CBC, "Member 'ASurvivor_C::InteractionBangEnabled' has a wrong offset!");
