...
static_assert(sizeof(UKeybindWidget_C) == 0x0007B0, "Wrong size on UKeybindWidget_C");
...
static_assert(offsetof(UKeybindWidget_C, InnerRoot) == 0x000290, "Member 'UKeybindWidget_C::InnerRoot' has a wrong offset!");
static_assert(offsetof(UKeybindWidget_C, KeyTextOverlay) == 0x000298, "Member 'UKeybindWidget_C::KeyTextOverlay' has a wrong offset!");
static_assert(offsetof(UKeybindWidget_C, SizeBox_0) == 0x0002A0, "Member 'UKeybindWidget_C::SizeBox_0' has a wrong offset!");
static_assert(offsetof(UKeybindWidget_C, SizeBoxBackplate) == 0x0002A8, "Member 'UKeybindWidget_C::SizeBoxBackplate' has a wrong offset!");
static_assert(offsetof(UKeybindWidget_C, Switcher) == 0x0002B0, "Member 'UKeybindWidget_C::Switcher' has a wrong offset!");
static_assert(offsetof(UKeybindWidget_C, TextKeybind) == 0x0002B8, "Member 'UKeybindWidget_C::TextKeybind' has a wrong offset!");
static_assert(offsetof(UKeybindWidget_C, TextSizeMinBox) == 0x0002C0, "Member 'UKeybindWidget_C::TextSizeMinBox' has a wrong offset!");
static_assert(offsetof(UKeybindWidget_C, Brush_Size) == 0x0002C8, "Member 'UKeybindWidget_C::Brush_Size' has a wrong offset!");
static_assert(offsetof(UKeybindWidget_C, Frame_MultiBrush) == 0x0002D0, "Member 'UKeybindWidget_C::Frame_MultiBrush' has a wrong offset!");
static_assert(offsetof(UKeybindWidget_C, MultiFont) == 0x0005A0, "Member 'UKeybindWidget_C::MultiFont' has a wrong offset!");
