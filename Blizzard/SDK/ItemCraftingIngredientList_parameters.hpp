...
public:
	...
	TDelegate<void(EFortCraftFailCause FailureCause)> K2Node_CreateDelegate_OutputDelegate1234;      // 0x0060(0x0010)(ZeroConstructor, NoDestructor)
	class UFortInventoryContext*                  CallFunc_GetContext_ReturnValue12;                 // 0x0070(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(const TArray<class UFortWorldItem*>& ItemsAdded, const TArray<class UFortWorldItem*>& ItemsRemoved)> K2Node_CreateDelegate_OutputDelegate12345; // 0x0088(0x0010)(ZeroConstructor, NoDestructor)
};
...
static_assert(offsetof(ItemCraftingIngredientList_C_SetItemToRepresent, K2Node_CreateDelegate_OutputDelegate1) == 0x000020, "Member 'ItemCraftingIngredientList_C_SetItemToRepresent::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(ItemCraftingIngredientList_C_SetItemToRepresent, K2Node_CreateDelegate_OutputDelegate12) == 0x000038, "Member 'ItemCraftingIngredientList_C_SetItemToRepresent::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
static_assert(offsetof(ItemCraftingIngredientList_C_SetItemToRepresent, CallFunc_GetContext_ReturnValue1) == 0x000048, "Member 'ItemCraftingIngredientList_C_SetItemToRepresent::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ItemCraftingIngredientList_C_SetItemToRepresent, K2Node_CreateDelegate_OutputDelegate123) == 0x000050, "Member 'ItemCraftingIngredientList_C_SetItemToRepresent::K2Node_CreateDelegate_OutputDelegate123' has a wrong offset!");
static_assert(offsetof(ItemCraftingIngredientList_C_SetItemToRepresent, K2Node_CreateDelegate_OutputDelegate1234) == 0x000060, "Member 'ItemCraftingIngredientList_C_SetItemToRepresent::K2Node_CreateDelegate_OutputDelegate1234' has a wrong offset!");
static_assert(offsetof(ItemCraftingIngredientList_C_SetItemToRepresent, CallFunc_GetContext_ReturnValue12) == 0x000070, "Member 'ItemCraftingIngredientList_C_SetItemToRepresent::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
static_assert(offsetof(ItemCraftingIngredientList_C_SetItemToRepresent, CallFunc_ItemNeedsInventoryTracking_NeedsTracking1) == 0x000078, "Member 'ItemCraftingIngredientList_C_SetItemToRepresent::CallFunc_ItemNeedsInventoryTracking_NeedsTracking1' has a wrong offset!");
static_assert(offsetof(ItemCraftingIngredientList_C_SetItemToRepresent, CallFunc_GetContext_ReturnValue123) == 0x000080, "Member 'ItemCraftingIngredientList_C_SetItemToRepresent::CallFunc_GetContext_ReturnValue123' has a wrong offset!");
static_assert(offsetof(ItemCraftingIngredientList_C_SetItemToRepresent, K2Node_CreateDelegate_OutputDelegate12345) == 0x000088, "Member 'ItemCraftingIngredientList_C_SetItemToRepresent::K2Node_CreateDelegate_OutputDelegate12345' has a wrong offset!");
