...
static_assert(sizeof(B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage) == 0x0001E8, "Wrong size on B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage");
...
static_assert(offsetof(B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage, Temp_bool_Has_Been_Initd_Variable) == 0x000090, "Member 'B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage::Temp_bool_Has_Been_Initd_Variable' has a wrong offset!");
static_assert(offsetof(B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage, Temp_bool_IsClosed_Variable) == 0x000091, "Member 'B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage::Temp_bool_IsClosed_Variable' has a wrong offset!");
static_assert(offsetof(B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage, K2Node_Event_MyComp) == 0x000098, "Member 'B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage::K2Node_Event_MyComp' has a wrong offset!");
static_assert(offsetof(B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage, K2Node_Event_Other) == 0x0000A0, "Member 'B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage::K2Node_Event_Other' has a wrong offset!");
static_assert(offsetof(B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage, K2Node_Event_OtherComp) == 0x0000A8, "Member 'B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage::K2Node_Event_OtherComp' has a wrong offset!");
static_assert(offsetof(B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage, K2Node_Event_bSelfMoved) == 0x0000B0, "Member 'B_Proj_Athena_Bandage_C_ExecuteUbergraph_B_Proj_Athena_Bandage::K2Node_Event_bSelfMoved' has a wrong offset!");
