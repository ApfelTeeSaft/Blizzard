...
static_assert(sizeof(UAthenaNewsModal_C) == 0x000458, "Wrong size on UAthenaNewsModal_C");
...
static_assert(offsetof(UAthenaNewsModal_C, CloseButton) == 0x000410, "Member 'UAthenaNewsModal_C::CloseButton' has a wrong offset!");
static_assert(offsetof(UAthenaNewsModal_C, DescriptionScroll) == 0x000418, "Member 'UAthenaNewsModal_C::DescriptionScroll' has a wrong offset!");
static_assert(offsetof(UAthenaNewsModal_C, GliderGirl) == 0x000420, "Member 'UAthenaNewsModal_C::GliderGirl' has a wrong offset!");
static_assert(offsetof(UAthenaNewsModal_C, GliderPerson1) == 0x000428, "Member 'UAthenaNewsModal_C::GliderPerson1' has a wrong offset!");
static_assert(offsetof(UAthenaNewsModal_C, Image_0) == 0x000430, "Member 'UAthenaNewsModal_C::Image_0' has a wrong offset!");
static_assert(offsetof(UAthenaNewsModal_C, Lightbox) == 0x000438, "Member 'UAthenaNewsModal_C::Lightbox' has a wrong offset!");
static_assert(offsetof(UAthenaNewsModal_C, MainIcon) == 0x000440, "Member 'UAthenaNewsModal_C::MainIcon' has a wrong offset!");
static_assert(offsetof(UAthenaNewsModal_C, SafeZone_0) == 0x000448, "Member 'UAthenaNewsModal_C::SafeZone_0' has a wrong offset!");
static_assert(offsetof(UAthenaNewsModal_C, Title) == 0x000450, "Member 'UAthenaNewsModal_C::Title' has a wrong offset!");
