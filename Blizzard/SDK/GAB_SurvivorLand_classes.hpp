...
static_assert(sizeof(UGAB_SurvivorLand_C) == 0x000AC0, "Wrong size on UGAB_SurvivorLand_C");
static_assert(offsetof(UGAB_SurvivorLand_C, UberGraphFrame) == 0x000AB0, "Member 'UGAB_SurvivorLand_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGAB_SurvivorLand_C, SectionName) == 0x000AB8, "Member 'UGAB_SurvivorLand_C::SectionName' has a wrong offset!");
