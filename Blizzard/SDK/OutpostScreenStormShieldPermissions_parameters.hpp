...
public:
	...
	struct FFortTeamMemberInfo                    K2Node_CustomEvent_NewTeamMemberInfo;              // 0x0040(0x01A8)()
	int32                                         K2Node_CustomEvent_PlayerIndex;                    // 0x01E8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1EC[0x4];                                      // 0x01EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortPartyContext*                      CallFunc_GetContext_ReturnValue;                   // 0x01F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortUITeamInfo*                        CallFunc_GetLocalPlayerTeam_ReturnValue;           // 0x01F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions) == 0x000200, "Wrong size on OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions");
...
static_assert(offsetof(OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions, K2Node_CreateDelegate_OutputDelegate1) == 0x000030, "Member 'OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions, K2Node_CustomEvent_PlayerIndex) == 0x0001E8, "Member 'OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions::K2Node_CustomEvent_PlayerIndex' has a wrong offset!");
static_assert(offsetof(OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions, CallFunc_GetContext_ReturnValue) == 0x0001F0, "Member 'OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions, CallFunc_GetLocalPlayerTeam_ReturnValue) == 0x0001F8, "Member 'OutpostScreenStormShieldPermissions_C_ExecuteUbergraph_OutpostScreenStormShieldPermissions::CallFunc_GetLocalPlayerTeam_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(OutpostScreenStormShieldPermissions_C_UpdatePrivilagesEvent_0) == 0x0001A8, "Wrong size on OutpostScreenStormShieldPermissions_C_UpdatePrivilagesEvent_0");
