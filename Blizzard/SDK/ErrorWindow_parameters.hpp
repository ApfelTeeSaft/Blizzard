...
static_assert(offsetof(ErrorWindow_C_ExecuteUbergraph_ErrorWindow, K2Node_ComponentBoundEvent_Button1) == 0x000008, "Member 'ErrorWindow_C_ExecuteUbergraph_ErrorWindow::K2Node_ComponentBoundEvent_Button1' has a wrong offset!");
...
static_assert(offsetof(ErrorWindow_C_AddError, CallFunc_Array_Add_ReturnValue1) == 0x0000A0, "Member 'ErrorWindow_C_AddError::CallFunc_Array_Add_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(ErrorWindow_C_Initialize, K2Node_CreateDelegate_OutputDelegate1) == 0x000010, "Member 'ErrorWindow_C_Initialize::K2Node_CreateDelegate_OutputDelegate1' has a wrong offset!");
...
static_assert(offsetof(ErrorWindow_C_Initialize, CallFunc_GetContext_ReturnValue1) == 0x000030, "Member 'ErrorWindow_C_Initialize::CallFunc_GetContext_ReturnValue1' has a wrong offset!");
