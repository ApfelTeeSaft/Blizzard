...
static_assert(offsetof(GCNL_Enemy_Frozen_C_OnActive, CallFunc_GetGameTimeInSeconds_ReturnValue1) == 0x0001C8, "Member 'GCNL_Enemy_Frozen_C_OnActive::CallFunc_GetGameTimeInSeconds_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(GCNL_Enemy_Frozen_C_OnRemove, CallFunc_IsValid_ReturnValue1) == 0x0000FD, "Member 'GCNL_Enemy_Frozen_C_OnRemove::CallFunc_IsValid_ReturnValue1' has a wrong offset!");
