...
static_assert(offsetof(SmallLevelUpReward_C_SetupReward, Temp_byte_Variable1) == 0x000071, "Member 'SmallLevelUpReward_C_SetupReward::Temp_byte_Variable1' has a wrong offset!");
