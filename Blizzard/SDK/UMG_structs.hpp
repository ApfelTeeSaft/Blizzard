...
static_assert(sizeof(FRichTextStyleRow) == 0x0001D0, "Wrong size on FRichTextStyleRow");
...
{
public:
	struct FSlateBrush                            Brush;                                             // 0x0008(0x0078)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRichImageRow) == 0x000008, "Wrong alignment on FRichImageRow");
static_assert(sizeof(FRichImageRow) == 0x000080, "Wrong size on FRichImageRow");
