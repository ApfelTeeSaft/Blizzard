...
static_assert(offsetof(B_Post_SupplyDrop_Impact_C_ExecuteUbergraph_B_Post_SupplyDrop_Impact, CallFunc_Multiply_FloatFloat_ReturnValue1) == 0x000014, "Member 'B_Post_SupplyDrop_Impact_C_ExecuteUbergraph_B_Post_SupplyDrop_Impact::CallFunc_Multiply_FloatFloat_ReturnValue1' has a wrong offset!");
static_assert(offsetof(B_Post_SupplyDrop_Impact_C_ExecuteUbergraph_B_Post_SupplyDrop_Impact, CallFunc_Multiply_FloatFloat_ReturnValue12) == 0x000018, "Member 'B_Post_SupplyDrop_Impact_C_ExecuteUbergraph_B_Post_SupplyDrop_Impact::CallFunc_Multiply_FloatFloat_ReturnValue12' has a wrong offset!");
