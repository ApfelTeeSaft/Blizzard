...
public:
	...
	class UFortItemDefinition*                    CallFunc_GetItemDefinitionBP_ReturnValue1;         // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortItemDefinition*                    CallFunc_GetItemDefinitionBP_ReturnValue12;        // 0x0060(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortItemDefinition*                    CallFunc_GetItemDefinitionBP_ReturnValue123;       // 0x0068(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortItemDefinition*                    CallFunc_GetItemDefinitionBP_ReturnValue1234;      // 0x0070(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortItemDefinition*                    CallFunc_GetItemDefinitionBP_ReturnValue12345;     // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(ItemWindow_C_ExecuteUbergraph_ItemWindow, CallFunc_GetItemDefinitionBP_ReturnValue1) == 0x000050, "Member 'ItemWindow_C_ExecuteUbergraph_ItemWindow::CallFunc_GetItemDefinitionBP_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(ItemWindow_C_ExecuteUbergraph_ItemWindow, CallFunc_GetItemDefinitionBP_ReturnValue12) == 0x000060, "Member 'ItemWindow_C_ExecuteUbergraph_ItemWindow::CallFunc_GetItemDefinitionBP_ReturnValue12' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_ExecuteUbergraph_ItemWindow, CallFunc_GetItemDefinitionBP_ReturnValue123) == 0x000068, "Member 'ItemWindow_C_ExecuteUbergraph_ItemWindow::CallFunc_GetItemDefinitionBP_ReturnValue123' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_ExecuteUbergraph_ItemWindow, CallFunc_GetItemDefinitionBP_ReturnValue1234) == 0x000070, "Member 'ItemWindow_C_ExecuteUbergraph_ItemWindow::CallFunc_GetItemDefinitionBP_ReturnValue1234' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_ExecuteUbergraph_ItemWindow, CallFunc_GetItemDefinitionBP_ReturnValue12345) == 0x000078, "Member 'ItemWindow_C_ExecuteUbergraph_ItemWindow::CallFunc_GetItemDefinitionBP_ReturnValue12345' has a wrong offset!");
...
public:
	...
	class UItemEntry_C*                           CallFunc_Create_ReturnValue;                       // 0x0038(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData12;            // 0x0168(0x0040)(HasGetValueTypeHash)
	class FText                                   CallFunc_GetDisplayName_ReturnValue1;              // 0x01A8(0x0018)()
	...
	class FText                                   CallFunc_GetDisplayName_ReturnValue12;             // 0x0228(0x0018)()
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData1234;          // 0x0240(0x0040)(HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>            K2Node_MakeArray_Array12;                          // 0x0280(0x0010)(ZeroConstructor, ReferenceParm)
	class FText                                   CallFunc_Format_ReturnValue12;                     // 0x0290(0x0018)()
	int32                                         Temp_int_Variable;                                 // 0x02A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_2AC[0x4];                                      // 0x02AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_GetDisplayName_ReturnValue123;            // 0x02B0(0x0018)()
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData12345;         // 0x02C8(0x0040)(HasGetValueTypeHash)
	int32                                         Temp_int_Variable1;                                // 0x0308(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_30C[0x4];                                      // 0x030C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FFormatArgumentData>            K2Node_MakeArray_Array123;                         // 0x0310(0x0010)(ZeroConstructor, ReferenceParm)
	class FText                                   CallFunc_Format_ReturnValue123;                    // 0x0320(0x0018)()
	bool                                          Temp_bool_Variable1;                               // 0x0338(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	ESlateVisibility                              Temp_byte_Variable1;                               // 0x0341(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESlateVisibility                              K2Node_Select1_Default;                            // 0x0342(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(ItemWindow_C_AddInfo, CallFunc_Array_Length_ReturnValue1) == 0x000030, "Member 'ItemWindow_C_AddInfo::CallFunc_Array_Length_ReturnValue1' has a wrong offset!");
...
static_assert(offsetof(ItemWindow_C_AddInfo, K2Node_MakeStruct_FormatArgumentData1) == 0x000128, "Member 'ItemWindow_C_AddInfo::K2Node_MakeStruct_FormatArgumentData1' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, K2Node_MakeStruct_FormatArgumentData12) == 0x000168, "Member 'ItemWindow_C_AddInfo::K2Node_MakeStruct_FormatArgumentData12' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, CallFunc_GetDisplayName_ReturnValue1) == 0x0001A8, "Member 'ItemWindow_C_AddInfo::CallFunc_GetDisplayName_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, K2Node_MakeStruct_FormatArgumentData123) == 0x0001C0, "Member 'ItemWindow_C_AddInfo::K2Node_MakeStruct_FormatArgumentData123' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, K2Node_MakeArray_Array1) == 0x000200, "Member 'ItemWindow_C_AddInfo::K2Node_MakeArray_Array1' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, CallFunc_Format_ReturnValue1) == 0x000210, "Member 'ItemWindow_C_AddInfo::CallFunc_Format_ReturnValue1' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, CallFunc_GetDisplayName_ReturnValue12) == 0x000228, "Member 'ItemWindow_C_AddInfo::CallFunc_GetDisplayName_ReturnValue12' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, K2Node_MakeStruct_FormatArgumentData1234) == 0x000240, "Member 'ItemWindow_C_AddInfo::K2Node_MakeStruct_FormatArgumentData1234' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, K2Node_MakeArray_Array12) == 0x000280, "Member 'ItemWindow_C_AddInfo::K2Node_MakeArray_Array12' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, CallFunc_Format_ReturnValue12) == 0x000290, "Member 'ItemWindow_C_AddInfo::CallFunc_Format_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(ItemWindow_C_AddInfo, CallFunc_GetDisplayName_ReturnValue123) == 0x0002B0, "Member 'ItemWindow_C_AddInfo::CallFunc_GetDisplayName_ReturnValue123' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, K2Node_MakeStruct_FormatArgumentData12345) == 0x0002C8, "Member 'ItemWindow_C_AddInfo::K2Node_MakeStruct_FormatArgumentData12345' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, Temp_int_Variable1) == 0x000308, "Member 'ItemWindow_C_AddInfo::Temp_int_Variable1' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, K2Node_MakeArray_Array123) == 0x000310, "Member 'ItemWindow_C_AddInfo::K2Node_MakeArray_Array123' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, CallFunc_Format_ReturnValue123) == 0x000320, "Member 'ItemWindow_C_AddInfo::CallFunc_Format_ReturnValue123' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, Temp_bool_Variable1) == 0x000338, "Member 'ItemWindow_C_AddInfo::Temp_bool_Variable1' has a wrong offset!");
...
static_assert(offsetof(ItemWindow_C_AddInfo, Temp_byte_Variable1) == 0x000341, "Member 'ItemWindow_C_AddInfo::Temp_byte_Variable1' has a wrong offset!");
static_assert(offsetof(ItemWindow_C_AddInfo, K2Node_Select1_Default) == 0x000342, "Member 'ItemWindow_C_AddInfo::K2Node_Select1_Default' has a wrong offset!");
