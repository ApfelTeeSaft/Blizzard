...
static_assert(offsetof(DailyQuestProgressWidget_C_ExecuteUbergraph_DailyQuestProgressWidget, K2Node_Select1_Default) == 0x00000B, "Member 'DailyQuestProgressWidget_C_ExecuteUbergraph_DailyQuestProgressWidget::K2Node_Select1_Default' has a wrong offset!");
...
static_assert(offsetof(DailyQuestProgressWidget_C_Update, CallFunc_Conv_IntToFloat_ReturnValue1) == 0x0000F0, "Member 'DailyQuestProgressWidget_C_Update::CallFunc_Conv_IntToFloat_ReturnValue1' has a wrong offset!");
