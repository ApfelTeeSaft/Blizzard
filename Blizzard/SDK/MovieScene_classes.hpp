...
static_assert(alignof(IMovieSceneBindingOverridesInterface) == 0x000001, "Wrong alignment on IMovieSceneBindingOverridesInterface");
static_assert(sizeof(IMovieSceneBindingOverridesInterface) == 0x000001, "Wrong size on IMovieSceneBindingOverridesInterface");
...
static_assert(sizeof(UMovieSceneSection) == 0x000110, "Wrong size on UMovieSceneSection");
static_assert(offsetof(UMovieSceneSection, EvalOptions) == 0x0000B0, "Member 'UMovieSceneSection::EvalOptions' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, Easing) == 0x0000B8, "Member 'UMovieSceneSection::Easing' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, StartTime) == 0x0000F0, "Member 'UMovieSceneSection::StartTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, EndTime) == 0x0000F4, "Member 'UMovieSceneSection::EndTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, RowIndex) == 0x0000F8, "Member 'UMovieSceneSection::RowIndex' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, OverlapPriority) == 0x0000FC, "Member 'UMovieSceneSection::OverlapPriority' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, PrerollTime) == 0x000104, "Member 'UMovieSceneSection::PrerollTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, PostrollTime) == 0x000108, "Member 'UMovieSceneSection::PostrollTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, BlendType) == 0x00010C, "Member 'UMovieSceneSection::BlendType' has a wrong offset!");
...
{
public:
	bool                                          bHighPassFilter;                                   // 0x00B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneSegmentCompilerTestTrack) == 0x0000D0, "Wrong size on UMovieSceneSegmentCompilerTestTrack");
static_assert(offsetof(UMovieSceneSegmentCompilerTestTrack, bHighPassFilter) == 0x0000B8, "Member 'UMovieSceneSegmentCompilerTestTrack::bHighPassFilter' has a wrong offset!");
static_assert(offsetof(UMovieSceneSegmentCompilerTestTrack, SectionArray) == 0x0000C0, "Member 'UMovieSceneSegmentCompilerTestTrack::SectionArray' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSegmentCompilerTestSection) == 0x000110, "Wrong size on UMovieSceneSegmentCompilerTestSection");
...
{
public:
	struct FMovieSceneEvaluationTemplate          PrecompiledEvaluationTemplate;                     // 0x00B0(0x02F0)(ContainsInstancedReference, NativeAccessSpecifierPublic)
	EMovieSceneCompletionMode                     DefaultCompletionMode;                             // 0x03A0(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bParentContextsAreSignificant;                     // 0x03A1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneSequence) == 0x0003A8, "Wrong size on UMovieSceneSequence");
static_assert(offsetof(UMovieSceneSequence, PrecompiledEvaluationTemplate) == 0x0000B0, "Member 'UMovieSceneSequence::PrecompiledEvaluationTemplate' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequence, DefaultCompletionMode) == 0x0003A0, "Member 'UMovieSceneSequence::DefaultCompletionMode' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequence, bParentContextsAreSignificant) == 0x0003A1, "Member 'UMovieSceneSequence::bParentContextsAreSignificant' has a wrong offset!");

// Class MovieScene.MovieSceneSequencePlayer
// 0x07D0 (0x07F8 - 0x0028)
#pragma pack(push, 0x1)
class alignas(0x08) UMovieSceneSequencePlayer : public UObject
{
public:
	...
	uint8                                         bPendingFirstUpdate : 1;                           // 0x03C4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	...
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x03F8(0x0030)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_428[0x3D0];                                    // 0x0428(0x03D0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMovieSceneSequencePlayer, TimeCursorPosition) == 0x0003D8, "Member 'UMovieSceneSequencePlayer::TimeCursorPosition' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, StartTime) == 0x0003DC, "Member 'UMovieSceneSequencePlayer::StartTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, EndTime) == 0x0003E0, "Member 'UMovieSceneSequencePlayer::EndTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, CurrentNumLoops) == 0x0003E4, "Member 'UMovieSceneSequencePlayer::CurrentNumLoops' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSubSection) == 0x000178, "Wrong size on UMovieSceneSubSection");
static_assert(offsetof(UMovieSceneSubSection, Parameters) == 0x000110, "Member 'UMovieSceneSubSection::Parameters' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, StartOffset) == 0x000124, "Member 'UMovieSceneSubSection::StartOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, TimeScale) == 0x000128, "Member 'UMovieSceneSubSection::TimeScale' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, PrerollTime_MovieSceneSubSection) == 0x00012C, "Member 'UMovieSceneSubSection::PrerollTime_MovieSceneSubSection' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneSubSection, ActorToRecord) == 0x000138, "Member 'UMovieSceneSubSection::ActorToRecord' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, TargetSequenceName) == 0x000158, "Member 'UMovieSceneSubSection::TargetSequenceName' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, TargetPathToRecordTo) == 0x000168, "Member 'UMovieSceneSubSection::TargetPathToRecordTo' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSubTrack) == 0x0000D0, "Wrong size on UMovieSceneSubTrack");
