...
static_assert(offsetof(ItemInspectCycleWidget_C_ExecuteUbergraph_ItemInspectCycleWidget, K2Node_ComponentBoundEvent_Button1) == 0x000028, "Member 'ItemInspectCycleWidget_C_ExecuteUbergraph_ItemInspectCycleWidget::K2Node_ComponentBoundEvent_Button1' has a wrong offset!");
