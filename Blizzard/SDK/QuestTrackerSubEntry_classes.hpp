...
static_assert(sizeof(UQuestTrackerSubEntry_C) == 0x000390, "Wrong size on UQuestTrackerSubEntry_C");
static_assert(offsetof(UQuestTrackerSubEntry_C, UberGraphFrame) == 0x000250, "Member 'UQuestTrackerSubEntry_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UQuestTrackerSubEntry_C, CheckmarkAnimation) == 0x000258, "Member 'UQuestTrackerSubEntry_C::CheckmarkAnimation' has a wrong offset!");
static_assert(offsetof(UQuestTrackerSubEntry_C, CompletionRemove) == 0x000260, "Member 'UQuestTrackerSubEntry_C::CompletionRemove' has a wrong offset!");
static_assert(offsetof(UQuestTrackerSubEntry_C, CompletionFlash) == 0x000268, "Member 'UQuestTrackerSubEntry_C::CompletionFlash' has a wrong offset!");
static_assert(offsetof(UQuestTrackerSubEntry_C, Bullet) == 0x000270, "Member 'UQuestTrackerSubEntry_C::Bullet' has a wrong offset!");
static_assert(offsetof(UQuestTrackerSubEntry_C, BulletOverlay) == 0x000278, "Member 'UQuestTrackerSubEntry_C::BulletOverlay' has a wrong offset!");
static_assert(offsetof(UQuestTrackerSubEntry_C, CheckMark) == 0x000280, "Member 'UQuestTrackerSubEntry_C::CheckMark' has a wrong offset!");
static_assert(offsetof(UQuestTrackerSubEntry_C, FlashImage) == 0x000288, "Member 'UQuestTrackerSubEntry_C::FlashImage' has a wrong offset!");
static_assert(offsetof(UQuestTrackerSubEntry_C, ObjectiveDescriptionText) == 0x000290, "Member 'UQuestTrackerSubEntry_C::ObjectiveDescriptionText' has a wrong offset!");
static_assert(offsetof(UQuestTrackerSubEntry_C, Pin) == 0x000298, "Member 'UQuestTrackerSubEntry_C::Pin' has a wrong offset!");
static_assert(offsetof(UQuestTrackerSubEntry_C, NonHUDBullet) == 0x0002A0, "Member 'UQuestTrackerSubEntry_C::NonHUDBullet' has a wrong offset!");
static_assert(offsetof(UQuestTrackerSubEntry_C, NonHUDPin) == 0x000318, "Member 'UQuestTrackerSubEntry_C::NonHUDPin' has a wrong offset!");
