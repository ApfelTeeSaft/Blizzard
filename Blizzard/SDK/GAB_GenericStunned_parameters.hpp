...
public:
	...
	struct FActiveGameplayEffectHandle            CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue12; // 0x0114(0x0008)(NoDestructor, HasGetValueTypeHash)
	...
	struct FActiveGameplayEffectHandle            CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue123; // 0x014C(0x0008)(NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_154[0x4];                                      // 0x0154(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortPawn*                              CallFunc_GetActivatingPawn_ReturnValue123;         // 0x0158(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(GAB_GenericStunned_C_ExecuteUbergraph_GAB_GenericStunned, CallFunc_GetActivatingPawn_ReturnValue12) == 0x000100, "Member 'GAB_GenericStunned_C_ExecuteUbergraph_GAB_GenericStunned::CallFunc_GetActivatingPawn_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(GAB_GenericStunned_C_ExecuteUbergraph_GAB_GenericStunned, CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue12) == 0x000114, "Member 'GAB_GenericStunned_C_ExecuteUbergraph_GAB_GenericStunned::CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue12' has a wrong offset!");
...
static_assert(offsetof(GAB_GenericStunned_C_ExecuteUbergraph_GAB_GenericStunned, CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue123) == 0x00014C, "Member 'GAB_GenericStunned_C_ExecuteUbergraph_GAB_GenericStunned::CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue123' has a wrong offset!");
static_assert(offsetof(GAB_GenericStunned_C_ExecuteUbergraph_GAB_GenericStunned, CallFunc_GetActivatingPawn_ReturnValue123) == 0x000158, "Member 'GAB_GenericStunned_C_ExecuteUbergraph_GAB_GenericStunned::CallFunc_GetActivatingPawn_ReturnValue123' has a wrong offset!");
